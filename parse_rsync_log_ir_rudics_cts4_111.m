...
%
% SYNTAX :
%  [o_floatBinFiles] = parse_rsync_log_ir_rudics_cts4_111(a_rsyncLogName, a_floatLoginName)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_floatBinFiles] = parse_rsync_log_ir_rudics_cts4_111(a_rsyncLogName, a_floatLoginName)
