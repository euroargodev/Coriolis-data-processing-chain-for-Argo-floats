...
g_cocs_ncCreateSyntheticProfileVersion = '1.0 (version 15.06.2018 for ARGO_simplify_getpressureaxis_v6)';
...
if (~isempty(g_cocs_outputXmlReportDirName))
   xmlFileName = [g_cocs_outputXmlReportDirName '/nc_create_synthetic_profile_rt_' currentTime '.xml'];
else
   xmlFileName = [tempdir '/nc_create_synthetic_profile_rt_' currentTime '.xml'];
end
