...
%
% SYNTAX :
%   nc_update_argo_format_set_tech_label_03ac or nc_update_argo_format_set_tech_label_03ac(6900189, 7900118)
%
% INPUT PARAMETERS :
...
%   04/14/2021 - RNU - V 03ac: update technical labels:
%                              - see g_couf_oldLabelList and g_couf_newLabelList
%                              lists below
% ------------------------------------------------------------------------------
function nc_update_argo_format_set_tech_label_03ac(varargin)
...
g_couf_ncUpdateArgoFormatVersion = '03ac';
...
newChild.appendChild(docNode.createTextNode('Argo Coriolis update format tool (nc_update_argo_format_set_tech_label_03ac)'));
docRootNode.appendChild(newChild);
...
g_couf_oldLabelList = [ ...
   {'NUMBER_ParkCTDOSamplesInternal_COUNT'} ...
   ];
