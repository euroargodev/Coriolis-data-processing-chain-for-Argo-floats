...
%
% SYNTAX :
%   nc_compare_mono_profile_files_prv or nc_compare_mono_profile_files_prv(6900189, 7900118)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function nc_compare_mono_profile_files_prv(varargin)
...
logFile = [DIR_LOG_CSV_FILE '/' 'nc_compare_mono_profile_files_prv' name '_' datestr(now, 'yyyymmddTHHMMSS') '.log'];
diary(logFile);
tic;
