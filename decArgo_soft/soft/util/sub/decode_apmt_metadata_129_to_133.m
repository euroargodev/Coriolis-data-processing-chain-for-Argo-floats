...
%
% SYNTAX :
%  [o_metaData] = decode_apmt_metadata_129_to_133(a_inputFilePathName)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_metaData] = decode_apmt_metadata_129_to_133(a_inputFilePathName)
...
if ~(exist(a_inputFilePathName, 'file') == 2)
   fprintf('ERROR: decode_apmt_metadata_129_to_133: File not found: %s\n', a_inputFilePathName);
   return
end
...
sensors.sensor_crover.path_length.pth = '';
sensors.sensor_crover.calibration.cln = '';
...
sensors.sensor_uvp6.acq_conf_0.frame = '';
sensors.sensor_uvp6.acq_conf_1.frame = '';
sensors.sensor_uvp6.acq_conf_2.frame = '';
sensors.sensor_uvp6.acq_conf_3.frame = '';
sensors.sensor_uvp6.acq_conf_4.frame = '';
sensors.sensor_uvp6.acq_conf_5.frame = '';
sensors.sensor_uvp6.acq_conf_6.frame = '';
sensors.sensor_uvp6.acq_conf_7.frame = '';
sensors.sensor_uvp6.acq_conf_8.frame = '';
sensors.sensor_uvp6.acq_conf_9.frame = '';
sensors.sensor_uvp6.taxo_conf_0.frame = '';
sensors.sensor_uvp6.taxo_conf_1.frame = '';
...
sensors.sensor_ramses.sensor.sn = '';
sensors.sensor_ramses.ramses_board.firmware = '';
sensors.sensor_ramses.spectrum.length = '';
sensors.sensor_ramses.spectrum.wavelengths = '';

sensors.sensor_ramses2 = [];
sensors.sensor_ramses2.sensor.sn = '';
sensors.sensor_ramses2.ramses_board.firmware = '';
sensors.sensor_ramses2.spectrum.length = '';
sensors.sensor_ramses2.spectrum.wavelengths = '';
...
sensors.sensor_imu = [];
sensors.sensor_imu.sensor.orientation = '';
sensors.sensor_imu.sensor.mode = '';
sensors.sensor_imu.temperature.t0 = '';
sensors.sensor_imu.accelerometer.ax0 = '';
sensors.sensor_imu.accelerometer.ay0 = '';
sensors.sensor_imu.accelerometer.az0 = '';
sensors.sensor_imu.accelerometer.axg = '';
sensors.sensor_imu.accelerometer.ayg = '';
sensors.sensor_imu.accelerometer.azg = '';
sensors.sensor_imu.gyroscope.gx0 = '';
sensors.sensor_imu.gyroscope.gy0 = '';
sensors.sensor_imu.gyroscope.gz0 = '';
sensors.sensor_imu.magnetometer.mx0 = '';
sensors.sensor_imu.magnetometer.my0 = '';
sensors.sensor_imu.magnetometer.mz0 = '';
sensors.sensor_imu.compass.hi1 = '';
sensors.sensor_imu.compass.hi2 = '';
sensors.sensor_imu.compass.si11 = '';
sensors.sensor_imu.compass.si12 = '';
sensors.sensor_imu.compass.si21 = '';
sensors.sensor_imu.compass.si22 = '';
