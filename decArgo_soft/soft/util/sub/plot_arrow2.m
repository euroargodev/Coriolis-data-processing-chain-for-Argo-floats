...
function handles = plot_arrow2( x1,y1,x2,y2,largeur,hauteur,varargin )
%
...
%
% 7/3/2005 : Creation C. Kermabon a partir plot_arrow.m telecharge sur le
% web. Dans cette version, on fixe la taille et largeur de la fleche
% en fonction de ce que fournit l'utilisateur.
%
...
head_length = hauteur; % Modif. CK 
head_width  = largeur; % Modif. CK 
