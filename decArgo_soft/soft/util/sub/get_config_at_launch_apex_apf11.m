...
elseif (isempty(files))
   fprintf('WARNING: mission.cfg file is mission for float %d in directory ''%s''\n', ...
...
elseif (isempty(files))
   fprintf('WARNING: system.cfg file is mission for float %d in directory ''%s''\n', ...
      a_floatNum, a_configDirName);
elseif (length(files) == 1)
...
elseif (isempty(files))
   fprintf('WARNING: sample.cfg file is mission for float %d in directory ''%s''\n', ...
      a_floatNum, a_configDirName);
elseif (length(files) == 1)
