...
%
% SYNTAX :
%  [o_confParamNames, o_confParamValues] = read_conf_cmd_report_arvor_cm( ...
...
% ------------------------------------------------------------------------------
function [o_confParamNames, o_confParamValues] = read_conf_cmd_report_arvor_cm( ...
...
for idS = 1:length(sensorList)
   ...
   switch sensorNum
      case 0
         values2 = [{'4800'} {'5000'} {'0'} {'1'} {'5'} {'-5'} {'2500'} {'-5'} {'50'} {'0'} {'50'} {'0.083'} {'0.01'} {'0'} {'1'} ];
         lastId = 14;
      case 1
         values2 = [{'1500'} {'10000'} {'0'} {'1'} {''} {''} {''} {''} {''} {''} {'0'}];
         lastId = 10;
      case 4
         values2 = [{'8000'} {'6000'} {'0'} {'1'} {'0'} {'4135'} {'0'} {'4135'} {'1'} {'0'} {'1'} {'0'} {'0'}];
         lastId = 12;
      case 7
         values2 = [{'5000'} {'4000'} {'0'} {'1'} {'10'} {'-0.5'} {'5.5'} {'0'} {'0'} {'5'} {'50'} {'1'} {'0'}];
         lastId = 12;
      case 8
         values2 = [{'500'} {'500'} {'0'} {'1'} {'10'} {'-0.5'} {'5.5'} {'0'} {'0'} {'5'} {'25'} {'0'} {'0'}];
         lastId = 12;
   end
...
if (length(o_confParamNames) ~= 104+(49*length(sensorList))+(nbSpecific))
   fprintf('WARNING: Float #%d: Number of config parameters (%d) different from expected (%d)\n', ...
      a_floatNum, length(o_confParamNames), 104+(49*length(sensorList))+(nbSpecific));
else
