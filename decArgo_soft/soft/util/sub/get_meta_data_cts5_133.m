...
% ------------------------------------------------------------------------------
function [o_metaStruct] = get_meta_data_cts5_133(...
   a_metaDataXmlFileName, a_metaStruct, a_sensorListNum, a_floatNum, a_outputCsvDirName, a_rtVersionFlag)
   ...
   if (any(a_sensorListNum == 3))
      if (~a_rtVersionFlag)
         if (isfield(metaData.sensors, 'sensor_ocr'))
            ...
            idF4 = find(strcmp('RADIOMETER_DOWN_IRR555', o_metaStruct.SENSOR));
            if (~isempty(idF) && ~isempty(idF2) && ~isempty(idF3) && ~isempty(idF4))
                  ...
                  if (isfield(metaData.sensors.sensor_ocr.sensor, 'sn'))
                     if (str2double(metaData.sensors.sensor_ocr.sensor.sn) ~= str2double(o_metaStruct.SENSOR_SERIAL_NO{idF}))
                        ...
                        fprintf('WARNING: BDD: Float #%d: SENSOR_SERIAL_NO for ''%s'' differ (database: ''%s'' xml:''%s'') - DB contents should be updated (see %s)\n', ...
                           ...
                           metaData.sensors.sensor_ocr.sensor.sn, ...
                           g_cogj_csvFileBddPathName);
                        fprintf(g_cogj_csvFileBddId, '%d;411;207;%s;SENSOR_SERIAL_NO\n', ...
                           a_floatNum, ...
                           metaData.sensors.sensor_ocr.sensor.sn);
                     end
                  end
                  if (isfield(metaData.sensors.sensor_ocr.sensor, 'model'))
                     if (~strcmp(metaData.sensors.sensor_ocr.sensor.model, o_metaStruct.SENSOR_MODEL{idF}))
                        ...
                        fprintf('WARNING: BDD: Float #%d: SENSOR_MODEL for ''%s'' differ (database: ''%s'' xml:''%s'') - DB contents should be updated (see %s)\n', ...
                           ...
                           metaData.sensors.sensor_ocr.sensor.model, ...
                           g_cogj_csvFileBddPathName);
                        fprintf(g_cogj_csvFileBddId, '%d;410;207;%s;SENSOR_MODEL\n', ...
                           a_floatNum, ...
                           metaData.sensors.sensor_ocr.sensor.model);
                     end
                  end
               ...
               if (isfield(metaData.sensors.sensor_ocr, 'channel_04'))
                  if (isfield(metaData.sensors.sensor_ocr.channel_04, 'a0'))
                     if (~isfield(o_metaStruct.CALIBRATION_COEFFICIENT, 'OCR'))
                        ...
                        fprintf('WARNING: COEF: Float #%d: OCR A0Lambda555 coef (%s) is missing in META.json file - calib_coef file contents should be updated (see %s)\n', ...
                           a_floatNum, ...
                           metaData.sensors.sensor_ocr.channel_04.a0, ...
                           g_cogj_csvFileCoefPathName);
                        fprintf(g_cogj_csvFileCoefId, '%d;OCR;A0Lambda555;%s\n', ...
                           a_floatNum, ...
                           metaData.sensors.sensor_ocr.channel_04.a0);
                     elseif (str2double(metaData.sensors.sensor_ocr.channel_04.a0) ~= str2double(o_metaStruct.CALIBRATION_COEFFICIENT.OCR.A0Lambda555))
                        if (isempty(g_cogj_csvFileCoefId) || (g_cogj_csvFileCoefId == -1))
                           [g_cogj_csvFileCoefId, g_cogj_csvFileCoefPathName] = open_csv_file(a_outputCsvDirName, 'C', g_cogj_csvFileCoefPathName);
                        end
                        fprintf('WARNING: COEF: Float #%d: OCR A0Lambda555 coef differ (database: ''%s'' xml:''%s'') - DB contents should be updated (see %s)\n', ...
                           a_floatNum, ...
                           o_metaStruct.CALIBRATION_COEFFICIENT.OCR.A0Lambda555, ...
                           metaData.sensors.sensor_ocr.channel_04.a0, ...
                           g_cogj_csvFileCoefPathName);
                        fprintf(g_cogj_csvFileCoefId, '%d;OCR;A0Lambda555;%s\n', ...
                           a_floatNum, ...
                  ...
                  if (isfield(metaData.sensors.sensor_ocr.channel_04, 'a1'))
                     if (~isfield(o_metaStruct.CALIBRATION_COEFFICIENT, 'OCR'))
                        ...
                        fprintf('WARNING: COEF: Float #%d: OCR A1Lambda555 coef (%s) is missing in META.json file - calib_coef file contents should be updated (see %s)\n', ...
                           a_floatNum, ...
                           metaData.sensors.sensor_ocr.channel_04.a1, ...
                           g_cogj_csvFileCoefPathName);
                        fprintf(g_cogj_csvFileCoefId, '%d;OCR;A1Lambda555;%s\n', ...
                           a_floatNum, ...
                           metaData.sensors.sensor_ocr.channel_04.a1);
                     elseif (str2double(metaData.sensors.sensor_ocr.channel_04.a1) ~= str2double(o_metaStruct.CALIBRATION_COEFFICIENT.OCR.A1Lambda555))
                        if (isempty(g_cogj_csvFileCoefId) || (g_cogj_csvFileCoefId == -1))
                           [g_cogj_csvFileCoefId, g_cogj_csvFileCoefPathName] = open_csv_file(a_outputCsvDirName, 'C', g_cogj_csvFileCoefPathName);
                        end
                        fprintf('WARNING: COEF: Float #%d: OCR A1Lambda555 coef differ (database: ''%s'' xml:''%s'') - DB contents should be updated (see %s)\n', ...
                           a_floatNum, ...
                           o_metaStruct.CALIBRATION_COEFFICIENT.OCR.A1Lambda555, ...
                           metaData.sensors.sensor_ocr.channel_04.a1, ...
                           g_cogj_csvFileCoefPathName);
                        fprintf(g_cogj_csvFileCoefId, '%d;OCR;A1Lambda555;%s\n', ...
                           a_floatNum, ...
                  ...
                  if (isfield(metaData.sensors.sensor_ocr.channel_04, 'im'))
                     if (~isfield(o_metaStruct.CALIBRATION_COEFFICIENT, 'OCR'))
                        ...
                        fprintf('WARNING: COEF: Float #%d: OCR LmLambda555 coef (%s) is missing in META.json file - calib_coef file contents should be updated (see %s)\n', ...
                           a_floatNum, ...
                           metaData.sensors.sensor_ocr.channel_04.im, ...
                           g_cogj_csvFileCoefPathName);
                        fprintf(g_cogj_csvFileCoefId, '%d;OCR;LmLambda555;%s\n', ...
                           a_floatNum, ...
                           metaData.sensors.sensor_ocr.channel_04.im);
                     elseif (str2double(metaData.sensors.sensor_ocr.channel_04.im) ~= str2double(o_metaStruct.CALIBRATION_COEFFICIENT.OCR.LmLambda555))
                        if (isempty(g_cogj_csvFileCoefId) || (g_cogj_csvFileCoefId == -1))
                           [g_cogj_csvFileCoefId, g_cogj_csvFileCoefPathName] = open_csv_file(a_outputCsvDirName, 'C', g_cogj_csvFileCoefPathName);
                        end
                        fprintf('WARNING: COEF: Float #%d: OCR LmLambda555 coef differ (database: ''%s'' xml:''%s'') - DB contents should be updated (see %s)\n', ...
                           a_floatNum, ...
                           o_metaStruct.CALIBRATION_COEFFICIENT.OCR.LmLambda555, ...
                           metaData.sensors.sensor_ocr.channel_04.im, ...
                           g_cogj_csvFileCoefPathName);
                        fprintf(g_cogj_csvFileCoefId, '%d;OCR;LmLambda555;%s\n', ...
                           a_floatNum, ...
               ...
               fprintf('ERROR: Float #%d: cannot find expected ''RADIOMETER_DOWN_IRR380'' and/or ''RADIOMETER_DOWN_IRR443'' and/or ''RADIOMETER_DOWN_IRR490'' and/or ''RADIOMETER_DOWN_IRR555'' sensor in DB contents - OCR metadata ignored\n', ...
                  a_floatNum);
            end
         end
      end
      ...
      if (~a_rtVersionFlag)
         if (any(strcmp(o_metaStruct.SENSOR_MOUNTED_ON_FLOAT, 'ECO3')))
            ...
            if (isfield(metaData.sensors, 'sensor_eco'))
               ...
               idF3 = find(strcmp('AUX_FLUOROMETER_CHLA435', o_metaStruct.SENSOR));
                     ...
                     if (isfield(metaData.sensors.sensor_eco.sensor, 'sn'))
                        if (~isempty(metaData.sensors.sensor_eco.sensor.sn))
                           if (str2double(metaData.sensors.sensor_eco.sensor.sn) ~= str2double(o_metaStruct.SENSOR_SERIAL_NO{idF}))
                              ...
                              fprintf('WARNING: BDD: Float #%d: SENSOR_SERIAL_NO for ''%s'' differ (database: ''%s'' xml:''%s'') - DB contents should be updated (see %s)\n', ...
                                 a_floatNum, ...
                                 'AUX_FLUOROMETER_CHLA435', ...
                                 o_metaStruct.SENSOR_SERIAL_NO{idF3}, ...
                                 metaData.sensors.sensor_eco.sensor.sn, ...
                                 g_cogj_csvFileBddPathName);
                              fprintf(g_cogj_csvFileBddId, '%d;411;304;%s;SENSOR_SERIAL_NO\n', ...
                                 a_floatNum, ...
                                 metaData.sensors.sensor_eco.sensor.sn);
                           end
                        end
                        ...
                        if (~isempty(metaData.sensors.sensor_eco.sensor.model))
                           if (~strcmp(metaData.sensors.sensor_eco.sensor.model, o_metaStruct.SENSOR_MODEL{idF}))
                              ...
                              fprintf('WARNING: BDD: Float #%d: SENSOR_MODEL for ''%s'' differ (database: ''%s'' xml:''%s'') - DB contents should be updated (see %s)\n', ...
                                 ...
                                 metaData.sensors.sensor_eco.sensor.model, ...
                                 g_cogj_csvFileBddPathName);
                              fprintf(g_cogj_csvFileBddId, '%d;410;304;%s;SENSOR_MODEL\n', ...
                                 a_floatNum, ...
                                 metaData.sensors.sensor_eco.sensor.model);
                           end
                        end
                  ...
                  if (isfield(metaData.sensors.sensor_eco, 'channel_03'))
                     if (isfield(metaData.sensors.sensor_eco.channel_03, 'sf'))
                        if (~isfield(o_metaStruct.CALIBRATION_COEFFICIENT, 'ECO3'))
                           ...
                           fprintf('WARNING: COEF: Float #%d: ECO3 ScaleFactChloroA435 coef (%s) is missing in META.json file - calib_coef file contents should be updated (see %s)\n', ...
                              a_floatNum, ...
                              metaData.sensors.sensor_eco.channel_03.sf, ...
                              g_cogj_csvFileCoefPathName);
                           fprintf(g_cogj_csvFileCoefId, '%d;ECO3;ScaleFactChloroA435;%s\n', ...
                              a_floatNum, ...
                              metaData.sensors.sensor_eco.channel_03.sf);
                        elseif (str2double(metaData.sensors.sensor_eco.channel_03.sf) ~= str2double(o_metaStruct.CALIBRATION_COEFFICIENT.ECO3.ScaleFactChloroA435))
                           if (isempty(g_cogj_csvFileCoefId) || (g_cogj_csvFileCoefId == -1))
                              [g_cogj_csvFileCoefId, g_cogj_csvFileCoefPathName] = open_csv_file(a_outputCsvDirName, 'C', g_cogj_csvFileCoefPathName);
                           end
                           fprintf('WARNING: COEF: Float #%d: ECO3 ScaleFactChloroA435 coef differ (database: ''%s'' xml:''%s'') - DB contents should be updated (see %s)\n', ...
                              a_floatNum, ...
                              o_metaStruct.CALIBRATION_COEFFICIENT.ECO3.ScaleFactChloroA435, ...
                              metaData.sensors.sensor_eco.channel_03.sf, ...
                              g_cogj_csvFileCoefPathName);
                           fprintf(g_cogj_csvFileCoefId, '%d;ECO3;ScaleFactChloroA435;%s\n', ...
                              a_floatNum, ...
                     ...
                     if (isfield(metaData.sensors.sensor_eco.channel_03, 'dc'))
                        if (~isfield(o_metaStruct.CALIBRATION_COEFFICIENT, 'ECO3'))
                           ...
                           fprintf('WARNING: COEF: Float #%d: ECO3 DarkCountChloroA435 coef (%s) is missing in META.json file - calib_coef file contents should be updated (see %s)\n', ...
                              a_floatNum, ...
                              metaData.sensors.sensor_eco.channel_03.dc, ...
                              g_cogj_csvFileCoefPathName);
                           fprintf(g_cogj_csvFileCoefId, '%d;ECO3;DarkCountChloroA435;%s\n', ...
                              a_floatNum, ...
                              metaData.sensors.sensor_eco.channel_03.dc);
                        elseif (str2double(metaData.sensors.sensor_eco.channel_03.dc) ~= str2double(o_metaStruct.CALIBRATION_COEFFICIENT.ECO3.DarkCountChloroA435))
                           if (isempty(g_cogj_csvFileCoefId) || (g_cogj_csvFileCoefId == -1))
                              [g_cogj_csvFileCoefId, g_cogj_csvFileCoefPathName] = open_csv_file(a_outputCsvDirName, 'C', g_cogj_csvFileCoefPathName);
                           end
                           fprintf('WARNING: COEF: Float #%d: ECO3 DarkCountChloroA435 coef differ (database: ''%s'' xml:''%s'') - DB contents should be updated (see %s)\n', ...
                              a_floatNum, ...
                              o_metaStruct.CALIBRATION_COEFFICIENT.ECO3.DarkCountChloroA435, ...
                              metaData.sensors.sensor_eco.channel_03.dc, ...
                              g_cogj_csvFileCoefPathName);
                           fprintf(g_cogj_csvFileCoefId, '%d;ECO3;DarkCountChloroA435;%s\n', ...
                              a_floatNum, ...
