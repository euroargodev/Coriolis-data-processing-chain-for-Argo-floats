...
for idFloat = 1:length(floatList)
   ...
   if (any(strcmp(metaStruct.SENSOR_MOUNTED_ON_FLOAT, 'CROVER') == 1))
      ...
      if (~isempty(idF))
         croverCalibData.Pathlength_CP660 = metaData{idForWmo(idF), 4};
      end
      idF = find(strcmp(metaData(idForWmo, 5), 'CSCDARK_CP660'));
      if (~isempty(idF))
         croverCalibData.CSCDARK_CP660 = metaData{idForWmo(idF), 4};
      end
      idF = find(strcmp(metaData(idForWmo, 5), 'CSCCAL_CP660'));
      if (~isempty(idF))
         croverCalibData.CSCCAL_CP660 = metaData{idForWmo(idF), 4};
      end
      if (~isempty(croverCalibData))
         metaStruct.CALIBRATION_COEFFICIENT.CROVER = croverCalibData;
      end
   end
   ...
   dbConfigParamNameCode = [ ...
      ...
      {'OCR_DOWN_IRR_BANDWIDTH'}           {'CONFIG_PX_3_2_0_<I>_3'}; ...
      {'OCR_DOWN_IRR_WAVELENGTH'}          {'CONFIG_PX_3_2_0_<I>_2'}; ...
      {'OCR_VERTICAL_PRES_OFFSET'}         {'CONFIG_PX_1_2_0_0_0'}; ...
      {'ECO_BETA_ANGLE'}                   {'CONFIG_PX_1_3_0_0_2'}; ...
      {'ECO_BETA_BANDWIDTH'}               {'CONFIG_PX_3_3_0_<I>_1'}; ...
      {'ECO_BETA_WAVELENGTH'}              {'CONFIG_PX_3_3_0_<I>_0'}; ...
      {'ECO_CDOM_FLUO_EMIS_BANDWIDTH'}     {'CONFIG_PX_2_3_1_0_3'}; ...
      {'ECO_CDOM_FLUO_EMIS_WAVELENGTH'}    {'CONFIG_PX_2_3_1_0_1'}; ...
      {'ECO_CDOM_FLUO_EXCIT_BANDWIDTH'}    {'CONFIG_PX_2_3_1_0_2'}; ...
      {'ECO_CDOM_FLUO_EXCIT_WAVELENGTH'}   {'CONFIG_PX_2_3_1_0_0'}; ...
      {'ECO_CHLA_FLUO_EMIS_BANDWIDTH'}     {'CONFIG_PX_2_3_0_0_3'}; ...
      {'ECO_CHLA_FLUO_EMIS_WAVELENGTH'}    {'CONFIG_PX_2_3_0_0_1'}; ...
      {'ECO_CHLA_FLUO_EXCIT_BANDWIDTH'}    {'CONFIG_PX_2_3_0_0_2'}; ...
      {'ECO_CHLA_FLUO_EXCIT_WAVELENGTH'}   {'CONFIG_PX_2_3_0_0_0'}; ...
      {'ECO_CHLA435_FLUO_EMIS_BANDWIDTH'}  {'CONFIG_PX_2_3_3_0_3'}; ...
      {'ECO_CHLA435_FLUO_EMIS_WAVELGTH'}   {'CONFIG_PX_2_3_3_0_1'}; ...
      {'ECO_CHLA435_FLUO_EXCIT_BANDWIDTH'} {'CONFIG_PX_2_3_3_0_2'}; ...
      {'ECO_CHLA435_FLUO_EXCIT_WAVELGTH'}  {'CONFIG_PX_2_3_3_0_0'}; ...
      {'ECO_VERTICAL_PRES_OFFSET'}         {'CONFIG_PX_1_3_0_0_0'}; ...
      {'CROVER_VERTICAL_PRES_OFFSET'}      {'CONFIG_PX_1_5_0_0_0'}; ...
      {'SUNA_APF_OUTPUT_PIXEL_BEGIN'}      {'CONFIG_PX_1_6_0_0_3'}; ...
      {'SUNA_APF_OUTPUT_PIXEL_END'}        {'CONFIG_PX_1_6_0_0_4'}; ...
      {'SUNA_VERTICAL_PRES_OFFSET'}        {'CONFIG_PX_1_6_0_0_0'}; ...
      {'SUNA_WITH_SCOOP'}                  {'CONFIG_PX_1_6_0_0_5'}; ...
      {'UVP_VERTICAL_PRES_OFFSET'}         {'CONFIG_PX_1_10_0_0_0'}; ...
   ...
   configParamCode = dbConfigParamNameCode(:, 2);
   ...
   if (ismember(dacFormatId, [{'7.11'} {'7.12'} {'7.13'} {'7.14'} {'7.15'} {'7.16'} {'7.17'} {'7.18'}]))
      ...
      % check and parse UVP configuration frames
      if (any(sensorListNum == 8))
         metaStruct = get_uvp_configuration_frames(metaStruct, floatNum);
      end

   elseif (ismember(dacFormatId, [{'7.04'}]))
      metaStruct.META_AUX_UVP_FIRMWARE_VERSION = '2020.01';
   end
