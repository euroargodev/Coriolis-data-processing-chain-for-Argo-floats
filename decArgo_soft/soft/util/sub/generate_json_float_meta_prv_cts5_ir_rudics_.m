...
for idFloat = 1:length(floatList)
   ...
   % data base)
   switch (dacFormatId)
      case {'7.01', '7.02', '7.04', '7.11', '7.12', '7.13', '7.14', '7.15', '7.16'}
   ...
   dbConfigParamName = [ ...
      ...
      {'ECO_CHLA435_FLUO_EMIS_BANDWIDTH'} ...
      {'ECO_CHLA435_FLUO_EMIS_WAVELENGTH'} ...
      {'ECO_CHLA435_FLUO_EXCIT_BANDWIDTH'} ...
      {'ECO_CHLA435_FLUO_EXCIT_WAVELENGTH'} ...
   ...
   % for CTS5-USEA only
   if (ismember(dacFormatId, [{'7.11'} {'7.12'} {'7.13'} {'7.14'} {'7.15'} {'7.16'}]))
