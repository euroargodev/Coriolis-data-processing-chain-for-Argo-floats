...
for idFloat = 1:length(floatList)
   ...
   if (a_rudicsFlag == 0)
      if (~ismember(dacFormatId, [{'2.10.1.S'} {'2.11.1.S'} {'2.12.2.1.S'}]))
         fprintf('INFO: Float %d is not managed by this tool (DAC_FORMAT_ID (from PR_VERSION) : ''%s'')\n', ...
            floatNum, dacFormatId);
         continue
      end
   else
      if (~ismember(dacFormatId, [{'2.10.4.R'} {'2.11.3.R'} {'2.12.2.1.R'} {'2.12.3.R'} {'2.13.1.R'} {'2.13.1.1.R'} {'2.14.3.R'} {'2.15.0.R'}]))
         fprintf('INFO: Float %d is not managed by this tool (DAC_FORMAT_ID (from PR_VERSION) : ''%s'')\n', ...
            floatNum, dacFormatId);
         continue
      end
      ...
      for idC = 1:length(confNames)
         ...
         if (strcmp(floatConfName, 'iridium')) % see 6903699 & 6903700
            if (ismember(dacFormatId, [{'2.10.1.S'} {'2.11.1.S'} {'2.12.2.1.S'} {'2.10.4.R'} {'2.11.3.R'} {'2.12.2.1.R'} {'2.12.3.R'}]))
               continue
            elseif (ismember(dacFormatId, [{'2.13.1.R'} {'2.13.1.1.R'} {'2.14.3.R'} {'2.15.0.R'}]))
               floatConfValue = confData.(floatConfName){1};
               bddConfName = 'FLOAT_RUDICS_ID';
            else
               fprintf('ERROR: Float #%d: ''FLOAT_RUDICS_ID'' not managed yet for ''DAC_FORMAT_ID'' = ''%s''\n', ...
                  floatNum, dacFormatId);
            end
         else
            if (length(confData.(floatConfName)) > 1)
               ...
               elseif (strcmp(floatConfName, 'TelemetryDays'))
            ...
            if (isfield(configFloatStruct, floatConfName))
               ...
               if (strcmp(floatConfName, 'TelemetryDays'))
                  floatConfName1 = 'TelemetryDaysStart';
                  if (isfield(configFloatStruct, floatConfName1))
                     decConfName1 = configFloatStruct.(floatConfName1);
                     bddConfName1 = configBddStruct.(decConfName1);
                     bddConfName{end+1} = bddConfName1;
                  end
                  floatConfName2 = 'TelemetryDaysEnd';
                  if (isfield(configFloatStruct, floatConfName2))
                     decConfName2 = configFloatStruct.(floatConfName2);
                     bddConfName2 = configBddStruct.(decConfName2);
                     bddConfName{end+1} = bddConfName2;
                  end
               end
            end
         end
         ...
         if (~isempty(bddConfName))
            ...
            if (ismember(dacFormatId, [{'2.13.1.R'} {'2.13.1.1.R'} {'2.14.3.R'} {'2.15.0.R'}]))
               if (strcmp(floatConfName, 'TelemetryDays'))
                  nbLoops = 2;
                  bddConfNameAll = bddConfName;
                  floatConfValueAll = floatConfValue;
               end
            end
            for idL = 1:nbLoops
               if (nbLoops == 2)
                  ...
                  elseif (strcmp(floatConfName, 'TelemetryDays'))
                     bddConfName = bddConfNameAll{idL};
                     floatConfValue = floatConfValueAll{idL};
                  end
               end
               diffFlag = -1;
...
switch (a_dacFormatId)
   case {'2.10.1.S', '2.10.4.R', '2.11.1.S', '2.11.3.R', '2.12.2.1.S', '2.12.2.1.R', '2.12.3.R'}
   ...
   case {'2.13.1.R', '2.13.1.1.R', '2.14.3.R'}
      o_configStruct = struct( ...
         'CONFIG_DIR_ProfilingDirection', 'DIRECTION', ...
         'CONFIG_CT_CycleTime', 'CYCLE_TIME', ...
         'CONFIG_ARM_ActivateRecoveryModeFlag', 'ActivateRecoveryModeFlag', ...
         ...
         'CONFIG_IBD_IceBreakupDays', 'IceBreakupDays', ...
         'CONFIG_IMLT_IceDetectionTemperature', 'UnderIceMixedLayerCriticalTemp', ...
         'CONFIG_IDC_IceDescentCycles', 'IceDescentCycles', ...
         'CONFIG_IDP_IceDetectionMaxPres', 'IceDetectionMixedLayerPMax', ...
         'CONFIG_IEP_IceEvasionPressure', 'IceEvasionPressure', ...
         'CONFIG_ICEM_IceDetectionMask', 'ActiveIceDetectionMonth', ...
         'CONFIG_ITI_IdleTimerInterval', 'IdleTimerInterval', ...
         ...
         'CONFIG_PRE_MissionPreludePeriod', 'MissionPreludePeriod', ...
         'CONFIG_SPSPC_SurfacePressureStopPumpedCtd', 'SurfacePressureStopPumpedCtd', ...
         'CONFIG_TSD_IceTelemetryStartDay', 'IceTelemetryStartDay', ...
         'CONFIG_TED_IceTelemetryEndDay', 'IceTelemetryEndDay', ...
         'CONFIG_REP_ArgosTransmissionRepetitionPeriod', 'TRANS_REPETITION', ...
         'CONFIG_TT_IceTelemetryTimeout', 'IceTelemetryTimeout', ...
         'CONFIG_UP_UpTime', 'MissionCfgUpTime', ...
         'CONFIG_VM_VitalsMask', 'VitalsMask', ...
         'CONFIG_TBP_MaxAirBladderPressure', 'MissionCfgMaxAirBladderPressure', ...
         'CONFIG_FEXT_PistonFullExtension', 'FullyExtendedPistonPos', ...
   ...
   case {'2.15.0.R'}
      o_configStruct = struct( ...
         ...
         'CONFIG_HRC_HyperRetractCount', 'HyperRetractCount', ...
         'CONFIG_HRP_HyperRetractPressure', 'HyperRetractPressure', ...
         'CONFIG_IAT_IceAscentTimeout', 'IceAscentTimeout', ...      
         'CONFIG_IBD_IceBreakupDays', 'IceBreakupDays', ...
         'CONFIG_IMLT_IceDetectionTemperature', 'UnderIceMixedLayerCriticalTemp', ...
         'CONFIG_IDCO_IceDescentCount', 'IceDescentCount', ...
         'CONFIG_IDC_IceDescentCycles', 'IceDescentCycles', ...
         'CONFIG_IDN_IceDescentNudge', 'IceDescentNudge', ...
         'CONFIG_IDPRES_IceDescentPressure', 'IceDescentPressure', ...
         'CONFIG_IDT_IceDescentTimeout', 'IceDescentTimeout', ...
         'CONFIG_IDTI_IceDescentTimerInterval', 'IceDescentTimerInterval', ...
         'CONFIG_IDP_IceDetectionMaxPres', 'IceDetectionMixedLayerPMax', ...
         'CONFIG_IEP_IceEvasionPressure', 'IceEvasionPressure', ...
         'CONFIG_ICEM_IceDetectionMask', 'ActiveIceDetectionMonth', ...
         'CONFIG_ITI_IdleTimerInterval', 'IdleTimerInterval', ...
...
switch (a_dacFormatId)
   case {'2.10.1.S', '2.10.4.R', '2.11.1.S', '2.11.3.R', '2.12.2.1.S', '2.12.2.1.R', '2.12.3.R'}
      o_configStruct = struct( ...
         ...
         'IceDetectionMixedLayerPMax', 'CONFIG_IDP_IceDetectionMaxPres', ...
   ...
   case {'2.13.1.R', '2.13.1.1.R', '2.14.3.R'}
      o_configStruct = struct( ...
         ...
         'PreludeTime', 'CONFIG_PRE_MissionPreludePeriod', ...
         'SurfacePressure', 'CONFIG_SPSPC_SurfacePressureStopPumpedCtd', ...
         'TelemetryDaysStart', 'CONFIG_TSD_IceTelemetryStartDay', ...
         'TelemetryDaysEnd', 'CONFIG_TED_IceTelemetryEndDay', ...
         'TelemetryInterval', 'CONFIG_REP_ArgosTransmissionRepetitionPeriod', ...
   ...
   case {'2.15.0.R'}
      o_configStruct = struct( ...
         ...
         'IceBreakupDays', 'CONFIG_IBD_IceBreakupDays', ...
         'UnderIceMixedLayerCriticalTemp', 'CONFIG_IMLT_IceDetectionTemperature', ...
...
switch (a_techName)
   ...
   case {'FLOAT_RUDICS_ID'}
      o_techId = 2384;
   case {'IceTelemetryStartDay'}
      o_techId = 2458;
   case {'IceTelemetryEndDay'}
      o_techId = 2459;
   case {'IceTelemetryTimeout'}
      o_techId = 2460;
   otherwise
