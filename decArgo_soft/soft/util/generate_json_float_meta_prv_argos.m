...
outputDirName = ['C:\Users\jprannou\_RNU\DecArgo_soft\work\generate_json_float_meta_prv_argos_' datestr(now, 'yyyymmddTHHMMSS')];
   ...
   if (strcmp(dacFormatId, '4.52'))
      ...
      if (~isempty(idFRepRate))
         ...
         switch (dacFormatId)
            ...
            otherwise
               fprintf('WARNING: Nothing done yet in generate_json_float_meta_prv_argos for dacFormatId %s\n', dacFormatId);
         end
