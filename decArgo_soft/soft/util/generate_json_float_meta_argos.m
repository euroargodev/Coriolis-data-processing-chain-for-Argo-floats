...
%
% SYNTAX :
%  generate_json_float_meta_argos()
%
% INPUT PARAMETERS :
%
% OUTPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function generate_json_float_meta_argos()
...
outputDirName = ['C:\Users\jprannou\_RNU\DecArgo_soft\work\generate_json_float_meta_argos_' datestr(now, 'yyyymmddTHHMMSS')];
   ...
   if (strcmp(dacFormatId, '4.52'))
      ...
      if (~isempty(idFRepRate))
         ...
         switch (dacFormatId)
            ...
            otherwise
               fprintf('WARNING: Nothing done yet in generate_json_float_meta_argos for dacFormatId %s\n', dacFormatId);
         end
...
switch (a_dacFormatId)
   ...
   case {'4.52'}
      o_configStruct = struct( ...
         ...
         'CONFIG_MC2_CyclePeriod1', 'PR_CYCLE_PERIOD', ...
         'CONFIG_MC3_CyclePeriod2', 'PR_CYCLE_PERIOD', ...
         'CONFIG_MC002_CyclePeriod', 'PR_CYCLE_PERIOD', ...
