...
%
% SYNTAX :
%  generate_json_float_meta_remocean_flbb
%
% INPUT PARAMETERS :
%
% OUTPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function generate_json_float_meta_remocean_flbb
...
logFile = ['C:\Users\jprannou\_RNU\DecArgo_soft\work\generate_json_float_meta_remocean_flbb_' datestr(now, 'yyyymmddTHHMMSS') '.log'];
diary(logFile);
