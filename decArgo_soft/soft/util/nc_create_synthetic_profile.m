...
for idCy = 1:length(cyNumList)
   ...
   for idDir = 1:2
      ...
      if (~isempty(cProfFileName))
         ...
         profDataStruct = get_prof_data(cProfFileName, bProfFileName, profileDir);
      end
...
%
% SYNTAX :
%  [o_profData] = get_prof_data(a_cProfFileName, a_bProfFileName, a_profDir)
%
% INPUT PARAMETERS :
...
%   01/11/2018 - RNU - creation
% ------------------------------------------------------------------------------
function [o_profData] = get_prof_data(a_cProfFileName, a_bProfFileName, a_profDir)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% step #2: keep only levels with PRES_QC/PRES_ADJUSTED_QC = '1', then sort
% PRES levels in ascending order
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if (paramDataMode(1) == 'R')
   idDel = find(paramDataQc(:, 1) == g_decArgo_qcStrBad);
else
   idDel = find(paramDataAdjustedQc(:, 1) == g_decArgo_qcStrBad);
end
samplingCode(idDel) = [];
paramData(idDel, :) = [];
paramDataQc(idDel, :) = [];
...
% algorithm from Henry BITTIG (bittig@obs-vlfr.fr)on 19/01/2018 15:52
...
for idParam = 4:size(paramData, 2) % ignore T and S
