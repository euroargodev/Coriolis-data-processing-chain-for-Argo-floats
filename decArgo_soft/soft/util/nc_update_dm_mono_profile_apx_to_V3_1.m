...
%
% SYNTAX :
%   nc_update_dm_mono_profile_apx_to_V3_1 or nc_update_dm_mono_profile_apx_to_V3_13(6900189, 7900118)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function nc_update_dm_mono_profile_apx_to_V3_1(varargin)
...
logFile = [DIR_LOG_FILE '/' 'nc_update_dm_mono_profile_apx_to_V3_1' name '_' datestr(now, 'yyyymmddTHHMMSS') '.log'];
diary(logFile);
tic;
...
function [o_ok] = update_dm_file(a_inputDmFileName, ...
   a_inputRtCFileName, a_inputRtBFileName, ...
   a_outputCFileName, a_outputBFileName, ...
   a_direction, a_rtCyNum, a_bFileFlag, ...
   a_floatNum, a_jsonFloatInfoDirName, a_jsonFloatMetaDirName)
