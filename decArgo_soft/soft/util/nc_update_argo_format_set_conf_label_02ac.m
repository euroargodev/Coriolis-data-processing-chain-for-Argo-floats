...
%                              - see g_couf_oldLabelList and g_couf_newLabelList
%                              lists below
%   04/14/2021 - RNU - V 02ac: update configuration labels:
%                              - see g_couf_oldLabelList and g_couf_newLabelList
%                              lists below
% ------------------------------------------------------------------------------
function nc_update_argo_format_set_conf_label_02ac(varargin)
...
g_couf_ncUpdateArgoFormatVersion = '02ac';
...
try
   ...
   tmpDir = [DIR_TMP '/' 'nc_update_argo_format_set_conf_label_02ac_' currentTime];
   status = mkdir(tmpDir);
   if (status ~= 1)
   ...
   logFile = [DIR_LOG_FILE '/' 'nc_update_argo_format_set_conf_label_02ac_' currentTime '.log'];
   diary(logFile);
...
newChild.appendChild(docNode.createTextNode('Argo Coriolis update format tool (nc_update_argo_format_set_conf_label_02ac)'));
docRootNode.appendChild(newChild);
...
g_couf_oldLabelList = [ ...
   ...
   {'CONFIG_FlbbBetaWavelength_nm'} ...
   ];

g_couf_newLabelList = [ ...
   {'CONFIG_EcoBetaWavelength1_nm'} ...
   {'CONFIG_FlbbBetaWavelength1_nm'} ... 
   ];
