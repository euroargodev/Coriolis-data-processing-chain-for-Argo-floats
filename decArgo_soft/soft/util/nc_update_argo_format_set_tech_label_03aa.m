...
%
% SYNTAX :
%   nc_update_argo_format_set_tech_label_03aa or nc_update_argo_format_set_tech_label_03aa(6900189, 7900118)
%
% INPUT PARAMETERS :
...
%                              lists below
% ------------------------------------------------------------------------------
function nc_update_argo_format_set_tech_label_03aa(varargin)
...
g_couf_ncUpdateArgoFormatVersion = '03aa';
...
% initialize list of TECH labels to modify
init_label_list;
...
try
   ...
   tmpDir = [DIR_TMP '/' 'nc_update_argo_format_set_tech_label_03aa_' currentTime];
   status = mkdir(tmpDir);
   if (status ~= 1)
   ...
   logFile = [DIR_LOG_FILE '/' 'nc_update_argo_format_set_tech_label_03aa_' currentTime '.log'];
   diary(logFile);
...
newChild.appendChild(docNode.createTextNode('Argo Coriolis update format tool (nc_update_argo_format_set_tech_label_03aa)'));
docRootNode.appendChild(newChild);
...
% ------------------------------------------------------------------------------
% Initialize the list of TECH labels to update.
%
% SYNTAX :
%  init_label_list
%
...
g_couf_oldLabelList = [ ...
   {'FLAG_CROVERStatus_LOGICAL'} ...
   {'FLAG_ECO3Status_LOGICAL'} ...
   {'FLAG_OCRStatus_LOGICAL'} ...
   {'FLAG_OPTODEStatus_LOGICAL'} ...
   {'FLAG_SUNAStatus_LOGICAL'} ...
   {'NUMBER_CROVERAscentIridiumMessages_COUNT'} ...
   {'NUMBER_CROVERAscentSamplesDepthZone1_COUNT'} ...
   {'NUMBER_CROVERAscentSamplesDepthZone2_COUNT'} ...
   {'NUMBER_CROVERAscentSamplesDepthZone3_COUNT'} ...
   {'NUMBER_CROVERAscentSamplesDepthZone4_COUNT'} ...
   {'NUMBER_CROVERAscentSamplesDepthZone5_COUNT'} ...
   {'NUMBER_CROVERDescentIridiumMessages_COUNT'} ...
   {'NUMBER_CROVERDescentSamplesDepthZone1_COUNT'} ...
   {'NUMBER_CROVERDescentSamplesDepthZone2_COUNT'} ...
   {'NUMBER_CROVERDescentSamplesDepthZone3_COUNT'} ...
   {'NUMBER_CROVERDescentSamplesDepthZone4_COUNT'} ...
   {'NUMBER_CROVERDescentSamplesDepthZone5_COUNT'} ...
   {'NUMBER_CROVERParkIridiumMessages_COUNT'} ...
   {'NUMBER_ECO3AscentIridiumMessages_COUNT'} ...
   {'NUMBER_ECO3AscentSamplesDepthZone1_COUNT'} ...
   {'NUMBER_ECO3AscentSamplesDepthZone2_COUNT'} ...
   {'NUMBER_ECO3AscentSamplesDepthZone3_COUNT'} ...
   {'NUMBER_ECO3AscentSamplesDepthZone4_COUNT'} ...
   {'NUMBER_ECO3AscentSamplesDepthZone5_COUNT'} ...
   {'NUMBER_ECO3DescentIridiumMessages_COUNT'} ...
   {'NUMBER_ECO3DescentSamplesDepthZone1_COUNT'} ...
   {'NUMBER_ECO3DescentSamplesDepthZone2_COUNT'} ...
   {'NUMBER_ECO3DescentSamplesDepthZone3_COUNT'} ...
   {'NUMBER_ECO3DescentSamplesDepthZone4_COUNT'} ...
   {'NUMBER_ECO3DescentSamplesDepthZone5_COUNT'} ...
   {'NUMBER_ECO3ParkIridiumMessages_COUNT'} ...
   {'NUMBER_OCRAscentIridiumMessages_COUNT'} ...
   {'NUMBER_OCRAscentSamplesDepthZone1_COUNT'} ...
   {'NUMBER_OCRAscentSamplesDepthZone2_COUNT'} ...
   {'NUMBER_OCRAscentSamplesDepthZone3_COUNT'} ...
   {'NUMBER_OCRAscentSamplesDepthZone4_COUNT'} ...
   {'NUMBER_OCRAscentSamplesDepthZone5_COUNT'} ...
   {'NUMBER_OCRDescentIridiumMessages_COUNT'} ...
   {'NUMBER_OCRDescentSamplesDepthZone1_COUNT'} ...
   {'NUMBER_OCRDescentSamplesDepthZone2_COUNT'} ...
   {'NUMBER_OCRDescentSamplesDepthZone3_COUNT'} ...
   {'NUMBER_OCRDescentSamplesDepthZone4_COUNT'} ...
   {'NUMBER_OCRDescentSamplesDepthZone5_COUNT'} ...
   {'NUMBER_OCRParkIridiumMessages_COUNT'} ...
   ...
   {'NUMBER_ParkCROVERSamplesInternal_COUNT'} ...
   {'NUMBER_ParkECO3SamplesInternal_COUNT'} ...
   {'NUMBER_ParkOCRSamplesInternal_COUNT'} ...
   {'NUMBER_ParkOPTODESamplesInternal_COUNT'} ...
   {'NUMBER_ParkSUNASamplesInternal_COUNT'} ...
   {'NUMBER_SUNAAscentIridiumMessages_COUNT'} ...
   {'NUMBER_SUNAAscentSamplesDepthZone1_COUNT'} ...
   {'NUMBER_SUNAAscentSamplesDepthZone2_COUNT'} ...
   {'NUMBER_SUNAAscentSamplesDepthZone3_COUNT'} ...
   {'NUMBER_SUNAAscentSamplesDepthZone4_COUNT'} ...
   {'NUMBER_SUNAAscentSamplesDepthZone5_COUNT'} ...
   {'NUMBER_SUNADescentIridiumMessages_COUNT'} ...
   {'NUMBER_SUNADescentSamplesDepthZone1_COUNT'} ...
   {'NUMBER_SUNADescentSamplesDepthZone2_COUNT'} ...
   {'NUMBER_SUNADescentSamplesDepthZone3_COUNT'} ...
   {'NUMBER_SUNADescentSamplesDepthZone4_COUNT'} ...
   {'NUMBER_SUNADescentSamplesDepthZone5_COUNT'} ...
   {'NUMBER_SUNAParkIridiumMessages_COUNT'} ...
   ];

g_couf_newLabelList = [ ...
   {'FLAG_CroverStatus_LOGICAL'} ...
   {'FLAG_EcoStatus_LOGICAL'} ...
   {'FLAG_OcrStatus_LOGICAL'} ...
   {'FLAG_OptodeStatus_LOGICAL'} ...
   {'FLAG_SunaStatus_LOGICAL'} ...
   {'NUMBER_CroverAscentIridiumMessages_COUNT'} ...
   ...
   {'NUMBER_CroverDescentSamplesDepthZone5_COUNT'} ...
   {'NUMBER_CroverParkIridiumMessages_COUNT'} ...
   {'NUMBER_EcoAscentIridiumMessages_COUNT'} ...
   {'NUMBER_EcoAscentSamplesDepthZone1_COUNT'} ...
   {'NUMBER_EcoAscentSamplesDepthZone2_COUNT'} ...
   {'NUMBER_EcoAscentSamplesDepthZone3_COUNT'} ...
   {'NUMBER_EcoAscentSamplesDepthZone4_COUNT'} ...
   {'NUMBER_EcoAscentSamplesDepthZone5_COUNT'} ...
   {'NUMBER_EcoDescentIridiumMessages_COUNT'} ...
   {'NUMBER_EcoDescentSamplesDepthZone1_COUNT'} ...
   {'NUMBER_EcoDescentSamplesDepthZone2_COUNT'} ...
   {'NUMBER_EcoDescentSamplesDepthZone3_COUNT'} ...
   {'NUMBER_EcoDescentSamplesDepthZone4_COUNT'} ...
   {'NUMBER_EcoDescentSamplesDepthZone5_COUNT'} ...
   {'NUMBER_EcoParkIridiumMessages_COUNT'} ...
   {'NUMBER_OcrAscentIridiumMessages_COUNT'} ...
   {'NUMBER_OcrAscentSamplesDepthZone1_COUNT'} ...
   {'NUMBER_OcrAscentSamplesDepthZone2_COUNT'} ...
   {'NUMBER_OcrAscentSamplesDepthZone3_COUNT'} ...
   ...
   {'NUMBER_OptodeParkIridiumMessages_COUNT'} ...
   {'NUMBER_ParkCroverSamplesInternal_COUNT'} ...
   {'NUMBER_ParkEcoSamplesInternal_COUNT'} ...
   {'NUMBER_ParkOcrSamplesInternal_COUNT'} ...
   {'NUMBER_ParkOptodeSamplesInternal_COUNT'} ...
   {'NUMBER_ParkSunaSamplesInternal_COUNT'} ...
   {'NUMBER_SunaAscentIridiumMessages_COUNT'} ...
