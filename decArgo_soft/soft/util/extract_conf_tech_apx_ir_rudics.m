% ------------------------------------------------------------------------------
% Retrieve all CONF and TECH parameter names from Apex Iridium Rudics or Navis
% msg file for a given float.
%
% SYNTAX :
%   extract_conf_tech_apx_ir_rudics or extract_conf_tech_apx_ir_rudics(6900189, 7900118)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function extract_conf_tech_apx_ir_rudics(varargin)
...
logFile = [DIR_LOG_FILE '/' 'extract_conf_tech_apx_ir_rudics' name '_' timeInfo '.log'];
diary(logFile);
tic;
