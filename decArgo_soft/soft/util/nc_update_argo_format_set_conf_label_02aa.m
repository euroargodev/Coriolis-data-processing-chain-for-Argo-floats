...
%
% SYNTAX :
%   nc_update_argo_format_set_conf_label_02aa or nc_update_argo_format_set_conf_label_02aa(6900189, 7900118)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
% RELEASES :
%   02/24/2016 - RNU - V 02aa: update configuration labels:
%                              - see g_couf_oldLabelList and g_couf_newLabelList
%                              lists below
% ------------------------------------------------------------------------------
function nc_update_argo_format_set_conf_label_02aa(varargin)
...
DIR_INPUT_OUTPUT_NC_FILES = 'C:\Users\jprannou\_DATA\OUT\test_update_format_conf\';
...
g_couf_ncUpdateArgoFormatVersion = '02aa';
...
% initialize list of CONF labels to modify
init_label_list;
...
try
   ...
   tmpDir = [DIR_TMP '/' 'nc_update_argo_format_set_conf_label_02aa_' currentTime];
   status = mkdir(tmpDir);
   if (status ~= 1)
   ...
   logFile = [DIR_LOG_FILE '/' 'nc_update_argo_format_set_conf_label_02aa_' currentTime '.log'];
   diary(logFile);
            ...
            if ((exist(floatDirPathName, 'dir') == 7) && ~strcmp(floatDirName, '.') && ~strcmp(floatDirName, '..'))
               ...
               if (status == 1)
                  ...
                  if ((isempty(floatList)) || (~isempty(floatList) && ismember(floatWmo, floatList)))
                     ...
                     % meta-data file
                     floatFiles = dir([floatDirPathName '/' sprintf('%d_meta.nc', floatWmo)]);
...
if (exist(a_ncPathFileName, 'file') == 2)
   ...
   if (~isempty(ncData))
      ...
      if (strcmp(formatVersion, '3.1'))
         ...
         idVal = find(strcmp('LAUNCH_CONFIG_PARAMETER_NAME', ncData(1:2:end)) == 1, 1);
         launchConfigParamNameList = unique(cellstr(ncData{2*idVal}'));
         idVal = find(strcmp('CONFIG_PARAMETER_NAME', ncData(1:2:end)) == 1, 1);
         configParamNameList = unique(cellstr(ncData{2*idVal}'));
         
         for idL = 1:length(g_couf_oldLabelList)
            if (~isempty(find(strcmp(g_couf_oldLabelList{idL}, launchConfigParamNameList) == 1, 1)) || ...
                  ~isempty(find(strcmp(g_couf_oldLabelList{idL}, configParamNameList) == 1, 1)))
               updateNeeded = 1;
               break
            end
         end
   ...
   if (updateNeeded == 1)
      ...
      if (status == 1)
         ...
         if (ok == 1)
            ...
            g_couf_reportData.metaFile = [g_couf_reportData.metaFile {a_ncPathFileName}];
...
if (exist(a_ncPathFileName, 'file') == 2)
   ...
   varList = [{'LAUNCH_CONFIG_PARAMETER_NAME'} {'CONFIG_PARAMETER_NAME'}];
...
newChild.appendChild(docNode.createTextNode('Argo Coriolis update format tool (nc_update_argo_format_set_conf_label_02aa)'));
docRootNode.appendChild(newChild);
...
g_couf_oldLabelList = [ ...
   {'CONFIG_OcrMinTransmittedPAR_COUNT'} ...
   {'CONFIG_OcrMaxTransmittedPAR_COUNT'} ...
   {'CONFIG_SunaMinTransmittedNitratEconcentration_umole/L'} ...
   {'CONFIG_SunaMaxTransmittedNitratEconcentration_umole/L'} ...
   {'CONFIG_CtdAscentSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDepthZone1AscentSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDepthZone1DataProcessingMode_NUMBER'} ...
   {'CONFIG_CtdDepthZone1DepthZone2PressureThreshold_dbar'} ...
   {'CONFIG_CtdDepthZone1DescentToParkPresSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDepthZone1DescentToProfilePresSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDepthZone1DriftAtParkPresSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDepthZone1DriftAtProfilePresSamplingPeriod_minutes'} ...
   {'CONFIG_CtdDepthZone1PowerAcquisitionMode_NUMBER'} ...
   {'CONFIG_CtdDepthZone1SlicesThickness_dbar'} ...
   {'CONFIG_CtdDepthZone2AscentSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDepthZone2DataProcessingMode_NUMBER'} ...
   {'CONFIG_CtdDepthZone2DepthZone3PressureThreshold_dbar'} ...
   {'CONFIG_CtdDepthZone2DescentToParkPresSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDepthZone2DescentToProfilePresSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDepthZone2DriftAtParkPresSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDepthZone2DriftAtProfilePresSamplingPeriod_minutes'} ...
   {'CONFIG_CtdDepthZone2PowerAcquisitionMode_NUMBER'} ...
   {'CONFIG_CtdDepthZone2SlicesThickness_dbar'} ...
   {'CONFIG_CtdDepthZone3AscentSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDepthZone3DataProcessingMode_NUMBER'} ...
   {'CONFIG_CtdDepthZone3DepthZone4PressureThreshold_dbar'} ...
   {'CONFIG_CtdDepthZone3DescentToParkPresSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDepthZone3DescentToProfilePresSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDepthZone3DriftAtParkPresSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDepthZone3DriftAtProfilePresSamplingPeriod_minutes'} ...
   {'CONFIG_CtdDepthZone3PowerAcquisitionMode_NUMBER'} ...
   {'CONFIG_CtdDepthZone3SlicesThickness_dbar'} ...
   {'CONFIG_CtdDepthZone4AscentSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDepthZone4DataProcessingMode_NUMBER'} ...
   {'CONFIG_CtdDepthZone4DepthZone5PressureThreshold_dbar'} ...
   {'CONFIG_CtdDepthZone4DescentToParkPresSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDepthZone4DescentToProfilePresSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDepthZone4DriftAtParkPresSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDepthZone4DriftAtProfilePresSamplingPeriod_minutes'} ...
   {'CONFIG_CtdDepthZone4PowerAcquisitionMode_NUMBER'} ...
   {'CONFIG_CtdDepthZone4SlicesThickness_dbar'} ...
   {'CONFIG_CtdDepthZone5AscentSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDepthZone5DataProcessingMode_NUMBER'} ...
   {'CONFIG_CtdDepthZone5DescentToParkPresSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDepthZone5DescentToProfilePresSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDepthZone5DriftAtParkPresSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDepthZone5DriftAtProfilePresSamplingPeriod_minutes'} ...
   {'CONFIG_CtdDepthZone5PowerAcquisitionMode_NUMBER'} ...
   {'CONFIG_CtdDepthZone5SlicesThickness_dbar'} ...
   {'CONFIG_CtdDescentToParkPresSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDescentToProfilePresSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDriftAtParkPresSamplingPeriod_seconds'} ...
   {'CONFIG_CtdDriftAtProfilePresSamplingPeriod_minutes'} ...
   {'CONFIG_CtdFirstValidSample_NUMBER'} ...
