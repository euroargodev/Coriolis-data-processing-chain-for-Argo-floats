...
switch a_inputSensorName
   ...
   case 'OCR'
      switch a_decId
         case {130}
            o_sensorName = [{'RADIOMETER_DOWN_IRR412'} {'RADIOMETER_DOWN_IRR443'} {'RADIOMETER_DOWN_IRR490'} {'RADIOMETER_DOWN_IRR665'}];
   ...
   case 'ECO3'
      switch a_decId
         case {131}
            ...
            o_sensorModel = [{'ECO_FLBBFL'} {'ECO_FLBBFL'} {'ECO_FLBBFL'}];
         otherwise
   ...
   case 'HYDROC'
      o_sensorName = {'AUX_NDIR_ANALYZER_PCO2'};
      o_sensorDimLevel = [1401];
      o_sensorMaker = {'4H-JENA'};
      o_sensorModel = {'HYDROC_CO2'};
      
   case 'RAMSES_ARC'
      o_sensorName = {'AUX_RADIOMETER_UP_RAD'};
      o_sensorDimLevel = [1501];
      o_sensorMaker = {'TRIOS'};
      o_sensorModel = {'RAMSES_ARC'};

   case 'IMU'
      o_sensorName = {'AUX_INERTIAL_SENSOR'};
      o_sensorDimLevel = [1601];
      o_sensorMaker = {'NKE'};
      o_sensorModel = {'9AXIS_IMU'};
...
switch a_inputSensorName
   ...
   case 'OCR'
      switch a_decId
         case {130}
            o_paramName = [ ...
               {'RAW_DOWNWELLING_IRRADIANCE412'} {'RAW_DOWNWELLING_IRRADIANCE443'} ...
               {'RAW_DOWNWELLING_IRRADIANCE490'} {'RAW_DOWNWELLING_IRRADIANCE665'} ...
               {'DOWN_IRRADIANCE412'} {'DOWN_IRRADIANCE443'} ...
               {'DOWN_IRRADIANCE490'} {'DOWN_IRRADIANCE665'} ...
               ];
            o_paramDimLevel = [202 209 203 210 206 211 207 212];
            o_paramSensor = [ ...
               {'RADIOMETER_DOWN_IRR412'} {'RADIOMETER_DOWN_IRR443'} ...
               {'RADIOMETER_DOWN_IRR490'} {'RADIOMETER_DOWN_IRR665'} ...
               {'RADIOMETER_DOWN_IRR412'} {'RADIOMETER_DOWN_IRR443'} ...
               {'RADIOMETER_DOWN_IRR490'} {'RADIOMETER_DOWN_IRR665'} ...
               ];
            o_paramUnits = [ ...
   ...
   case 'OPUS'
      o_paramName = [ ...
         ...
         {'BLACK_AVERAGING_NITRATE'} ...
         {'BLACK_FLASH_COUNT_NITRATE'} ...
         {'BLACK_TEMP_NITRATE'} ...
         {'UV_INTENSITY_DARK_NITRATE_AVG'} ...
         {'UV_INTENSITY_DARK_NITRATE_SD'} ...
         ];
      o_paramDimLevel = 901:911;
      o_paramSensor = [ ...
   ...
   case 'RAMSES'
      o_paramName = [ ...
         ...
         {'RADIOMETER_DOWN_IRR_PRE_PRES'} ...
         {'RADIOMETER_DOWN_IRR_POST_PRES'} ...
         {'RADIOMETER_DOWN_IRR_PRE_INCLINATION'} ...
         {'RADIOMETER_DOWN_IRR_POST_INCLINATION'} ...
         {'RADIOMETER_DOWN_IRR_DARK_AVERAGE'} ...
         {'RAW_DOWNWELLING_IRRADIANCE'} ...
         ];
      o_paramDimLevel = 1201:1207;
      o_paramSensor = [ ...
   ...
   case 'HYDROC'
      ...
      o_paramDimLevel = 1401:1412;
      o_paramSensor = [ ...
         {'AUX_NDIR_ANALYZER_PCO2'} ...
         {'AUX_NDIR_ANALYZER_PCO2'} ...
         {'AUX_NDIR_ANALYZER_PCO2'} ...
         {'AUX_NDIR_ANALYZER_PCO2'} ...
         {'AUX_NDIR_ANALYZER_PCO2'} ...
   ...
   case 'RAMSES_ARC'
      o_paramName = [ ...
         ...
         {'RADIOMETER_UP_RAD_PRE_PRES'} ...
         {'RADIOMETER_UP_RAD_POST_PRES'} ...
         {'RADIOMETER_UP_RAD_PRE_INCLINATION'} ...
         {'RADIOMETER_UP_RAD_POST_INCLINATION'} ...
         {'RADIOMETER_UP_RAD_DARK_AVERAGE'} ...
         {'RAW_UPWELLING_RADIANCE'} ...
         ];
      o_paramDimLevel = 1501:1507;
      o_paramSensor = [ ...
         {'AUX_RADIOMETER_UP_RAD'} ...
         {'AUX_RADIOMETER_UP_RAD'} ...
         {'AUX_RADIOMETER_UP_RAD'} ...
         {'AUX_RADIOMETER_UP_RAD'} ...
         {'AUX_RADIOMETER_UP_RAD'} ...
   ...
   case 'IMU'
      o_paramName = [ ...
         ...
         {'SURFACE_LINEAR_ACCELERATION_COUNT_X'} ...
         {'SURFACE_LINEAR_ACCELERATION_COUNT_Y'} ...
         {'SURFACE_LINEAR_ACCELERATION_COUNT_Z'} ...
         {'SURFACE_MAGNETIC_FIELD_COUNT_X'} ...
         {'SURFACE_MAGNETIC_FIELD_COUNT_Y'} ...
         {'SURFACE_MAGNETIC_FIELD_COUNT_Z'} ...
         {'TILT'} ...
         {'HEADING'} ...
         ];
      o_paramDimLevel = 1601:1618;
      o_paramSensor = [ ...
         {'AUX_INERTIAL_SENSOR'} ...
         {'AUX_INERTIAL_SENSOR'} ...
         {'AUX_INERTIAL_SENSOR'} ...
