...
% one (named IGNORED_PARAMETER below).
%
% SYNTAX :
...
% name of the PARAMETER that should be not considered (a 'B' parameter
% should be provided; its associated 'I' parameters will also be ignored)
IGNORED_PARAMETER = 'NITRATE';
...
g_cocd_ncCopyMonoProfileDmAndQcVersion = '1.2';
...
%   a_ignoredParameter   : 'B' parameter to ignore
%
% OUTPUT PARAMETERS :
%
% EXAMPLES :
...
%
% SYNTAX :
%  [o_paramNameList] = get_associated_param(a_paramName)
%
% INPUT PARAMETERS :
%   a_paramName : B parameter name
%
% OUTPUT PARAMETERS :
...
%   08/10/2018 - RNU - creation
% ------------------------------------------------------------------------------
function [o_paramNameList] = get_associated_param(a_paramName)
