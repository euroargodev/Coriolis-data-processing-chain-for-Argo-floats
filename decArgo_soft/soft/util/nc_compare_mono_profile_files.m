...
%
% SYNTAX :
%   nc_compare_mono_profile_files or nc_compare_mono_profile_files(6900189, 7900118)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function nc_compare_mono_profile_files(varargin)
...
logFile = [DIR_LOG_CSV_FILE '/' 'nc_compare_mono_profile_files' name '_' datestr(now, 'yyyymmddTHHMMSS') '.log'];
diary(logFile);
tic;
...
outputFileName = [DIR_LOG_CSV_FILE '/' 'nc_compare_mono_profile_files' name '_' datestr(now, 'yyyymmddTHHMMSS') '.csv'];
