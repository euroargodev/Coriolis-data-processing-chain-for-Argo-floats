...
floatMetaFileName = 'C:\Users\jprannou\_RNU\DecPrv_info\_configParamNames\export_JPR_ArvorI_5-43_20160614.txt';
...
for idFloat = 1:length(floatList)
   ...
   if (strcmp(dacFormatId, '5.43'))
      ...
      if (~isempty(idDir))
         idDescSampPeriod = find(strcmp(metaStruct.CONFIG_PARAMETER_NAME, 'CONFIG_MC8_DescentSamplingPeriod') == 1);
...
switch (a_dacFormatId)
   ...
   case {'5.43'}
      o_configStruct = struct( ...
         ...
         'CONFIG_MC7_CTDPowerAcquisitionMode', '1', ...
         'CONFIG_MC8_DescentSamplingPeriod', '0', ...
         'CONFIG_MC9_DriftSamplingPeriod', '12', ...
...
switch (a_dacFormatId)
   ...
   case {'5.43'}
      o_configStruct = struct( ...
         ...
         'CONFIG_MC7_CTDPowerAcquisitionMode', 'PRCFG_Acquisition_mode', ...
         'CONFIG_MC8_DescentSamplingPeriod', 'DESC_PROFILE_PERIOD', ...
         'CONFIG_MC9_DriftSamplingPeriod', 'PR_IMMERSION_DRIFT_PERIOD', ...
