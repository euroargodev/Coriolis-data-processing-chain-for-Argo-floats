% ------------------------------------------------------------------------------
% Use the JAVA format checker on a set of floats to check TRAJ 3.2 consistency.
%
% SYNTAX :
%   nc_check_traj_format or nc_check_traj_format(6900189, 7900118)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
% RELEASES :
%   08/16/2022 - RNU - creation
% ------------------------------------------------------------------------------
function nc_check_traj_format(varargin)

% directory of the JAVA checker
DIR_JAVA_CHECKER = 'C:\Users\jprannou\_RNU\Argo\checker_US\TRAJ_CHECKER\javaChecker\file_checker_exec_v2.8.00-alpha_spec_v2.8.00-alpha\';
...
logFile = [DIR_LOG_FILE '/' 'nc_check_traj_format' name '_' datestr(now, 'yyyymmddTHHMMSS') '.log'];
diary(logFile);
tic;

% create the CSV output file
outputFileName = [DIR_CSV_FILE '/' 'nc_check_traj_format' name '_' datestr(now, 'yyyymmddTHHMMSS') '.csv'];
