               ...
               if (~isempty(metaData.CALIBRATION_COEFFICIENT))
                  ...
                  if (length(idF) == 1)
                     ...
                     if (length(idF) == 1)
                        ...
                        fprintf('ERROR: TEST063: Unable to find ''DarkCountChloroA'' in Json ECO2/ECO3/FLBB/FLNTU calibration information\n');
                     end
                     ...
                     if (length(idF) == 1)
                        ...
                        fprintf('ERROR: TEST063: Unable to find ''ScaleFactChloroA'' in Json ECO2/ECO3/FLBB/FLNTU calibration information\n');
                     end
                  end
               end
            end
