...
while 1
   ...
   if (startRecording)
      ...
      if (length(data) >= 21)
         if (~isempty(data{4}))
            o_data = [o_data; data([1:7 16 17 18:21])'];
         end
      else
...
if (putHeader == 1)
   header = 'Program;PTT;Satellite;Location date;Location class;Latitude;Longitude;Frequency;Altitude;Error radius;Semi-major axis;Semi-minor axis;Ellipse orientation';
   fprintf(fidOut, '%s\n', header);
end
