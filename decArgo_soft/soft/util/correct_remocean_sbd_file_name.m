...
%
% INPUT PARAMETERS :
%   varargin : to directory to check the SBD files
%
% OUTPUT PARAMETERS :
%
% EXAMPLES :
         ...
         for idFile = 1:length(sbdFiles)
            ...
            if (sbdCyFileSize > 0)
               ...
               if (rem(sbdCyFileSize, 140) == 0)
                  ...
                  [dataCycles] = decode_cycle_number_105(sbdData);
