...
g_cocd_ncCopyMonoProfileDmAndQcVersion = '1.11';
...
%
% SYNTAX :
%  nc_copy_mono_profile_dm_and_qc_specific_(a_floatList, a_logFile, ...
...
%   08/10/2018 - RNU - creation
% ------------------------------------------------------------------------------
function nc_copy_mono_profile_dm_and_qc_specific_(a_floatList, a_logFile, ...
   a_dirInputOldNcFiles, ...
   a_dirInputNewNcFiles, ...
   a_dirOutputNcFiles, ...
