...
%
% SYNTAX :
%   nc_compare_mono_profile_files_apx_ir_in_DM_PTS_only or nc_compare_mono_profile_files_apx_ir_in_DM_PTS_only(6900189, 7900118)
%
% INPUT PARAMETERS :
...
%                      ones)
%   09/06/2017 - RNU - in this version the data comparison is done on PTS only
% ------------------------------------------------------------------------------
function nc_compare_mono_profile_files_apx_ir_in_DM_PTS_only(varargin)
...
logFile = [DIR_LOG_CSV_FILE '/' 'nc_compare_mono_profile_files_apx_ir_in_DM_PTS_only' name '_' datestr(now, 'yyyymmddTHHMMSS') '.log'];
diary(logFile);
tic;
