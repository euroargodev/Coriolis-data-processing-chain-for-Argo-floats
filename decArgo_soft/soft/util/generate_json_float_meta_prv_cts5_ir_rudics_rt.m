...
%
% SYNTAX :
%  generate_json_float_meta_prv_cts5_ir_rudics_rt(varargin)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function generate_json_float_meta_prv_cts5_ir_rudics_rt(varargin)
...
if (~isempty(g_cogj_xmlReportDirName))
   xmlFileName = [g_cogj_xmlReportDirName '/generate_json_float_meta_prv_cts5_ir_rudics_rt_' currentTime '.xml'];
else
   xmlFileName = [tempdir '/generate_json_float_meta_prv_cts5_ir_rudics_rt_' currentTime '.xml'];
end
...
newChild.appendChild(docNode.createTextNode('Argo Coriolis float meta-data json file generating tool (generate_json_float_meta_prv_cts5_ir_rudics_rt)'));
docRootNode.appendChild(newChild);
