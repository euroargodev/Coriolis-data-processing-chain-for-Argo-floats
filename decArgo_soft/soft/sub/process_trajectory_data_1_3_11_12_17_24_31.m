...
%
% SYNTAX :
%  [o_tabTrajNMeas, o_tabTrajNCycle] = process_trajectory_data_1_3_11_12_17_24_31( ...
%    a_cycleNum, ...
...
% ------------------------------------------------------------------------------
function [o_tabTrajNMeas, o_tabTrajNCycle] = process_trajectory_data_1_3_11_12_17_24_31( ...
   a_cycleNum, ...
   a_addLaunchData, a_floatSurfData, ...
   a_floatClockDrift, ...
   a_descentStartDate, a_firstStabDate, a_firstStabPres, a_descentEndDate, ...
...
if (~isempty(a_tabTech))
   ...
   % should not be stored in cycle #1 of ASFAR mode
   if ~((a_decoderId == 31) && (a_cycleNum == 1))
