...
%
% SYNTAX :
%  [o_NITRATE, o_BISULFIDE] = compute_drift_NITRATE_BISULFIDE_from_spectrum_110_113_127( ...
...
% ------------------------------------------------------------------------------
function [o_NITRATE, o_BISULFIDE] = compute_drift_NITRATE_BISULFIDE_from_spectrum_110_113_127( ...
   a_UV_INTENSITY_NITRATE, a_UV_INTENSITY_DARK_NITRATE, ...
   a_UV_INTENSITY_NITRATE_fill_value, a_UV_INTENSITY_DARK_NITRATE_fill_value, ...
   a_NITRATE_fill_value, a_BISULFIDE_fill_value, ...
   a_UV_INTENSITY_NITRATE_dates, a_ctdDates, a_ctdData, ...
...
if (~isempty(idNoDef))
   ...
   if (nbComplex > 0)
      fprintf('WARNING: Float #%d Cycle #%d Profile #%d: %d NITRATE and BISULFIDE values are complex - these values are set to fill value in drift measurements of SUNA sensor\n', ...
         g_decArgo_floatNum, ...
         a_profSuna.cycleNumber, ...
         a_profSuna.profileNumber, ...
         nbComplex);
