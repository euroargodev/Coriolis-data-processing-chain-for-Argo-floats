...
%
% SYNTAX :
%  [o_tabTrajNMeas, o_tabTrajNCycle, o_tabTechNMeas] = process_trajectory_data_214_217( ...
...
% ------------------------------------------------------------------------------
function [o_tabTrajNMeas, o_tabTrajNCycle, o_tabTechNMeas] = process_trajectory_data_214_217( ...
   a_cycleNum, a_deepCycle, ...
   a_gpsData, a_iridiumMailData, ...
   a_cycleStartDate, ...
   a_descentToParkStartDate, a_firstStabDate, a_firstStabPres, a_descentToParkEndDate, ...
   ...
   if (~isempty(tabTech2) && (a_iceDetected == 0))
      ...
      if (any([pres temp psal] ~= 0))
         ...
         if (any(tabTech2((18:20)+ID_OFFSET) ~= 0) && any(tabTech2((18:20)+ID_OFFSET) ~= 65535))
            ...
            c1PhaseDoxy = sensor_2_value_C1C2Phase_doxy_201_to_203_206_to_209_213_to_217(tabTech2(18+ID_OFFSET));
            c2PhaseDoxy = sensor_2_value_C1C2Phase_doxy_201_to_203_206_to_209_213_to_217(tabTech2(19+ID_OFFSET));
            tempDoxy = sensor_2_value_for_temp_doxy_201_to_203_206_to_209_213_to_217(tabTech2(20+ID_OFFSET));
            doxy = compute_DOXY_201_203_206_209_213_to_217(c1PhaseDoxy, c2PhaseDoxy, tempDoxy, pres, temp, psal);
