...
%
% SYNTAX :
%  [o_PH_IN_SITU_FREE, o_PH_IN_SITU_TOTAL] = compute_PH_111_113_114_115_123( ...
%    a_VRS_PH, ...
%    a_VRS_PH_fillValue, ...
...
% ------------------------------------------------------------------------------
function [o_PH_IN_SITU_FREE, o_PH_IN_SITU_TOTAL] = compute_PH_111_113_114_115_123( ...
   a_VRS_PH, ...
   a_VRS_PH_fillValue, ...
   a_PRES, a_TEMP, a_PSAL, ...
   a_PRES_fillValue, a_TEMP_fillValue, a_PSAL_fillValue, ...
...
if (~isempty(idNoDef))
   ...
   if (any(isinf(o_PH_IN_SITU_FREE)) || any(isinf(o_PH_IN_SITU_TOTAL)))
      ...
      if (~isempty(idToDef))
         fprintf('INFO: Float #%d Cycle #%d Profile #%d%c: %d PH_IN_SITU_FREE values are Inf - these values are set to fill value in drift measurements of TRANSISTOR_PH sensor\n', ...
            g_decArgo_floatNum, ...
            a_profTransPh.cycleNumber, ...
            a_profTransPh.profileNumber, ...
            a_profTransPh.direction, ...
