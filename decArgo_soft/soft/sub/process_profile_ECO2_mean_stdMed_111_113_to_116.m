...
%
% SYNTAX :
%  [o_tabProfiles, o_tabDrift] = process_profile_ECO2_mean_stdMed_111_113_to_116( ...
...
% ------------------------------------------------------------------------------
function [o_tabProfiles, o_tabDrift] = process_profile_ECO2_mean_stdMed_111_113_to_116( ...
   a_dataECO2Mean, a_dataECO2StdMed, ...
   a_descentToParkStartDate, a_ascentEndDate, a_gpsData, a_sensorTechECO2, a_decoderId)
