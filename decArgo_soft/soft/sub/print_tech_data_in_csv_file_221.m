...
elseif (length(idF2) == 1)
   ...
   if (a_deepCycle == 1)
      ...
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas C1PHASE_DOXY; %d; => %.3f; degree\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 13+ID_OFFSET), sensor_2_value_for_C1C2phase_ir_sbd_2xx(a_tabTech2(id, 13+ID_OFFSET)));
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas C2PHASE_DOXY; %d; => %.3f; degree\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 14+ID_OFFSET), sensor_2_value_for_C1C2phase_ir_sbd_2xx(a_tabTech2(id, 14+ID_OFFSET)));
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas TEMP_DOXY; %d; => %.3f; degC\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 15+ID_OFFSET), sensor_2_value_for_temp_doxy_ir_sbd_2xx(a_tabTech2(id, 15+ID_OFFSET)));
