...
data(:, 7) = compute_CHLA_105_to_110_121_122(data(:, 4), g_decArgo_chloroADef, paramCHLA.fillValue);
% paramBBP700 = get_netcdf_param_attributes('BBP700');
% data(:, 8) = compute_BBP700_105_to_110_121_122(data(:, 5), g_decArgo_backscatDef, paramBBP700.fillValue);
