...
%
% SYNTAX :
%  [o_tempValues] = sensor_2_value_for_temperature_201_to_203_215(a_tempCounts)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_tempValues] = sensor_2_value_for_temperature_201_to_203_215(a_tempCounts)
