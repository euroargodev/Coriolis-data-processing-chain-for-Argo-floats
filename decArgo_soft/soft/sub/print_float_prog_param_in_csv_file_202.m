...
%
% SYNTAX :
%  print_float_prog_param_in_csv_file_202(a_floatParam)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function print_float_prog_param_in_csv_file_202(a_floatParam)
...
elseif (size(a_floatParam, 1) == 1)
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog; PT23: Hydraulic packets transmission flag; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_floatParam(id, 49));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog; PT24: Internal pressure calibration coeficient #1; %.3f\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_floatParam(id, 50));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog; PT25: Internal pressure calibration coeficient #2; %f\n', ...
