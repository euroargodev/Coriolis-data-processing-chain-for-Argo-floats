...
%
% SYNTAX :
%  print_data_in_csv_file_ir_rudics_cts4_111_113_114_115( ...
%    a_decoderId, ...
...
% ------------------------------------------------------------------------------
function print_data_in_csv_file_ir_rudics_cts4_111_113_114_115( ...
   a_decoderId, ...
   a_cyProfPhaseList, a_cyProfPhaseIndexList, ...
   a_dataCTD, a_dataOXY, ...
   a_dataECO2, a_dataECO3, ...
      ...
      for idDataType = 1:length(dataTypeList)
         ...
         switch (dataType)
            ...
            case 6
               ...
               print_data_in_csv_file_ECO2_mean_stdMed_111_113_114_115( ...
                  a_decoderId, cycleNum, profNum, phaseNum, ...
                  a_dataECO2Mean, a_dataECO2StdMed);
               
            case 8
               % ECO2 (raw)
               print_data_in_csv_file_ECO2_raw_111_113_114_115( ...
                  a_decoderId, cycleNum, profNum, phaseNum, ...
                  a_dataECO2Raw);
               ...
               switch (a_decoderId)
                  ...
                  case {115}
                     print_data_in_csv_file_ECO3_mean_stdMed_108_109_115( ...
                        ...
                        a_dataECO3Mean, a_dataECO3StdMed);
                  otherwise
                     fprintf('WARNING: Float #%d: Nothing implemented yet in print_data_in_csv_file_ir_rudics_cts4_111_113_114_115 for decoderId #%d\n', ...
                        g_decArgo_floatNum, ...
                        a_decoderId);
               end
            ...
            case 11
               ...
               switch (a_decoderId)
                  case {111, 113, 114}
                     print_data_in_csv_file_ECO3_raw_105_to_107_110_to_114( ...
                        a_decoderId, cycleNum, profNum, phaseNum, ...
                        a_dataECO3Raw);
                  case {115}
                     print_data_in_csv_file_ECO3_raw_108_109_115( ...
                        a_decoderId, cycleNum, profNum, phaseNum, ...
                        a_dataECO3Raw);
                  otherwise
                     fprintf('WARNING: Float #%d: Nothing implemented yet in print_data_in_csv_file_ir_rudics_cts4_111_113_114_115 for decoderId #%d\n', ...
