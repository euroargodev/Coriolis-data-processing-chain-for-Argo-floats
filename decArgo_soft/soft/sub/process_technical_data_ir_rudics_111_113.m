...
%    a_sensorTechFLNTU, a_sensorTechCROVER, a_sensorTechSUNA, a_deepCycleFlag, ...
%    a_tabTech, a_refDay, ...
%    a_floatProgParam)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function process_technical_data_ir_rudics_111_113( ...
   a_decoderId, a_cyProfPhaseList, ...
   a_sensorTechCTD, a_sensorTechOPTODE, a_sensorTechOCR, ...
   a_sensorTechECO2, a_sensorTechECO3, ...
   a_sensorTechFLNTU, a_sensorTechCROVER, a_sensorTechSUNA, a_deepCycleFlag, ...
...
for id = 1:length(tabStart)
   ...
   switch (tabType(id))
      ...
      case 253
         ...
         process_float_tech_data_ir_rudics_111_113( ...
