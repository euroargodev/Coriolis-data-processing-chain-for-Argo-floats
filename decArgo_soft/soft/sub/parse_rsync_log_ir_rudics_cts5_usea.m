...
%
% SYNTAX :
%  [o_floatFiles] = parse_rsync_log_ir_rudics_cts5_usea(a_rsyncLogName, a_floatLoginName)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_floatFiles] = parse_rsync_log_ir_rudics_cts5_usea(a_rsyncLogName, a_floatLoginName)
