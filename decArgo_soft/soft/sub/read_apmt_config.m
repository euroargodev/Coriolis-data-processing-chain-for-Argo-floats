...
%
% SYNTAX :
%  [o_configData] = read_apmt_config(a_inputFilePathName)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_configData] = read_apmt_config(a_inputFilePathName)
...
[configSectionList, configInfoStruct] = init_config_info_struct;
...
%
% SYNTAX :
%  [o_configSectionList, o_configInfoStruct] = init_config_info_struct
%
% INPUT PARAMETERS :
%
% OUTPUT PARAMETERS :
...
%   02/21/2017 - RNU - creation
% ------------------------------------------------------------------------------
function [o_configSectionList, o_configInfoStruct] = init_config_info_struct
