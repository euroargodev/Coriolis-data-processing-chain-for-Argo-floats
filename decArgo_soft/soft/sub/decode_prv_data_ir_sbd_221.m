...
%
% SYNTAX :
%  [o_decodedData] = decode_prv_data_ir_sbd_221(a_tabData, a_sbdFileName, a_sbdFileDate)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_decodedData] = decode_prv_data_ir_sbd_221(a_tabData, a_sbdFileName, a_sbdFileDate)
...
switch (packType)
   ...
   case 0
      ...
      tabTech1 = [packType tabTech1(1:75)' floatTime gpsLocLon gpsLocLat a_sbdFileDate];
   ...
   case 4
      ...
      tabTech2 = [packType tabTech2(1:81)' a_sbdFileDate];
      ...
      decodedData.expNbNearSurface = tabTech2(44);
      decodedData.expNbInAir = tabTech2(45);
   ...
   case 5
      ...
      tabNbBits = [ ...
         repmat(8, 1, 6) 16 ...
         16 repmat(8, 1, 6) repmat(16, 1, 4) 8 8 8 16 16 8 8 ...
         repmat(8, 1, 6) 16 repmat(8, 1, 5) 16 repmat(8, 1, 4) 16 repmat(8, 1, 12) 16 16 8 8 16 8 16 16 ...
         repmat(8, 1, 20) ...
         ];
      % get item bits
