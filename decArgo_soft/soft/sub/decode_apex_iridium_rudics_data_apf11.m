...
for idCy = 1:length(a_cycleList)
   ...
   if (ismember(a_decoderId, [1121, 1122, 1123, 1124, 1125, 1126, 1127]))
      % 2.11.3.R, 2.13.1.R & 2.13.1.1.R, 2.12.3.R, 2.14.3.R, 2.15.0.R, 2.10.4.R, 2.12.2.1.R
         
      [miscInfoSci, miscInfoSys, miscEvtsSys, ...
         metaData, missionCfg, sampleCfg, ...
         profCtdP, profCtdPt, profCtdPts, profCtdPtsh, profDo, ...
         profCtdCp, profCtdCpH, profFlbbCd, profFlbbCdCfg, profOcr504I, ...
         profRamses, ...
      ...
      [profDo, ...
         profCtdPtsh, profCtdCpH, profFlbbCd, profRafos] = ...
      ...
      if (~isempty(g_decArgo_outputCsvFileId))
         ...
         print_dates_apx_apf11_in_csv_file( ...
            profCtdP, profCtdPt, profCtdPts, profCtdPtsh, profDo, ...
            profFlbbCd, profFlbbCd, profOcr504I, profRamses, ...
            profRafosRtc, profRafos, ...
         ...
         [profDo, profFlbbCd] = ...
            remove_parameter_from_profile_apx_apf11_ir(profDo, profFlbbCd, a_decoderId);
         ...
         [cycleProfile] = process_apx_apf11_ir_profile( ...
            ...
            profFlbbCd, profOcr504I, profRamses, ...
            cycleTimeData, ...
         ...
         [o_tabTrajNMeas, o_tabTrajNCycle, o_tabTechAuxNMeas] = ...
            ...
            cycleNum, ...
            profCtdP, profCtdPt, profCtdPts, profCtdPtsh, profDo, ...
            profCtdCp, profCtdCpH, profFlbbCd, profOcr504I, profRamses, ...
            profRafosRtc, profRafos, ...
