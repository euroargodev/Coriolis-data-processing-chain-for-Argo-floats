...
%
% SYNTAX :
%  [o_tabProfiles, o_tabDrift] = process_profiles_ir_rudics_cts4_105_to_110_112( ...
%    a_decoderId, ...
%    a_cyProfPhaseList, ...
...
% ------------------------------------------------------------------------------
function [o_tabProfiles, o_tabDrift] = process_profiles_ir_rudics_cts4_105_to_110_112( ...
   a_decoderId, ...
   a_cyProfPhaseList, ...
   a_dataCTD, a_dataOXY, a_dataOCR, a_dataECO3, ...
   a_dataFLNTU, a_dataCROVER, a_dataSUNA, ...
