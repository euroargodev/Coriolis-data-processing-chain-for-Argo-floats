...
%
% SYNTAX :
%  [o_engineeringData] = parse_apx_ir_rudics_engineering_data(a_engineeringDataStr)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_engineeringData] = parse_apx_ir_rudics_engineering_data(a_engineeringDataStr)
