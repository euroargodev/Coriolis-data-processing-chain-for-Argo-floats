...
%
% SYNTAX :
%  [o_tabTrajIndex, o_tabTrajData] = collect_trajectory_data_ir_rudics_111_113_114( ...
...
% ------------------------------------------------------------------------------
function [o_tabTrajIndex, o_tabTrajData] = collect_trajectory_data_ir_rudics_111_113_114( ...
   a_decoderId, a_tabProfiles, a_tabDrift, ...
   a_floatPres, a_grounding, a_tabTech, a_refDay, ...
   a_cycleStartDate, a_buoyancyRedStartDate, ...
   a_descentToParkStartDate, ...
...
if (~isempty(a_grounding))
   ...
   paramInternalVacuum = get_netcdf_param_attributes('INTERNAL_VACCUM');
...
for idPack = 1:size(a_tabTech, 1)
   ...
   [trajFromTechStruct] = collect_traj_data_from_float_tech_ir_rudics_111_113_114( ...
