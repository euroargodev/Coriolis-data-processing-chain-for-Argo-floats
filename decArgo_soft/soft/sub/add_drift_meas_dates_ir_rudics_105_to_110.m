...
%    add_drift_meas_dates_ir_rudics_105_to_110(a_decoderId, ...
...
if (~isempty(a_dataCTDMeanDate))
   ...
   for idL = 1:length(idDrift)
      [a_dataCTDMeanDate(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(0, ...
...
if (~isempty(a_dataCTDStdMedDate))
   ...
   for idL = 1:length(idDrift)
      [a_dataCTDStdMedDate(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(0, ...
...
if (~isempty(a_dataCTDRawDate))
   ...
   for idL = 1:length(idDrift)
      [a_dataCTDRawDate(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(0, ...
...
if (~isempty(a_dataOXYMeanDate))
   ...
   for idL = 1:length(idDrift)
      [a_dataOXYMeanDate(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(1, ...
...
if (~isempty(a_dataOXYStdMedDate))
   ...
   for idL = 1:length(idDrift)
      [a_dataOXYStdMedDate(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(1, ...
...
if (~isempty(a_dataOXYRawDate))
   ...
   for idL = 1:length(idDrift)
      [a_dataOXYRawDate(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(1, ...
...
if (~isempty(a_dataECO3MeanDate))
   ...
   for idL = 1:length(idDrift)
      [a_dataECO3MeanDate(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(3, ...
...
if (~isempty(a_dataECO3StdMedDate))
   ...
   for idL = 1:length(idDrift)
      [a_dataECO3StdMedDate(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(3, ...
...
if (~isempty(a_dataECO3RawDate))
   ...
   for idL = 1:length(idDrift)
      [a_dataECO3RawDate(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(3, ...
...
if (~isempty(a_dataOCRMeanDate))
   ...
   for idL = 1:length(idDrift)
      [a_dataOCRMeanDate(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(2, ...
...
if (~isempty(a_dataOCRStdMedDate))
   ...
   for idL = 1:length(idDrift)
      [a_dataOCRStdMedDate(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(2, ...
...
if (~isempty(a_dataOCRRawDate))
   ...
   for idL = 1:length(idDrift)
      [a_dataOCRRawDate(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(2, ...
...
if (~isempty(a_dataFLNTUMeanDate))
   ...
   for idL = 1:length(idDrift)
      [a_dataFLNTUMeanDate(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(4, ...
...
if (~isempty(a_dataFLNTUStdMedDate))
   ...
   for idL = 1:length(idDrift)
      [a_dataFLNTUStdMedDate(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(4, ...
...
if (~isempty(a_dataFLNTURawDate))
   ...
   for idL = 1:length(idDrift)
      [a_dataFLNTURawDate(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(4, ...
...
if (~isempty(a_dataCROVERMeanDate))
   ...
   for idL = 1:length(idDrift)
      [a_dataCROVERMeanDate(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(5, ...
...
if (~isempty(a_dataCROVERStdMedDate))
   ...
   for idL = 1:length(idDrift)
      [a_dataCROVERStdMedDate(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(5, ...
...
if (~isempty(a_dataCROVERRawDate))
   ...
   for idL = 1:length(idDrift)
      [a_dataCROVERRawDate(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(5, ...
...
if (~isempty(a_dataSUNAMeanDate))
   ...
   for idL = 1:length(idDrift)
      [a_dataSUNAMeanDate(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(6, ...
...
if (~isempty(a_dataSUNAStdMedDate))
   ...
   for idL = 1:length(idDrift)
      [a_dataSUNAStdMedDate(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(6, ...
...
if (~isempty(a_dataSUNARawDate))
   ...
   for idL = 1:length(idDrift)
      [a_dataSUNARawDate(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(6, ...
...
if (~isempty(a_dataSUNAAPFDate))
   ...
   for idL = 1:length(idDrift)
      [a_dataSUNAAPFDate(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(6, ...
...
if (~isempty(a_dataSUNAAPF2))
   if (~isempty(a_dataSUNAAPF2Date))
      ...
      for idL = 1:length(idDrift)
         [a_dataSUNAAPF2Date(idDrift(idL), 4:end)] = compute_drift_dates_ir_rudics_105_to_110(6, ...
