...
%
% SYNTAX :
%  store_tech2_data_for_nc_210(a_tabTech2, a_deepCycle)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function store_tech2_data_for_nc_210(a_tabTech2, a_deepCycle)
...
if (a_deepCycle == 1)
   ...
   g_decArgo_outputNcParamValue{end+1} = sensor_2_value_for_pressure_202_210(tabTech2(15+ID_OFFSET));
   ...
   if (tabTech2(32+ID_OFFSET) > 0)
      ...
      g_decArgo_outputNcParamValue{end+1} = sensor_2_value_for_pressure_202_210(tabTech2(34+ID_OFFSET));
