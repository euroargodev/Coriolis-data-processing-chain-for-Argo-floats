...
%
% SYNTAX :
%  store_gps_data_ir_sbd_nva_2001_2002(a_tabTech)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function store_gps_data_ir_sbd_nva_2001_2002(a_tabTech)
...
if (~isempty(a_tabTech))
   ...
   for idTech = 1:size(a_tabTech, 1)
      ...
      gpsTime = sprintf('%02d %s', ...
         a_tabTech(idTech, 40+ID_OFFSET), ...
         format_time_dec_argo(a_tabTech(idTech, 41+ID_OFFSET)));
