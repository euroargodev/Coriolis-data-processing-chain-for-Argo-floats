...
[techSectionList, techInfoStruct] = init_tech_info_struct;
...
%
% SYNTAX :
%  [o_techSectionList, o_techInfoStruct] = init_tech_info_struct
%
% INPUT PARAMETERS :
%
% OUTPUT PARAMETERS :
...
%   02/21/2017 - RNU - creation
% ------------------------------------------------------------------------------
function [o_techSectionList, o_techInfoStruct] = init_tech_info_struct
...
o_newStruct.func1 = []; % function to be applied final information to adjust it from clock offset (time adjustment)
