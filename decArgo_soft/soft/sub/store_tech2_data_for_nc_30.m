...
%
% SYNTAX :
%  store_tech2_data_for_nc_30(a_tabTech, a_floatTimeParts, a_utcTimeJuld, a_floatClockDrift, o_deepCycle)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function store_tech2_data_for_nc_30(a_tabTech, a_floatTimeParts, a_utcTimeJuld, a_floatClockDrift, o_deepCycle)
