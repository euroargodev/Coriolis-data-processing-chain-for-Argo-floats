% ------------------------------------------------------------------------------
% Create drift data set from decoded CTDO messages.
%
% SYNTAX :
%  [o_parkOcc, o_parkDate, o_parkTransDate, ...
%    o_parkPres, o_parkTemp, o_parkSal, o_parkRawDoxy] = ...
%    create_prv_drift_4_19(a_tabDrifCTDO, a_nbDriftMeas, a_refDay, ...
...
[parkDateHour] = compute_drift_dates_1_4_11_12_19( ...
   1, a_tabDrifCTDO, a_driftSamplingPeriod, ...
...
if (isempty(parkDateHour))
   ...
   [parkDateHour] = compute_drift_dates_1_4_11_12_19( ...
      2, a_tabDrifCTDO, a_driftSamplingPeriod, ...
