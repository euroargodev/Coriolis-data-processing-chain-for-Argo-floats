...
%
% SYNTAX :
%  [o_tabProfiles] = process_profiles_206_to_208_213( ...
...
% ------------------------------------------------------------------------------
function [o_tabProfiles] = process_profiles_206_to_208_213( ...
   a_descProfDate, a_descProfPres, a_descProfTemp, a_descProfSal, ...
   a_descProfC1PhaseDoxy, a_descProfC2PhaseDoxy, a_descProfTempDoxy, a_descProfDoxy, ...
   a_ascProfDate, a_ascProfPres, a_ascProfTemp, a_ascProfSal, ...
   a_ascProfC1PhaseDoxy, a_ascProfC2PhaseDoxy, a_ascProfTempDoxy, a_ascProfDoxy, ...
...
switch (a_decoderId)
   case {206, 207, 208} % Provor-DO Iridium 5.71 & 5.7 & 5.72
      ...
      if (~isempty(a_tabTech))
         ...
         temp = sensor_2_value_for_temp_204_to_214_217_219_220_222_to_224(tabTech(42));
   ...
   case {213, 214}
      ...
      if (~isempty(a_tabTech))
         ...
         tabTech = a_tabTech(end, :);
         pres = sensor_2_value_for_pressure_202_210_to_214_217_222_to_224(tabTech(16));
         temp = sensor_2_value_for_temp_204_to_214_217_219_220_222_to_224(tabTech(17));
