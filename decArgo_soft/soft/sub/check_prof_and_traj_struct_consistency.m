               ...
               if (~isempty(paramDataMode))
                  if (length(paramDataMode) == length(paramList))
                     ...
                     if (~all(paramDataMode == ' '))
                        ...
                        % fprintf('INFO: PROF-TRAJ CONSISTENCY: PROF: Float #%d Cycle #%d: nProf %d: paramDataMode useless\n', ...
                        %    g_decArgo_floatNum, ...
                        %    prof.outputCycleNumber, ...
                        %    nProf);
                     end
                  ...
                  if (~isempty(paramDataMode))
                     if (length(paramDataMode) == length(paramList))
                        if (~all(paramDataMode == ' '))
                           ...
                           % fprintf('INFO: PROF-TRAJ CONSISTENCY: TRAJ: Float #%d Cycle #%d: MC %d: idM %d: paramDataMode useless\n', ...
                           %    g_decArgo_floatNum, ...
                           %    nMeas.outputCycleNumber, ...
                           %    measStruct.measCode, ...
                           %    idM);
