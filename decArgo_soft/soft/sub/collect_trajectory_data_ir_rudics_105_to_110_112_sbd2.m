...
%
% SYNTAX :
%  [o_tabTrajIndex, o_tabTrajData] = collect_trajectory_data_ir_rudics_105_to_110_112_sbd2( ...
...
% ------------------------------------------------------------------------------
function [o_tabTrajIndex, o_tabTrajData] = collect_trajectory_data_ir_rudics_105_to_110_112_sbd2( ...
   a_decoderId, a_tabProfiles, a_tabDrift, ...
   a_floatProgTech, a_floatProgParam, ...
   a_floatPres, a_tabTech, a_refDay, ...
   a_cycleStartDate, a_buoyancyRedStartDate, ...
