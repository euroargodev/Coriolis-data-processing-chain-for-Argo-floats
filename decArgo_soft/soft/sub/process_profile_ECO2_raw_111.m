...
%
% SYNTAX :
%  [o_tabProfiles, o_tabDrift] = process_profile_ECO2_raw_111( ...
%    a_dataECO2Raw, ...
...
% ------------------------------------------------------------------------------
function [o_tabProfiles, o_tabDrift] = process_profile_ECO2_raw_111( ...
   a_dataECO2Raw, ...
   a_descentToParkStartDate, a_ascentEndDate, a_gpsData, a_sensorTechECO2, a_decoderId)
...
cycleNumList = sort(unique(a_dataECO2RawDate(:, 1)));
profileNumList = sort(unique(a_dataECO2RawDate(:, 2)));
phaseNumList = sort(unique(a_dataECO2RawDate(:, 3)));
