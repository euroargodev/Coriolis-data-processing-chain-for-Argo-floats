...
%
% SYNTAX :
%  [o_gpsData, o_gpsInfo, o_techData] = process_apx_ir_rudics_gps_data( ...
...
% ------------------------------------------------------------------------------
function [o_gpsData, o_gpsInfo, o_techData] = process_apx_ir_rudics_gps_data( ...
   a_gpsFixDataStr, a_techData, a_gpsData)
...
[gpsLocDate, gpsLocLon, gpsLocLat, ...
   ...
   gpsLocFailedAcqTime, gpsLocFailedIce] = parse_apx_ir_rudics_gps_fix(a_gpsFixDataStr);
