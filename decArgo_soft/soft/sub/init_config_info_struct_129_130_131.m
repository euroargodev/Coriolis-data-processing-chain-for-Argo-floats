...
% ------------------------------------------------------------------------------
% RELEASES :
%   06/13/2022 - RNU - creation
% ------------------------------------------------------------------------------
function [o_configSectionList, o_configInfoStruct] = init_config_info_struct_129_130_131
...
o_configSectionList = [ ...
   ...
   {'SENSOR_09'} ... % UVP6 TAXO
   {'SENSOR_10'} ... % NONE
   {'SENSOR_11'} ... % UVP6 BLACK
   {'SENSOR_13'} ... % EXTTRIG
   {'SENSOR_14'} ... % RAMSES
   {'SENSOR_15'} ... % OPUS LIGHT
   {'SENSOR_16'} ... % OPUS BLACK
   {'SENSOR_17'} ... % MPE
   {'SENSOR_18'} ... % HYDROC M
   {'SENSOR_19'} ... % HYDROC C
   {'SENSOR_20'} ... % IMU
...
% IMU
o_configInfoStruct.SENSOR_20 = o_configInfoStruct.SENSOR_;
for idP = 54:60
   param = init_basic_struct;
   param.num = idP;
   switch (idP)
   ...
   o_configInfoStruct.SENSOR_20{end+1} = param;
end

% RAMSES-2
o_configInfoStruct.SENSOR_21 = [];
for idP = 0:56
   param = init_basic_struct;
   param.num = idP;
   switch (idP)
   ...
   o_configInfoStruct.SENSOR_21{end+1} = param;
end
...
for idP = 0:1
   ...
   switch (idP)
      case 0
         param.fmtIn = '%u';
         param.name = 'orientation mode (0= horizontal, 1=vertical)';
         param.fmtOut = '%d';
      case 1
         param.fmtIn = '%u';
         param.name = 'acquisition mode (0=raw, 1=tilt+heading)';
         param.fmtOut = '%d';
   end
   o_configInfoStruct.IMU{end+1} = param;
end
