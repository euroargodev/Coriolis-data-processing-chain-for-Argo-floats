...
%
% SYNTAX :
%  process_float_tech_data_ir_rudics_sbd2_one( ...
...
% ------------------------------------------------------------------------------
function process_float_tech_data_ir_rudics_sbd2_one( ...
   a_cycleNum, a_profNum, a_phaseNum, a_dataIndex, ...
   a_tabTech, a_refDay)
...
buoyancyRedStartDate = a_refDay + a_tabTech(a_dataIndex, 14) + a_tabTech(a_dataIndex, 15)/1440;
g_decArgo_outputNcParamIndex = [g_decArgo_outputNcParamIndex; ...
