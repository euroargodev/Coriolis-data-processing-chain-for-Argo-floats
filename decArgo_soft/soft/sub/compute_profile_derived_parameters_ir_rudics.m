   ...
   if (~ismember(a_decoderId, [110, 113, 127]))
      ...
      for idP = 1:size(paramToDeriveList, 1)
         ...
         if (~isempty(idF1) && ~isempty(idF2))
            ...
            [nitrate, rmsError] = compute_profile_NITRATE_105_to_109_111_112_114_121_to_126( ...
...
if (~ismember(a_decoderId, [106, 107, 109, 110, 111, 112, 113, 114])) % without PPOX_DOXY
   ...
   if (~isempty(ctdIntData))
      ...
      switch (a_decoderId)
         ...
         case {121, 122, 124, 126, 127}
            ...
            o_DOXY(idNoDef) = compute_DOXY_107_109_to_111_113_114_121_122_124_126_127( ...
   ...
   if (~isempty(ctdIntData))
      ...
      switch (a_decoderId)
         ...
         case {107, 109, 110, 111, 113, 114}
            ...
            o_PPOX_DOXY(idNoDef) = compute_PPOX_DOXY_107_109_to_111_113_114_121_122_124_126_127( ...
               a_C1PHASE_DOXY(idNoDef), ...
               a_C2PHASE_DOXY(idNoDef), ...
               a_TEMP_DOXY(idNoDef), ...
               a_C1PHASE_DOXY_fillValue, ...
...
if (~isempty(ctdDataNoDef))
   ...
   if (~isempty(ctdIntData))
      ...
      [o_PH_IN_SITU_FREE(idNoDef), o_PH_IN_SITU_TOTAL(idNoDef)] = compute_PH_111_113_114_123( ...
         a_VRS_PH(idNoDef), ...
         a_VRS_PH_fillValue, ...
         ctdIntData(idNoDef, 1), ...
         ctdIntData(idNoDef, 2), ...
