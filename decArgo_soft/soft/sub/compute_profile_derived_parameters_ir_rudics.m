...
for idP = 1:length(paramToDeriveList)
   ...
   if (~isempty(idF))
      ...
      downIrr380 = compute_DOWN_IRRADIANCE380_105_to_112_121_122( ...
         a_profOcr.data(:, idF), ...
...
for idP = 1:length(paramToDeriveList)
   ...
   if (~isempty(idF))
      ...
      downIrr412 = compute_DOWN_IRRADIANCE412_105_to_112_121_122( ...
         a_profOcr.data(:, idF), ...
         paramToDerive.fillValue, derivedParam.fillValue);
...
for idP = 1:length(paramToDeriveList)
   ...
   if (~isempty(idF))
      ...
      downIrr490 = compute_DOWN_IRRADIANCE490_105_to_112_121_122( ...
         a_profOcr.data(:, idF), ...
         paramToDerive.fillValue, derivedParam.fillValue);
...
for idP = 1:length(paramToDeriveList)
   ...
   if (~isempty(idF))
      ...
      downPar = compute_DOWNWELLING_PAR_105_to_112_121_122( ...
         a_profOcr.data(:, idF), ...
         paramToDerive.fillValue, derivedParam.fillValue);
...
for idP = 1:length(paramToDeriveList)
   ...
   if (~isempty(idF))
      ...
      chla = compute_CHLA_105_to_112_121_122( ...
         a_profEco2.data(:, idF), ...
         paramToDerive.fillValue, derivedParam.fillValue);
...
for idP = 1:length(paramToDeriveList)
   ...
   if (~isempty(idF))
      ...
      cdom = compute_CDOM_105_to_107_110_112_121_122( ...
         a_profEco3.data(:, idF), ...
         paramToDerive.fillValue, derivedParam.fillValue);
...
if (~isempty(ctdDataNoDef))
   ...
   if (~isempty(ctdIntData))
      ...
      if (a_lambda == 700)
         o_BBP(idNoNan) = compute_BBP700_105_to_112_121_122( ...
...
for idP = 1:length(paramToDeriveList)
   ...
   if (~isempty(idF))
      ...
      bbp700 = compute_BBP700_105_to_112_121_122_V1( ...
         a_profEco3.data(:, idF), ...
         paramToDerive.fillValue, derivedParam.fillValue);
...
if (~FITLM_MATLAB_FUNCTION_NOT_AVAILABLE)
   if (a_decoderId ~= 110)
      ...
      for idP = 1:size(paramToDeriveList, 1)
         ...
         if (~isempty(idF1) && ~isempty(idF2))
            ...
            nitrate = compute_profile_NITRATE_105_to_109_111_112_121_122( ...
   ...
   for idP = 1:length(paramToDeriveList)
      ...
      if (~isempty(idF))
         ...
         nitrate = compute_profile_NITRATE_from_MOLAR_105_to_109_111_112_121_122( ...
            a_profSuna.data(:, idF), ...
            paramToDerive.fillValue, derivedParam.fillValue, ...
            a_profSuna.data(:, 1), ctdMeasData, ...
            paramPres.fillValue, ...
