...
for idP = 1:length(paramToDeriveList)
   ...
   if (~isempty(idF))
      ...
      downIrr380 = compute_DOWN_IRRADIANCE380_105_to_110_121( ...
         a_profOcr.data(:, idF), ...
...
for idP = 1:length(paramToDeriveList)
   ...
   if (~isempty(idF))
      ...
      downIrr412 = compute_DOWN_IRRADIANCE412_105_to_110_121( ...
         a_profOcr.data(:, idF), ...
         paramToDerive.fillValue, derivedParam.fillValue);
...
for idP = 1:length(paramToDeriveList)
   ...
   if (~isempty(idF))
      ...
      downIrr490 = compute_DOWN_IRRADIANCE490_105_to_110_121( ...
         a_profOcr.data(:, idF), ...
         paramToDerive.fillValue, derivedParam.fillValue);
...
for idP = 1:length(paramToDeriveList)
   ...
   if (~isempty(idF))
      ...
      downPar = compute_DOWNWELLING_PAR_105_to_110_121( ...
         a_profOcr.data(:, idF), ...
         paramToDerive.fillValue, derivedParam.fillValue);
...
for idP = 1:length(paramToDeriveList)
   ...
   if (~isempty(idF))
      ...
      chla = compute_CHLA_105_to_110_121( ...
         a_profEco3.data(:, idF), ...
         paramToDerive.fillValue, derivedParam.fillValue);
...
for idP = 1:length(paramToDeriveList)
   ...
   if (~isempty(idF))
      ...
      cdom = compute_CDOM_105_to_107_110_121( ...
         a_profEco3.data(:, idF), ...
         paramToDerive.fillValue, derivedParam.fillValue);
...
if (~isempty(ctdDataNoDef))
   ...
   if (~isempty(ctdIntData))
      ...
      if (a_lambda == 700)
         o_BBP(idNoNan) = compute_BBP700_105_to_110_121( ...
...
for idP = 1:length(paramToDeriveList)
   ...
   if (~isempty(idF))
      ...
      bbp700 = compute_BBP700_105_to_110_121_V1( ...
         a_profEco3.data(:, idF), ...
         paramToDerive.fillValue, derivedParam.fillValue);
...
if (~isempty(ctdDataNoDef))
   ...
   if (~isempty(ctdIntData))
      ...
      switch (a_decoderId)
         ...
         case {107, 109, 110, 121}
            
            % compute DOXY values using the Stern-Volmer equation
            o_DOXY(idNoNan) = compute_DOXY_107_109_110_121( ...
               a_C1PHASE_DOXY(idNoNan), ...
               a_C2PHASE_DOXY(idNoNan), ...
               a_TEMP_DOXY(idNoNan), ...
               a_C1PHASE_DOXY_fillValue, ...
