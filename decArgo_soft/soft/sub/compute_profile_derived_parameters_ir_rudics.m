...
for idP = 1:length(paramToDeriveList)
   ...
   if (~isempty(idF))
      ...
      chla = compute_CHLA_105_to_112_121_to_125_1121_1122_1322( ...
         a_profEco2.data(:, idF), ...
         paramToDerive.fillValue, derivedParam.fillValue);
...
for idP = 1:length(paramToDeriveList)
   ...
   if (~isempty(idF))
      ...
      cdom = compute_CDOM_105_to_107_110_112_121_to_125_1121_1122_1322( ...
         a_profEco3.data(:, idF), ...
         paramToDerive.fillValue, derivedParam.fillValue);
...
if (~isempty(ctdDataNoDef))
   ...
   if (~isempty(ctdIntData))
      ...
      if (a_lambda == 700)
         o_BBP(idNoDef) = compute_BBP700_105_to_112_121_to_125_1121_1122_1322( ...
...
for idP = 1:length(paramToDeriveList)
   ...
   if (~isempty(idF))
      ...
      bbp700 = compute_BBP700_105_to_112_121_to_125_1121_1122_1322_V1( ...
         a_profEco3.data(:, idF), ...
         paramToDerive.fillValue, derivedParam.fillValue);
   ...
   if (~isempty(ctdIntData))
      ...
      switch (a_decoderId)
         ...
         case {107, 109, 110, 111, 113, 121, 122, 124}
            ...
            o_DOXY(idNoDef) = compute_DOXY_107_109_to_111_113_121_122_124( ...
               a_C1PHASE_DOXY(idNoDef), ...
               a_C2PHASE_DOXY(idNoDef), ...
               a_TEMP_DOXY(idNoDef), ...
               a_C1PHASE_DOXY_fillValue, ...
   ...
   if (~isempty(ctdIntData))
      ...
      switch (a_decoderId)
         ...
         case {107, 109, 110, 111, 113, 121, 122, 124}
            ...
            o_PPOX_DOXY(idNoDef) = compute_PPOX_DOXY_121_122_124( ...
               a_C1PHASE_DOXY(idNoDef), ...
               a_C2PHASE_DOXY(idNoDef), ...
               a_TEMP_DOXY(idNoDef), ...
               a_C1PHASE_DOXY_fillValue, ...
