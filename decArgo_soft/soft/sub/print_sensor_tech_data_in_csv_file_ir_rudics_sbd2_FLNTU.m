...
for id = 1:length(idPack)
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; FLNTU tech; Chloro.: scale fact. coef; %g\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechFLNTUCoefScaleChloro(idP, 3));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; FLNTU tech; Chloro.: dark count coef; %g\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechFLNTUDarkCountChloro(idP, 3));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; FLNTU tech; Turbidity: scale fact. coef; %g\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechFLNTUCoefScaleTurbi(idP, 3));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; FLNTU tech; Turbidity: dark count coef; %g\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechFLNTUDarkCountTurbi(idP, 3));
end
