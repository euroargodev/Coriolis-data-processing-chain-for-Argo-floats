...
%
% SYNTAX :
%  print_float_prog_param_in_csv_file_204(a_floatParam)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function print_float_prog_param_in_csv_file_204(a_floatParam)
...
elseif (size(a_floatParam, 1) == 1)
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog; PM10: Threshold for shallow to deep depth zone; %d; dbar\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_floatParam(id, 19));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog; PM11: Slice thickness in surface depth zone; %d; dbar\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_floatParam(id, 20));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog; PM12: Slice thickness in deep depth zone; %d; dbar\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_floatParam(id, 21));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog; PM13: Iridium EOL transmission period; %d; minutes\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_floatParam(id, 22));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog; PM14: Iridium second session waiting time; %d; minutes\n', ...
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog; PT4: Pump duration during buoyancy acquisition; %d; sec\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_floatParam(id, 28)*10);
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog; PT22: Internal pressure calibration coeficient #1; %.3f\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_floatParam(id, 46));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog; PT23: Internal pressure calibration coeficient #2; %f\n', ...
