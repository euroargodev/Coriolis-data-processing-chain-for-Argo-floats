...
% ------------------------------------------------------------------------------
function init_float_config_prv_ir_rudics_cts5_usea(a_decoderId)
...
if (isfield(g_decArgo_jsonMetaData, 'FIRST_CYCLE_TO_PROCESS'))
   ...
   fprintf('ERROR: Float #%d: FIRST_CYCLE_TO_PROCESS not present in Json meta-data file\n', ...
      g_decArgo_floatNum);
end
               ...
               if ((length(value) == 1) && (status == 1))
                  ...
                  elseif (strcmp(jConfName([1:20 23:end]), 'CONFIG_APMT_PATTERN__P04'))
                     ...
                     if (~isempty(timeSec))
                        ...
                        fprintf('ERROR: Float #%d: cannot parse ''%s'' data from Json meta-data file\n', ...
                           g_decArgo_floatNum, ...
                           jConfName);
                        return
                     end
                  ...
                  elseif (ismember(jConfName, opusConfigFileList))
                     ...
                     fprintf('WARNING: Float #%d: cannot convert ''%s'' data to float type from Json meta-data file\n', ...
                        g_decArgo_floatNum, ...
                        jConfName);
                  end
               end
