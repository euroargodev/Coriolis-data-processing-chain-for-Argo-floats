...
%
% SYNTAX :
%  [o_tabProfiles, o_tabDrift] = process_profile_ECO3_mean_stdMed_108_109_115( ...
...
% ------------------------------------------------------------------------------
function [o_tabProfiles, o_tabDrift] = process_profile_ECO3_mean_stdMed_108_109_115( ...
   a_dataECO3Mean, a_dataECO3StdMed, ...
   a_descentToParkStartDate, a_ascentEndDate, a_gpsData, a_sensorTechECO3, a_decoderId)
      ...
      if (isempty(idDataStdMed))
         ...
         if (isempty(idDataMean))
            ...
            if (~isempty(data))
               ...
               g_decArgo_addParamListBackscattering{end+1} = 'BETA_BACKSCATTERING532_STD';
               g_decArgo_addParamListBackscattering{end+1} = 'BETA_BACKSCATTERING532_MED';
