   ...
   case {1121, 1122, 1123, 1322}
         ...
         if (~isempty(idPres) && ...
            ...
            if (~isempty(a_cycleTimeData.ascentEndDate))
               ...
               if (~isempty(idSurf))
                  ...
                  % compute PPOX_DOXY
                  ppoxDoxyValues = compute_PPOX_DOXY_1121_1122_1123_1322( ...
      ...
      if ((~isempty(o_profCtdPtsh)) || (~isempty(o_profCtdCpH)))
         ...
         if (~isempty(o_profCtdPtsh))
            ...
            if (~isempty(idPres) && ~isempty(idTemp) && ~isempty(idPsal) && ...
               ...
               [phInSituFreeValues, phInSituTotalValues] = compute_PH_1121_1122_1123_1322( ...
      ...
      if (~isempty(o_profFlbbCd))
         ...
         if (~isempty(idFluorescenceChla) && ~isempty(idChla))
            % compute CHLA
            chlaValues = compute_CHLA_105_to_112_121_to_126_1121_to_1123_1322( ...
         ...
         if (~isempty(idFluorescenceCdom) && ~isempty(idCdom))
            % compute CDOM
            cdomValues = compute_CDOM_105_to_107_110_112_121_to_126_1121_to_1123_1322( ...
