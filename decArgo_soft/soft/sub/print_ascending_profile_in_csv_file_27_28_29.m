...
% ------------------------------------------------------------------------------
function print_ascending_profile_in_csv_file_27_28_29( ...
   a_ascProfOcc, a_ascProfDate, a_ascProfPres, a_ascProfTemp, a_ascProfSal, ...
   a_acProfTPhaseDoxy, a_ascProfDoxy)
...
if (~isempty(a_ascProfPres))
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; AscProf; Description; UTC time; pressure (dbar); temperature (°C); salinity (SI); TPHASE_DOXY (degree); DOXY (micromol/kg); redundancy\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum);
