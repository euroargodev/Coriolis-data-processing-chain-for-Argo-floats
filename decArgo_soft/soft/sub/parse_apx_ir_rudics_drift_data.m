...
%
% SYNTAX :
%  [o_driftData] = parse_apx_ir_rudics_drift_data(a_driftMeasDataStr, a_decoderId)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_driftData] = parse_apx_ir_rudics_drift_data(a_driftMeasDataStr, a_decoderId)
...
switch (a_decoderId)
   ...
   case {1101, 1104, 1105, 1107, 1110, 1111, 1112, 1113} % 030410 & 020212 & 030512 & 062813_1 & 092813 & 073014 & 102815 & 110216
      ...
      [o_driftData] = parse_apx_ir_rudics_drift_data_1_4_5_7_10_to_13(a_driftMeasDataStr);
      
   case {1102, 1106, 1108} % 120210 & 060612 & 062813_2 & 051216
      
      [o_driftData] = parse_apx_ir_rudics_drift_data_2_6_8(a_driftMeasDataStr);
      
   case {1103, 1109} % 012811 & 062813_3
      
      [o_driftData] = parse_apx_ir_rudics_drift_data_3_9(a_driftMeasDataStr);
...
%   07/10/2017 - RNU - creation
% ------------------------------------------------------------------------------
function [o_driftData] = parse_apx_ir_rudics_drift_data_1_4_5_7_10_to_13(a_driftMeasDataStr)
...
%   07/10/2017 - RNU - creation
% ------------------------------------------------------------------------------
function [o_driftData] = parse_apx_ir_rudics_drift_data_2_6_8(a_driftMeasDataStr)
...
%   07/10/2017 - RNU - creation
% ------------------------------------------------------------------------------
function [o_driftData] = parse_apx_ir_rudics_drift_data_3_9(a_driftMeasDataStr)
