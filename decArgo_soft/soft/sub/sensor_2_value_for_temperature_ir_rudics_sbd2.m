...
%
% SYNTAX :
%  [o_tempValues] = sensor_2_value_for_temperature_ir_rudics_sbd2(a_tempCounts)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_tempValues] = sensor_2_value_for_temperature_ir_rudics_sbd2(a_tempCounts)
...
idNoDef = find((a_tempCounts ~= g_decArgo_tempCountsDef) & (a_tempCounts ~= 0));
o_tempValues(idNoDef) = o_tempValues(idNoDef)/1000 - 2;
