% ------------------------------------------------------------------------------
% Retrieve the list of existing cycles of an Apex Iridium Sbd float.
%
% SYNTAX :
%  [o_cycleList, o_restricted] = get_float_cycle_list_iridium_sbd_apx( ...
...
% ------------------------------------------------------------------------------
function [o_cycleList, o_restricted] = get_float_cycle_list_iridium_sbd_apx( ...
   a_floatNum, a_floatImei, a_floatRudicsId)
...
iriDirName = [g_decArgo_iridiumDataDirectory '/' sprintf('%04d', a_floatImei) '_' num2str(a_floatNum) '/archive/ascii/'];
