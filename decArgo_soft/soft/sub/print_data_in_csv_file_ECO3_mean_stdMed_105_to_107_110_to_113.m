...
if (isempty(idDataStdMed))
   ...
   dataMean(:, 8) = compute_CDOM_105_to_107_110_112_121_to_125_1121_1122_1322(dataMean(:, 6), g_decArgo_cdomDef, paramCDOM.fillValue);
   ...
   if (isempty(idDataMean))
      ...
      paramCDOM = get_netcdf_param_attributes('CDOM');
      data(:, 14) = compute_CDOM_105_to_107_110_112_121_to_125_1121_1122_1322(data(:, 6), g_decArgo_cdomDef, paramCDOM.fillValue);
