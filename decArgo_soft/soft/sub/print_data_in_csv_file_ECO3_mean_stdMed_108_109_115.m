...
if (isempty(idDataStdMed))
   ...
   dataMean(:, 7) = compute_CHLA_105_to_112_121_to_131_1121_to_28_1322_1323(dataMean(:, 4), g_decArgo_chloroADef, paramCHLA.fillValue);
%    paramBBP700 = get_netcdf_param_attributes('BBP700');
%    dataMean(:, 8) = compute_BBP700_105_to_112_121_to_131_1121_to_28_1322_1323(dataMean(:, 5), g_decArgo_backscatDef, paramBBP700.fillValue);
...
%    dataMean(:, 9) = compute_BBP532_108_109(dataMean(:, 6), g_decArgo_backscatDef, paramBBP532.fillValue);
   ...
   if (isempty(idDataMean))
      ...
      paramCHLA = get_netcdf_param_attributes('CHLA');
      data(:, 13) = compute_CHLA_105_to_112_121_to_131_1121_to_28_1322_1323(data(:, 4), g_decArgo_chloroADef, paramCHLA.fillValue);
