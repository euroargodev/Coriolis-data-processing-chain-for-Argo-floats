...
%
% SYNTAX :
%  set_float_config_ir_rudics_cts4_105_to_110_112(a_cyProfPhaseList, a_floatSoftVersion)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function set_float_config_ir_rudics_cts4_105_to_110_112(a_cyProfPhaseList, a_floatSoftVersion)
      ...
      for idC = 1:length(uCy)
         ...
         for idP = 1:length(uProf)
            ...
            if (~isempty(find((a_cyProfPhaseList(:, 3) == cyNum) & ...
               ...
               idPC0113 = find(strcmp('CONFIG_PC_0_1_13', configNames) == 1, 1);
               if (~isempty(idPC0113))
                  ...
                  if (~isempty(idPC014))
                     ...
                     if (~isempty(idPos))
                        ...
                        if (treatType == 0)
                           currentConfig(idPC0113) = configPC014;
                        else
                           currentConfig(idPC0113) = configPC014 + 0.5;
                        end
                     end
                  end
               end
