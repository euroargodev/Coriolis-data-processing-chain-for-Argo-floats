...
%
% SYNTAX :
%  [o_nbFiles] = copy_files_ir_cts5(a_listFileNames, a_inputDir, a_outputDir, a_floatNum)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_nbFiles] = copy_files_ir_cts5(a_listFileNames, a_inputDir, a_outputDir, a_floatNum)
