...
%    decode_system_log_apx_apf11_ir_1127(a_systemLogFileList, a_cycleTimeData, a_presOffsetData, a_techData, a_decoderId)
%
% INPUT PARAMETERS :
...
for idFile = 1:length(a_systemLogFileList)
   ...
   if (~isempty(idEvts))
      [o_cycleTimeData] = process_apx_apf11_ir_time_evts_1121_23_26_27(events(idEvts), o_cycleTimeData);
   ...
   if (~isempty(idEvts))
      buoyancy = process_apx_apf11_ir_buoyancy_evts_1127_1323(events(idEvts));
