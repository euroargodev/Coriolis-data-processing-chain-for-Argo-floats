...
%
% SYNTAX :
%  store_tech_data_for_nc_204_to_208(a_tabTech, a_deepCycle)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function store_tech_data_for_nc_204_to_208(a_tabTech, a_deepCycle)
...
if (a_deepCycle == 1)
   ...
   %    g_decArgo_outputNcParamValue{end+1} = sensor_2_value_for_temperature_204_to_210(tabTech(42));
   %
   %    g_decArgo_outputNcParamIndex = [g_decArgo_outputNcParamIndex;
