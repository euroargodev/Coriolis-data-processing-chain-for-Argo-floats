...
% ------------------------------------------------------------------------------
function print_data_in_csv_file_ECO2_raw_111_113_114_115( ...
   a_decoderId, a_cycleNum, a_profNum, a_phaseNum, ...
   a_dataECO2Raw)
...
data(:, 6) = compute_CHLA_105_to_112_121_to_131_1121_to_28_1322_1323(data(:, 4), g_decArgo_chloroADef, paramCHLA.fillValue);
