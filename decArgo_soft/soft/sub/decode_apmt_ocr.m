...
%
% SYNTAX :
%  [o_ocrData] = decode_apmt_ocr(a_fileNameInfo)
%
% INPUT PARAMETERS :
%   a_fileNameInfo : information on APMT OCR file to decode
%
% OUTPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_ocrData] = decode_apmt_ocr(a_fileNameInfo)
...
try
   ...
   switch (data(1))
      case {4}
         o_ocrData = decode_apmt_ocr4(data, lastByteNum, inputFilePathName);
      case {5}
         fprintf('ERROR: decode_apmt_ocr7 not implemented yet\n');
      case {6}
         fprintf('ERROR: decode_apmt_ocr14 not implemented yet\n');
      otherwise
