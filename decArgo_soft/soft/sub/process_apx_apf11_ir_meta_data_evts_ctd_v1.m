...
%
% SYNTAX :
%  [o_metaData] = process_apx_apf11_ir_meta_data_evts_ctd_v1(a_events, a_metaData)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_metaData] = process_apx_apf11_ir_meta_data_evts_ctd_v1(a_events, a_metaData)
