...
%
% SYNTAX :
%  [o_tabProfiles] = merge_profile_meas_ir_rudics_cts5_usea_uvp_black_v2(a_tabProfiles)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_tabProfiles] = merge_profile_meas_ir_rudics_cts5_usea_uvp_black_v2(a_tabProfiles)
...
paramBlackNumImPart = get_netcdf_param_attributes('BLACK_NUMBER_IMAGES_PARTICLES');
...
for idDir = 1:length(uDir)
   ...
   paramList = [ ...
      paramPres paramBlackNumImPart paramBlackTempParticles paramBlackNbSizeSpecPart ...
      ];
      
   newProfile = a_tabProfiles(idProfForDir(1));
   
   newProfile.paramList = paramList;
   newProfile.paramNumberWithSubLevels = [4];
