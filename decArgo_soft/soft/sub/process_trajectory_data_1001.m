...
%
% SYNTAX :
%  [o_tabTrajNMeas, o_tabTrajNCycle] = process_trajectory_data_1001( ...
%    a_cycleNum, ...
%    a_addLaunchData, a_floatSurfData, ...
%    a_trajData, a_parkData, a_profData, a_timeData, a_presOffsetData, a_decoderId)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_tabTrajNMeas, o_tabTrajNCycle] = process_trajectory_data_1001( ...
   a_cycleNum, ...
   a_addLaunchData, a_floatSurfData, ...
   a_trajData, a_parkData, a_profData, a_timeData, a_presOffsetData, a_decoderId)
