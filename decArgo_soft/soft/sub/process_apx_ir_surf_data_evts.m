% ------------------------------------------------------------------------------
% Parse and process Apex Rudics surface data from log file.
%
% SYNTAX :
%  [o_surfData] = process_apx_ir_surf_data_evts(a_events, a_decoderId)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_surfData] = process_apx_ir_surf_data_evts(a_events, a_decoderId)
