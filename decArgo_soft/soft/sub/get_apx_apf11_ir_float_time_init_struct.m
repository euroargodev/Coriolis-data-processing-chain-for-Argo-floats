...
o_timeStruct = struct( ...
   ...
   'activatedPressure', [], ... % from 'IDLE | pressure activated' of system_log file
   ...
   'descentEndAdjPres', [], ...
   'rafosCorrelationStartDateSci', [], ... % from 'RAFOS correlation initiated' of science_log file
   'rafosCorrelationStartAdjDateSci', [], ...
   'rafosCorrelationStartPresSci', [], ... % CTD_P of same timestamp or average of 2 surrounding values
   'rafosCorrelationStartAdjPresSci', [], ... % CTD_P of same timestamp or average of 2 surrounding values
   ...
   'ascentStartDateSci', [], ... % from 'Profiling Mission' or 'ASCENT' of science_log file
   ...
   'ascentEndAdjDate', [], ...
   'iceDescentStartDateSci', [], ... % from 'ICEDESCENT' of science_log file
   'iceDescentStartAdjDateSci', [], ...
   'iceDescentStartPresSci', [], ... % CTD_P of same timestamp or average of 2 surrounding values
   'iceDescentStartAdjPresSci', [], ...
   'iceDescentStartDateSys', [], ... % from 'SURFACE -> ICEDESCENT' of system_log file
   'iceDescentStartAdjDateSys', [], ...
   'iceAscentStartDateSci', [], ... % from 'ICEASCENT' of science_log file
   'iceAscentStartAdjDateSci', [], ...
   'iceAscentStartPresSci', [], ... % CTD_P of same timestamp or average of 2 surrounding values
   'iceAscentStartAdjPresSci', [], ...
   'iceAscentStartDateSys', [], ... % from 'ICEDESCENT -> ICEASCENT' of system_log file
   'iceAscentStartAdjDateSys', [], ...
   'iceAscentEndDateSci', [], ... % from 'Surface Mission' of science_log file WHEN IN 'ICEASCENT' phase
   'iceAscentEndAdjDateSci', [], ...
   'iceAscentEndPresSci', [], ... % CTD_P of same timestamp or average of 2 surrounding values
   'iceAscentEndAdjPresSci', [], ...
   'iceAscentEndDateSys', [], ... % from 'ICEASCENT -> SURFACE' of system_log file
   'iceAscentEndAdjDateSys', [], ...
   'bladderInflationStartDateSys', [], ... % from 'Inflating air bladder' of system_log file - the first occurence is stored to assign MC = 710 or 711 to DO surface measurements
