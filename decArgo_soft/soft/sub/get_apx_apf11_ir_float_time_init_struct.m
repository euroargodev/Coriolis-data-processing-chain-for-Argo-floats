...
o_timeStruct = struct( ...
   ...
   'descentStartDateSys', [], ... % from 'Mission state PRELUDE -> PARKDESCENT' or 'Mission state SURFACE -> PARKDESCENT' of system_log file
   ...
   'parkStartAdjDateSys', [], ...
   'parkEndDateSci', [], ... % from 'Deep Descent Mission' of science_log file
   'parkEndAdjDateSci', [], ...
