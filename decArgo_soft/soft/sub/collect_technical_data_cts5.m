% ------------------------------------------------------------------------------
% Collect technical data from AMPT technical messages (and merge TECH and Event
% technical data)
%
% SYNTAX :
%  [o_techNcParamIndex, o_techNcParamValue, o_tabTechNMeas] = collect_technical_data_cts5(a_tabTech)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_techNcParamIndex, o_techNcParamValue, o_tabTechNMeas] = collect_technical_data_cts5(a_tabTech)
...
for idPack = 1:size(a_tabTech, 1)
   ...
   for idT = 1:length(techData)
      techDataAll = [techDataAll; ...
         ...
         {techData{idT}.source} techData{idT}.techId techData{idT}.valueRaw techData{idT}.valueOutput];
   end
end
