...
%    decode_prv_data_ir_rudics_cts4_111(a_tabSensors, a_tabDates, a_procLevel)
%
% INPUT PARAMETERS :
   ...
   for idMes = 1:size(tabSensors, 1)
      ...
      switch (packType)
         ...
         case 0
            ...
            switch (sensorDataType)
               ...
               case {6, 8}
                  ...
                  if (sensorDataType == 6)
                     o_dataECO2MeanDate = [o_dataECO2MeanDate; [cycleNum profNum phaseNum measDate]];
                     o_dataECO2MeanDateTrans = [o_dataECO2MeanDateTrans; [cycleNum profNum phaseNum measDateTrans]];
                     o_dataECO2MeanPres = [o_dataECO2MeanPres; [cycleNum profNum phaseNum measPres]];
                     o_dataECO2MeanChloroA = [o_dataECO2MeanChloroA; [cycleNum profNum phaseNum measChloroA]];
                     o_dataECO2MeanBackscat = [o_dataECO2MeanBackscat; [cycleNum profNum phaseNum measBackscat]];
                  elseif (sensorDataType == 8)
                     o_dataECO2RawDate = [o_dataECO2RawDate; [cycleNum profNum phaseNum measDate]];
                     o_dataECO2RawDateTrans = [o_dataECO2RawDateTrans; [cycleNum profNum phaseNum measDateTrans]];
                     o_dataECO2RawPres = [o_dataECO2RawPres; [cycleNum profNum phaseNum measPres]];
                     o_dataECO2RawChloroA = [o_dataECO2RawChloroA; [cycleNum profNum phaseNum measChloroA]];
                     o_dataECO2RawBackscat = [o_dataECO2RawBackscat; [cycleNum profNum phaseNum measBackscat]];
                  end
               ...
               case {7}
                  ...
                  o_dataECO2StdMedDate = [o_dataECO2StdMedDate; [cycleNum profNum phaseNum measDate]];
                  o_dataECO2StdMedDateTrans = [o_dataECO2StdMedDateTrans; [cycleNum profNum phaseNum measDateTrans]];
                  o_dataECO2StdMedPresMean  = [o_dataECO2StdMedPresMean; [cycleNum profNum phaseNum measPresMean]];
                  o_dataECO2StdMedChloroAStd  = [o_dataECO2StdMedChloroAStd; [cycleNum profNum phaseNum measChloroAStd]];
                  o_dataECO2StdMedBackscatStd  = [o_dataECO2StdMedBackscatStd; [cycleNum profNum phaseNum measBackscatStd]];
                  o_dataECO2StdMedChloroAMed  = [o_dataECO2StdMedChloroAMed; [cycleNum profNum phaseNum measChloroAMed]];
                  o_dataECO2StdMedBackscatMed  = [o_dataECO2StdMedBackscatMed; [cycleNum profNum phaseNum measBackscatMed]];
         ...
         case 248
            ...
            if (cycleNum ~= g_decArgo_cycleNum)
               fprintf('DEC_WARNING: Float #%d Cycle #%d: packType #%d: inconsistent cycle number (#%d instead of #%d) => ignoring packet data\n', ...
                  g_decArgo_floatNum, g_decArgo_cycleNum, ...
                  packType, ...
                  cycleNum, g_decArgo_cycleNum);
               continue;
            ...
            floatProgRudics = [packJulD values(7:13)' sbdFileDate];
            
            o_floatProgRudics = [o_floatProgRudics; floatProgRudics];
            
            o_cyProfPhaseList = [o_cyProfPhaseList; ...
               248 -1 values(7) values(8) -1 sbdFileDate];
            
            % update float configuration
            update_float_config_ir_rudics_111(248, packJulD, values(7:13));
         ...
         case 249
            ...
            if (cycleNum ~= g_decArgo_cycleNum)
               ...
               %                   cycleNum, g_decArgo_cycleNum);
               %                continue;
               fprintf('DEC_WARNING: Float #%d Cycle #%d: packType #%d: inconsistent cycle number (#%d instead of #%d)\n', ...
                  g_decArgo_floatNum, g_decArgo_cycleNum, ...
                  packType, ...
                  cycleNum, g_decArgo_cycleNum);
            end
            ...
            floatProgSensor = [packJulD values(1:55)' sbdFileDate];
            
            o_floatProgSensor = [o_floatProgSensor; floatProgSensor];
            
            o_cyProfPhaseList = [o_cyProfPhaseList; ...
               249 values(1) values(3:5)' sbdFileDate];
            
            % update float configuration
            update_float_config_ir_rudics_111(249, packJulD, values(1:55));
         ...
         case 250
            ...
            switch (sensorType)
               ...
               case 1
                  ...
                  o_sensorTechOPTODESensorSerialNum = [o_sensorTechOPTODESensorSerialNum; cycleNum profNum measSensorSerialNum];
               ...
               case 2
                  ...
                  if (measCoefSensor1 == 1) && (measCoefSensor2 == 2)
                     ...
                     o_sensorTechOCRCoefLambda3A0 = [o_sensorTechOCRCoefLambda3A0; cycleNum profNum nan];
                     o_sensorTechOCRCoefLambda3A1 = [o_sensorTechOCRCoefLambda3A1; cycleNum profNum nan];
                     o_sensorTechOCRCoefLambda3Lm = [o_sensorTechOCRCoefLambda3Lm; cycleNum profNum nan];
                     o_sensorTechOCRCoefParA0 = [o_sensorTechOCRCoefParA0; cycleNum profNum nan];
                     o_sensorTechOCRCoefParA1 = [o_sensorTechOCRCoefParA1; cycleNum profNum nan];
                     o_sensorTechOCRCoefParLm = [o_sensorTechOCRCoefParLm; cycleNum profNum nan];
                  ...
                  elseif (measCoefSensor1 == 3) && (measCoefSensor2 == 4)
                     ...
                     o_sensorTechOCRSensorState = [o_sensorTechOCRSensorState; cycleNum profNum sensorState];
                     o_sensorTechOCRSensorSerialNum = [o_sensorTechOCRSensorSerialNum; cycleNum profNum measSensorSerialNum];
                     o_sensorTechOCRCoefLambda1A0 = [o_sensorTechOCRCoefLambda1A0; cycleNum profNum nan];
                     o_sensorTechOCRCoefLambda1A1 = [o_sensorTechOCRCoefLambda1A1; cycleNum profNum nan];
                     o_sensorTechOCRCoefLambda1Lm = [o_sensorTechOCRCoefLambda1Lm; cycleNum profNum nan];
                     o_sensorTechOCRCoefLambda2A0 = [o_sensorTechOCRCoefLambda2A0; cycleNum profNum nan];
                     o_sensorTechOCRCoefLambda2A1 = [o_sensorTechOCRCoefLambda2A1; cycleNum profNum nan];
                     o_sensorTechOCRCoefLambda2Lm = [o_sensorTechOCRCoefLambda2Lm; cycleNum profNum nan];
               ...
               case 3
                  ...
                  if (any(strcmp('ECO2', g_decArgo_sensorMountedOnFloat) == 1))
                     ...
                     % ECO2
                     o_sensorTechECO2NbPackDesc = [o_sensorTechECO2NbPackDesc; cycleNum profNum nbPackDesc];
                     o_sensorTechECO2NbPackDrift = [o_sensorTechECO2NbPackDrift; cycleNum profNum nbPackDrift];
                     o_sensorTechECO2NbPackAsc = [o_sensorTechECO2NbPackAsc; cycleNum profNum nbPackAsc];
                     o_sensorTechECO2NbMeasDescZ1 = [o_sensorTechECO2NbMeasDescZ1; cycleNum profNum nbMeasDescZ1];
                     o_sensorTechECO2NbMeasDescZ2 = [o_sensorTechECO2NbMeasDescZ2; cycleNum profNum nbMeasDescZ2];
                     o_sensorTechECO2NbMeasDescZ3 = [o_sensorTechECO2NbMeasDescZ3; cycleNum profNum nbMeasDescZ3];
                     o_sensorTechECO2NbMeasDescZ4 = [o_sensorTechECO2NbMeasDescZ4; cycleNum profNum nbMeasDescZ4];
                     o_sensorTechECO2NbMeasDescZ5 = [o_sensorTechECO2NbMeasDescZ5; cycleNum profNum nbMeasDescZ5];
                     o_sensorTechECO2NbMeasDrift = [o_sensorTechECO2NbMeasDrift; cycleNum profNum nbMeasDrift];
                     o_sensorTechECO2NbMeasAscZ1 = [o_sensorTechECO2NbMeasAscZ1; cycleNum profNum nbMeasAscZ1];
                     o_sensorTechECO2NbMeasAscZ2 = [o_sensorTechECO2NbMeasAscZ2; cycleNum profNum nbMeasAscZ2];
                     o_sensorTechECO2NbMeasAscZ3 = [o_sensorTechECO2NbMeasAscZ3; cycleNum profNum nbMeasAscZ3];
                     o_sensorTechECO2NbMeasAscZ4 = [o_sensorTechECO2NbMeasAscZ4; cycleNum profNum nbMeasAscZ4];
                     o_sensorTechECO2NbMeasAscZ5 = [o_sensorTechECO2NbMeasAscZ5; cycleNum profNum nbMeasAscZ5];
                     o_sensorTechECO2SensorState = [o_sensorTechECO2SensorState; cycleNum profNum sensorState];
                     o_sensorTechECO2SensorSerialNum = [o_sensorTechECO2SensorSerialNum; cycleNum profNum measSensorSerialNum];
                     o_sensorTechECO2CoefScaleFactChloroA = [o_sensorTechECO2CoefScaleFactChloroA; cycleNum profNum measCoefScaleFactChloroA];
                     o_sensorTechECO2CoefDarkCountChloroA = [o_sensorTechECO2CoefDarkCountChloroA; cycleNum profNum measCoefDarkCountChloroA];
                     o_sensorTechECO2CoefScaleFactBackscat = [o_sensorTechECO2CoefScaleFactBackscat; cycleNum profNum measCoefScaleFactBackscat];
                     o_sensorTechECO2CoefDarkCountBackscat = [o_sensorTechECO2CoefDarkCountBackscat; cycleNum profNum measCoefDarkCountBackscat];
                  else
         ...
         case 252
            ...
            for idBin = 1:19
               ...
               o_floatPresActTime = [o_floatPresActTime; ...
                  [cycleNum profNum phaseNum actTime]];
               o_floatPresActDuration = [o_floatPresActDuration; ...
                  [cycleNum profNum phaseNum actDuration]];
         ...
         case 253
            ...
            tabTech = [packJulD values(7:92)' gpsLocLon gpsLocLat sbdFileDate];
         ...
         case 254
            ...
            floatProgTech = [packJulD values(7:47)' sbdFileDate];
            ...
            % update float configuration
            update_float_config_ir_rudics_111(254, packJulD, values(7:47));
         ...
         case 255
            ...
            floatProgParam = [packJulD values(7:70)' sbdFileDate];
            ...
            % update float configuration
            update_float_config_ir_rudics_111(255, packJulD, values(7:70));
