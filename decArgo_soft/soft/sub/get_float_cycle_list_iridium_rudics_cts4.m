...
%
% SYNTAX :
%  [o_cycleList] = get_float_cycle_list_iridium_rudics_cts4(a_floatNum, a_floatLoginName)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_cycleList] = get_float_cycle_list_iridium_rudics_cts4(a_floatNum, a_floatLoginName)
