% ------------------------------------------------------------------------------
% Create and add the vertical sampling scheme information to the CTS5-USEA core
% profiles.
%
% SYNTAX :
%  [o_tabProfiles] = add_vertical_sampling_scheme_ir_rudics_cts5_usea_ctd(a_tabProfiles)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_tabProfiles] = add_vertical_sampling_scheme_ir_rudics_cts5_usea_ctd(a_tabProfiles)
