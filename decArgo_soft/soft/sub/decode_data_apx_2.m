...
%
% SYNTAX :
%  [o_miscInfo, o_auxInfo, o_profData, o_parkData, o_astData, ...
%    o_metaData, o_techData, o_trajData, o_timeInfo, o_timeData, o_presOffsetData] = ...
%    decode_data_apx_2(a_argosDataData, a_argosDataUsed, a_argosDataDate, ...
...
% ------------------------------------------------------------------------------
function [o_miscInfo, o_auxInfo, o_profData, o_parkData, o_astData, ...
   o_metaData, o_techData, o_trajData, o_timeInfo, o_timeData, o_presOffsetData] = ...
   decode_data_apx_2(a_argosDataData, a_argosDataUsed, a_argosDataDate, ...
   a_sensorData, a_sensorDate, a_cycleNum, a_timeData, a_presOffsetData, a_decoderId)
...
for idL = 1:size(a_sensorData, 1)
   ...
   elseif (msgNum == 3)
      ...
      profReceived(1:17) = ones(17, 1)*255;
      ...
      profReceived(17+(msgNum-4)*29+1:17+(msgNum-4)*29+29) = ones(29, 1)*255;
