...
%    decode_apx_ir_rudics_HR_profile_data(a_profHighResMeasDataStr, a_decoderId)
%
% INPUT PARAMETERS :
...
switch (a_decoderId)
   ...
   case {1101} % 030410
      ...
      [o_profHrData, o_profHrInfo] = ...
         decode_apx_ir_rudics_HR_profile_data_1(a_profHighResMeasDataStr);
      
   case {1102, 1105, 1106, 1108, 1111, 1113}
      % 120210 & 030512 & 060612 & 062813_2 & 073014 & 110216
      
      [o_profHrData, o_profHrInfo] = ...
         decode_apx_ir_rudics_HR_profile_data_2_5_6_8_11_13(a_profHighResMeasDataStr);
      
   case {1103, 1104, 1107, 1109, 1110, 1112}
      % 012811 & 020212 & 062813_1 & 062813_3 & 092813 & 102815
      
      [o_profHrData, o_profHrInfo] = ...
         decode_apx_ir_rudics_HR_profile_data_3_4_7_9_10_12(a_profHighResMeasDataStr);
   ...
   otherwise
      fprintf('DEC_WARNING: Float #%d Cycle #%d: Nothing done yet in decode_apx_ir_rudics_HR_profile_data for decoderId #%d\n', ...
         g_decArgo_floatNum, ...
         g_decArgo_cycleNum, ...
         a_decoderId);
      return;
