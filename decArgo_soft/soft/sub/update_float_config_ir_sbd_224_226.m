...
% ------------------------------------------------------------------------------
function update_float_config_ir_sbd_224_226(a_floatParam, a_cycleNum, a_decoderId)
...
if (~isempty(floatParam1))
   ...
   elseif (a_decoderId == 226)
      ...
      % TC02 transmitted in 10 csec => in csec in the configuration
      floatParam1(47+ID_OFFSET) = floatParam1(47+ID_OFFSET)*10;
      % TC03 transmitted in 10 csec => in csec in the configuration
      floatParam1(48+ID_OFFSET) = floatParam1(18+ID_OFFSET)*10;
      % TC04 transmitted in 1000 csec => in csec in the configuration
      floatParam1(49+ID_OFFSET) = floatParam1(49+ID_OFFSET)*1000;
      % TC22 transmitted in 1000 csec => in csec in the configuration
      floatParam1(67+ID_OFFSET) = floatParam1(67+ID_OFFSET)*1000;
   ...
   for id = 0:29
      ...
      idPos = find(strcmp(name, configNames) == 1, 1);
      if (~isempty(idPos))
         newConfig(idPos) = floatParam1(id+startForTc+ID_OFFSET);
      end
   end
end
