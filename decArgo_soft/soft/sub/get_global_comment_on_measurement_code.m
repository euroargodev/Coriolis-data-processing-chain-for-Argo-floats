...
switch (a_decoderId)
   ...
   case {106, 107, 109, 110, 111, 112, 301, 302, 303}
      % Provor CTS4 & Arvor CM with PPOX_DOXY
      o_mcList = [ ...
         g_MC_Launch ...
         g_MC_CycleStart ...
         g_MC_DST ...
   ...
   case {1322}
      ...
      o_mcList = [ ...
         ...
         g_MC_TST ...
         g_MC_Surface ...
         g_MC_SurfaceDoMeasBeforeAirBladderInflation ...
         g_MC_SurfaceDoMeasAfterAirBladderInflation ...
         g_MC_TET-10 ...
         g_MC_TET ...
         g_MC_Grounded ...
         ];      
...
if (~ismember(a_decoderId, apexApf11IrDecoderIdList))
   ...
   switch (a_measurementCode)
      ...
      case {g_MC_SurfaceDoMeasBeforeAirBladderInflation}
         o_comment = 'surface oxygen data: in-water samples, part of surface sequence (guidance in RT: before air-bladder inflation / before max. buoyancy)';
      case {g_MC_SurfaceDoMeasAfterAirBladderInflation}
         o_comment = 'surface oxygen data: in-air samples, part of surface sequence (guidance in RT: after air-bladder inflation / after max. buoyancy)';
   end
