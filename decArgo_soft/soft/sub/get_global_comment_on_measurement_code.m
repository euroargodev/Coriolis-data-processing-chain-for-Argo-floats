...
switch (a_decoderId)
   ...
   case {122, 123, 124, 125, 126, 127, 128, 129, 130, 131, 132, 133}
      % Provor CTS5
      o_mcList = [ ...
         g_MC_Launch ...
         g_MC_CycleStart ...
   ...
   case {1101, 1105, 1110, 1111, 1112, 1114}
...
if (~ismember(a_decoderId, g_decArgo_decoderIdListApexApf11Iridium))
   ...
   switch (a_measurementCode)
      ...
      case {g_MC_SpyAtPark}
         if ((a_decoderId > 1000) && (a_decoderId < 1100))
            % Apex APF9 Argosfloat
            o_comment = 'measurement at PET';
         else
