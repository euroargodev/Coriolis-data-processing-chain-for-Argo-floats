...
% ------------------------------------------------------------------------------
function print_data_in_csv_file_ECO2_mean_stdMed_111_113_to_116( ...
   a_decoderId, a_cycleNum, a_profNum, a_phaseNum, ...
   a_dataECO2Mean, a_dataECO2StdMed)
...
if (isempty(idDataStdMed))
   ...
   dataMean(:, 6) = compute_CHLA_105_to_112_121_to_133_1121_to_28_1322_1323(dataMean(:, 4), g_decArgo_chloroADef, paramCHLA.fillValue);
   ...
   if (isempty(idDataMean))
      ...
      paramCHLA = get_netcdf_param_attributes('CHLA');
      data(:, 10) = compute_CHLA_105_to_112_121_to_133_1121_to_28_1322_1323(data(:, 4), g_decArgo_chloroADef, paramCHLA.fillValue);
