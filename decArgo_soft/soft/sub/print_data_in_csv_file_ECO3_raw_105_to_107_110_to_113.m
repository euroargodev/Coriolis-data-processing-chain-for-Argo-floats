...
data(:, 7) = compute_CHLA_105_to_112_121_to_126_1121_to_27_1322_1323(data(:, 4), g_decArgo_chloroADef, paramCHLA.fillValue);
% paramBBP700 = get_netcdf_param_attributes('BBP700');
% data(:, 8) = compute_BBP700_105_to_112_121_to_126_1121_to_27_1322_1323(data(:, 5), g_decArgo_backscatDef, paramBBP700.fillValue);
paramCDOM = get_netcdf_param_attributes('CDOM');
data(:, 8) = compute_CDOM_105_to_107_110_112_121_to_126_1121_to_27_1322_1323(data(:, 6), g_decArgo_cdomDef, paramCDOM.fillValue);
