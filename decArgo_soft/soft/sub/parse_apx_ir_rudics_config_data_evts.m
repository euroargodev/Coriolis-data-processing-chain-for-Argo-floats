% ------------------------------------------------------------------------------
% Parse Apex Iridium Rudics configuration data from .log file.
%
% SYNTAX :
%  [o_configData] = parse_apx_ir_rudics_config_data_evts(a_events)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_configData] = parse_apx_ir_rudics_config_data_evts(a_events)
