...
%
% SYNTAX :
%  [o_clockOffset, o_cycleList] = get_clock_offset_apx_apf11_ir( ...
...
% ------------------------------------------------------------------------------
function [o_clockOffset, o_cycleList] = get_clock_offset_apx_apf11_ir( ...
   a_floatNum, a_floatImei, a_floatRudicsId, a_decoderId)
...
[o_cycleList, restricted] = get_float_cycle_list_iridium_sbd_apx_apf11(a_floatNum, a_floatImei, a_floatRudicsId);
if (restricted)
