...
%
% SYNTAX :
%  [o_DOWN_IRRADIANCE412] = compute_DOWN_IRRADIANCE412_105_to_109( ...
...
% ------------------------------------------------------------------------------
function [o_DOWN_IRRADIANCE412] = compute_DOWN_IRRADIANCE412_105_to_109( ...
   a_RAW_DOWNWELLING_IRRADIANCE412, ...
   a_RAW_DOWNWELLING_IRRADIANCE412_fill_value, a_DOWN_IRRADIANCE412_fill_value)
...
o_DOWN_IRRADIANCE412(idNoDef) = ...
   a1Lambda412*(a_RAW_DOWNWELLING_IRRADIANCE412(idNoDef) - a0Lambda412)*lmLambda412;
