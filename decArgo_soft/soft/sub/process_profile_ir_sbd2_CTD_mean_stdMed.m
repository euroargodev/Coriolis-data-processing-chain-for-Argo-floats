...
%
% SYNTAX :
%  [o_tabProfiles, o_tabDrift] = process_profile_ir_sbd2_CTD_mean_stdMed( ...
...
% ------------------------------------------------------------------------------
function [o_tabProfiles, o_tabDrift] = process_profile_ir_sbd2_CTD_mean_stdMed( ...
   a_dataCTDMean, a_dataCTDStdMed, ...
   a_descentToParkStartDate, a_ascentEndDate, ...
   a_gpsData, a_iridiumMailData, a_sensorTechCTD, a_decoderId)
...
cycleProfPhaseList = unique(a_dataCTDMeanDate(:, 1:3), 'rows');
