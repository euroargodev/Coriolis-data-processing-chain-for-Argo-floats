...
%
% SYNTAX :
%  set_float_config_ir_rudics_cts4_111(a_cyProfPhaseList)
%
% INPUT PARAMETERS :
%   a_cyProfPhaseList : list of cycle and profiles associated to that configuration
%
% OUTPUT PARAMETERS :
%
% EXAMPLES :
...
% ------------------------------------------------------------------------------
function set_float_config_ir_rudics_cts4_111(a_cyProfPhaseList)
...
if (~isempty(a_cyProfPhaseList))
   ...
   if ((~isempty(idData)) || (g_decArgo_noDataFlag == 0))
