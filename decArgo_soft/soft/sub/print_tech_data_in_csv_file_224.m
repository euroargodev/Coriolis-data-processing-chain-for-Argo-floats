...
elseif (length(idF2) == 1)
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2_%d; min "in air" PSAL meas; %d; => %.3f; PSU\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 2+ID_OFFSET), a_tabTech2(id, 63+ID_OFFSET), sensor_2_value_for_salinity_210_to_214_217_220_222_to_225(a_tabTech2(id, 63+ID_OFFSET)));
end
