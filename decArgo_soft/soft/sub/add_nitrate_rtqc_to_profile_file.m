...
elseif (isfield(g_decArgo_calibInfo, 'SUNA') && ...
   ...
   fprintf('RTQC_ERROR: Float #%d Cycle #%d: inconsistent SUNA calibration information - unable to perform NITRATE RTQC specific test (Test #59)\n', ...
      a_floatNum, a_cyNum);
   return
end
...
idDef = sort([idDef; ...
   ...
   (ctdIntData(:, 1) == paramPres.fillValue) | ...
   (ctdIntData(:, 2) == paramTemp.fillValue) | ...
   (ctdIntData(:, 3) == paramSal.fillValue))]);
