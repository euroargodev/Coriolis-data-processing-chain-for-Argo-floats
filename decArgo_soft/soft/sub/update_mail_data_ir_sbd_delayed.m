...
if (ismember(g_decArgo_floatNum, [6903230, 6903256, 6902957, 6901880, 6903800, ...
   ...
   switch g_decArgo_floatNum
      ...
      case 6901880
         ...
         idF = find([g_decArgo_iridiumMailData.timeOfSessionJuld] == gregorian_2_julian_dec_argo('2021/11/28 06:22:20'));
         if (~isempty(idF))
            g_decArgo_iridiumMailData(idF).cycleNumber = 103;
         end
      case 6903800
      ...
      case 6904236
         idF = find([g_decArgo_iridiumMailData.timeOfSessionJuld] == gregorian_2_julian_dec_argo('2020/04/27 05:28:39'));
         if (~isempty(idF))
            g_decArgo_iridiumMailData(idF).cycleNumber = 34;
         end
      case 3901645
