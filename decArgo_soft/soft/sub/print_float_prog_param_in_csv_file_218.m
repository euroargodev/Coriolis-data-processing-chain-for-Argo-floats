...
% ------------------------------------------------------------------------------
function print_float_prog_param_in_csv_file_218(a_floatParam1, a_floatParam2)
...
%       g_decArgo_floatNum, g_decArgo_cycleNum, a_floatParam1(id, 40+ID_OFFSET));
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog #1; PT17: Second profile pressure; %d; dbar\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_floatParam1(id, 42+ID_OFFSET)*10);
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog #1; PT34: Internal pressure calibration coeficient #1; %.3f\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_floatParam1(id, 59+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog #1; PT35: Internal pressure calibration coeficient #2; %f\n', ...
