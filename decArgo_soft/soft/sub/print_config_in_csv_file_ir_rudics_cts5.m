...
%
% SYNTAX :
%  print_config_in_csv_file_ir_rudics_cts5(a_comment, a_conf, a_configStruct)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function print_config_in_csv_file_ir_rudics_cts5(a_comment, a_conf, a_configStruct)
