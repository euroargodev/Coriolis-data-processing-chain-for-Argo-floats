...
% ------------------------------------------------------------------------------
function print_float_prog_tech_data_in_csv_file_ir_rudics_105_to_110_one( ...
   a_cycleNum, a_profNum, a_dataIndex, ...
   a_floatProgTech)
...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 3));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT0 - Durée max elec surface; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 4));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT1 - Réduc émergence forfait; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 5));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT2 - Délai réduc émergence; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 6));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT3 - Délai remontée; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 7));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT4 - Vol max elec prof; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 8));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT5 - Durée max pompe; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 9));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT6 - Durée pompe remontée; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 10));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT7 - Durée pompe vidange; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 11));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT8 - Delta; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 12));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT9 - Pression max; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 13));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT10 - Palier 1; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 14));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT11 - Palier 2; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 15));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT12 - Seuil repositionnement; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 16));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT13 - Mode échouage; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 17));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT14 - Vol cumul échouage; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 18));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT15 - Pression échouage; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 19));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT16 - Décal échouage; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 20));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT17 - Delta dérive; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 21));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT18 - Vit moy desc; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 22));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT19 - Incrément pression; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 23));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT20 - Time-out modem Iridium; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 24));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT21 - Vit min remontée (lors de la scrutation de la pression); %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 25));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT22 - Vit moy remontée; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 26));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT23 - Tempo après RU; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 27));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT24 - Volume forfaitaire à transférer en fin de réduction d''émergence; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 28));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT25 - Nombre de tentatives d''émission Iridium; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
%    a_floatProgTech(a_dataIndex, 29));
% fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; float prog tech; PT26 - Coef 1; %d\n', ...
%    g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
