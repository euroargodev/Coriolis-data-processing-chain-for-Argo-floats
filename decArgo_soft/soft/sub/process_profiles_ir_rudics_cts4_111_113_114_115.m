...
%
% SYNTAX :
%  [o_tabProfiles, o_tabDrift] = process_profiles_ir_rudics_cts4_111_113_114_115( ...
%    a_decoderId, ...
%    a_cyProfPhaseList, ...
...
% ------------------------------------------------------------------------------
function [o_tabProfiles, o_tabDrift] = process_profiles_ir_rudics_cts4_111_113_114_115( ...
   a_decoderId, ...
   a_cyProfPhaseList, ...
   a_dataCTD, a_dataOXY, a_dataOCR, ...
   a_dataECO2, a_dataECO3, a_dataFLNTU, ...
...
for idDataType = 1:length(dataTypeList)
   ...
   switch (dataType)
      ...
      case 6
         ...
         [prof, drift] = process_profile_ECO2_mean_stdMed_111_113_114_115( ...
      ...
      case 8
         % ECO2 (raw)
         [prof, drift] = process_profile_ECO2_raw_111_113_114_115( ...
            a_dataECO2Raw, ...
            a_descentToParkStartDate, a_ascentEndDate, ...
            a_gpsData, a_sensorTechECO2, a_decoderId);
      ...
      case 9
         ...
         switch (a_decoderId)
            case {111, 113, 114}
               [prof, drift] = process_profile_ECO3_mean_stdMed_105_to_107_110_to_114( ...
            ...
            case {115}
               [prof, drift] = process_profile_ECO3_mean_stdMed_108_109_115( ...
                  ...
                  a_gpsData, a_sensorTechECO3, a_decoderId);
            otherwise
               fprintf('WARNING: Float #%d: Nothing implemented yet in process_profiles_ir_rudics_cts4_111_113_114_115 for decoderId #%d\n', ...
                  g_decArgo_floatNum, ...
                  a_decoderId);
         end
      ...
      case 11
         ...
         switch (a_decoderId)
            case {111, 113, 114}
               [prof, drift] = process_profile_ECO3_raw_105_to_107_110_to_114( ...
                  a_dataECO3Raw, ...
                  a_descentToParkStartDate, a_ascentEndDate, ...
                  a_gpsData, a_sensorTechECO3, a_decoderId);
            case {115}
      ...
      case 24
         % SUNA (APF)
         if (a_decoderId ~= 113)
            [prof, drift] = process_profile_SUNA_APF_105_to_109_111_to_115_121_to_125( ...
               a_dataSUNAAPF, ...
               a_descentToParkStartDate, a_ascentEndDate, ...
