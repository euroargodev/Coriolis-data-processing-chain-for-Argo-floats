...
%
% SYNTAX :
%  [o_iceModeActive] = config_ice_mode_active_111_113_to_116(a_cycleNum, a_profNum)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_iceModeActive] = config_ice_mode_active_111_113_to_116(a_cycleNum, a_profNum)
