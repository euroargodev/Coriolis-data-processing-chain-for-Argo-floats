...
%
% SYNTAX :
%  [o_doData] = decode_apmt_do_data(a_data, a_lastByteNum, a_inputFilePathName)
%
% INPUT PARAMETERS :
%   a_data              : input DO data to decode
...
% ------------------------------------------------------------------------------
function [o_doData] = decode_apmt_do_data(a_data, a_lastByteNum, a_inputFilePathName)
