...
%    decode_nva_data_ir_sbd_2003(a_tabData, a_tabDataDates, a_procLevel, a_firstDeepCycleDone)
%
% INPUT PARAMETERS :
...
for idMes = 1:size(a_tabData, 1)
   ...
   switch (packType)
      ...
      case 1
         ...
         tabTech([1:6 31 40 44]) = tabTech([1:6 31 40 44])*0.1;
         tabTech(26) = tabTech(26)*0.1 - 3276.8;
         tabTech(37:38) = tabTech(37:38)*1e-7 - 214.7483648;
         tabTech(47) = tabTech(47) + 2000;
         tabTech(48:49) = tabTech(48:49)*2;
      ...
      if (~isempty(tabCycleNum))
         ...
         if (length(unique(tabCycleNum)) == 1)
            ...
            if (g_decArgo_generateNcTech ~= 0)
               store_tech_data_for_nc_2003(o_tabTech, o_deepCycle);
            end
