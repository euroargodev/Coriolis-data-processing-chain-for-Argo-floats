...
%
% SYNTAX :
%  [o_DOWN_IRRADIANCE380] = compute_DOWN_IRRADIANCE380_105_to_109( ...
...
% ------------------------------------------------------------------------------
function [o_DOWN_IRRADIANCE380] = compute_DOWN_IRRADIANCE380_105_to_109( ...
   a_RAW_DOWNWELLING_IRRADIANCE380, ...
   a_RAW_DOWNWELLING_IRRADIANCE380_fill_value, a_DOWN_IRRADIANCE380_fill_value)
...
o_DOWN_IRRADIANCE380(idNoDef) = ...
   a1Lambda380*(a_RAW_DOWNWELLING_IRRADIANCE380(idNoDef) - a0Lambda380)*lmLambda380;
