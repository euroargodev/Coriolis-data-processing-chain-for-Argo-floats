...
%
% SYNTAX :
%  print_tech_data_in_csv_file_2002(a_tabTech, a_decoderId)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function print_tech_data_in_csv_file_2002(a_tabTech, a_decoderId)
...
for id = 1:size(a_tabTech, 1)
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech; Number of CTDO points in descent profile; %d\n', ...
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech; Number of CTDO points in ascent profile; %d\n', ...
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech; Number of CTDO points in drift at parking depth; %d\n', ...
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech; Number of power resets DO sensor; %d\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech(id, 51+ID_OFFSET));
   
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech; Number of failed acquisitions DO sensor; %d\n', ...
