...
%
% SYNTAX :
%  [o_tabProfiles, o_tabDrift] = process_profile_ECO3_mean_stdMed_105_to_107_110_111( ...
...
% ------------------------------------------------------------------------------
function [o_tabProfiles, o_tabDrift] = process_profile_ECO3_mean_stdMed_105_to_107_110_111( ...
   a_dataECO3Mean, a_dataECO3StdMed, ...
   a_descentToParkStartDate, a_ascentEndDate, a_gpsData, a_sensorTechECO3, a_decoderId)
