...
%
% SYNTAX :
%  print_tech_data_in_csv_file_202(a_tabTech)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function print_tech_data_in_csv_file_202(a_tabTech)
...
elseif (length(idF2) == 1)
   ...
   if (cycleStartDateDay ~= g_decArgo_dateDef)
      ...
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas PRES; %d; => %.1f; dbar\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech(id, 10), sensor_2_value_for_pressure_202_210_to_214_217_222_to_224(a_tabTech(id, 10)));
      ...
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas C1PHASE_DOXY; %d; => %.3f; degree\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech(id, 13), sensor_2_value_C1C2Phase_doxy_201T203_206T209_213T218_221_223(a_tabTech(id, 13)));
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas C2PHASE_DOXY; %d; => %.3f; degree\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech(id, 14), sensor_2_value_C1C2Phase_doxy_201T203_206T209_213T218_221_223(a_tabTech(id, 14)));
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas TEMP_DOXY; %d; => %.3f; degC\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech(id, 15), sensor_2_value_for_temp_doxy_201T203_206T209_213T218_221_223(a_tabTech(id, 15)));
