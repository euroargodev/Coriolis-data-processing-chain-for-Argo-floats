...
%
% SYNTAX :
%  [o_decodedData] = decode_prv_data_ir_sbd_212(a_tabData, a_sbdFileName, a_sbdFileDate)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_decodedData] = decode_prv_data_ir_sbd_212(a_tabData, a_sbdFileName, a_sbdFileDate)
