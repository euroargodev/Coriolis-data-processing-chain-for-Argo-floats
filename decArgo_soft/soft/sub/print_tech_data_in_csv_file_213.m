...
elseif (length(idF2) == 1)
   ...
   if (a_deepCycle == 1)
      ...
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2_%d; "Subsurface" meas C1PHASE_DOXY; %d; => %.3f; degree\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 2+ID_OFFSET), a_tabTech2(id, 18+ID_OFFSET), sensor_2_value_C1C2Phase_doxy_201T203_206T209_213T218_221(a_tabTech2(id, 18+ID_OFFSET)));
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2_%d; "Subsurface" meas C2PHASE_DOXY; %d; => %.3f; degree\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 2+ID_OFFSET), a_tabTech2(id, 19+ID_OFFSET), sensor_2_value_C1C2Phase_doxy_201T203_206T209_213T218_221(a_tabTech2(id, 19+ID_OFFSET)));
