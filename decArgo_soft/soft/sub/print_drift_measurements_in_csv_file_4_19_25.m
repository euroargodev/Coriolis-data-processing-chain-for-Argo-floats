...
if (~isempty(a_parkPres))
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Drift; Description; UTC time (Trans./Comp.); pressure (dbar); temperature (°C); salinity (SI); MOLAR_DOXY (micromol/l); DOXY (micromol/kg); redundancy\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum);
