% ------------------------------------------------------------------------------
% Parse and process Apex Iridium park data from log file.
%
% SYNTAX :
%  [o_parkData] = process_apx_ir_park_data_evts(a_parkDate, a_parkMeasStr, a_decoderId)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_parkData] = process_apx_ir_park_data_evts(a_parkDate, a_parkMeasStr, a_decoderId)
