% ------------------------------------------------------------------------------
% Parse Apex Iridium Rudics descending pressure marks data from .log file.
%
% SYNTAX :
%  [o_pMarkData] = parse_apx_ir_rudics_pmark_data_evts(a_events)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_pMarkData] = parse_apx_ir_rudics_pmark_data_evts(a_events)
