...
switch (a_decoderId)
   ...
   case {111, 113, 114} % Remocean V3.00 and higher
      ...
      if (deepCycleFlag == 1)
         set_float_config_ir_rudics_cts4_111_113_114(g_decArgo_cycleProfNum);
      end
      ...
      if (~isempty(floatProgRudics) || ~isempty(floatProgTech) || ...
         ...
         update_float_config_ir_rudics_111_113_114( ...
      ...
      [tabTech] = clean_gps_data_ir_rudics_111_113_114(tabTech);
      ...
      [cycleStartDate, buoyancyRedStartDate, ...
         ...
         compute_prv_dates_ir_rudics_111_113_114(tabTech, ...
      ...
      if (~isempty(g_decArgo_outputCsvFileId))
         ...
         print_info_in_csv_file_ir_rudics_cts4_111_113_114( ...
            a_decoderId, ...
            cyProfPhaseList, ...
            dataCTD, dataOXY, dataOCR, ...
            dataECO2, dataECO3, dataFLNTU, ...
         ...
         if (~isempty(tabTech))
            print_dates_in_csv_file_ir_rudics_cts4_111_113_114( ...
               a_decoderId, ...
               cycleStartDate, buoyancyRedStartDate, ...
               descentToParkStartDate, ...
               firstStabDate, firstStabPres, ...
         ...
         [tabTrajIndex, tabTrajData] = collect_trajectory_data_ir_rudics_111_113_114(a_decoderId, ...
         ...
         process_technical_data_ir_rudics_111_113_114( ...
