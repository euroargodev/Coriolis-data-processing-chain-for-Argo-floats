...
switch (a_decoderId)
   ...
   case {111, 113} % Remocean V3.00 and higher
      ...
      if (deepCycleFlag == 1)
         set_float_config_ir_rudics_cts4_111_113(g_decArgo_cycleProfNum);
      end
      ...
      if (~isempty(floatProgRudics) || ~isempty(floatProgTech) || ...
         ...
         update_float_config_ir_rudics_111_113( ...
      ...
      [tabTech] = clean_gps_data_ir_rudics_111_113(tabTech);
      
      % store GPS data
      store_gps_data_ir_rudics_111_113(tabTech);
      ...
      [cycleStartDate, buoyancyRedStartDate, ...
         ...
         compute_prv_dates_ir_rudics_111_113(tabTech, ...
      ...
      if (~isempty(g_decArgo_outputCsvFileId))
         ...
         [tabProfiles, tabDrift] = process_profiles_ir_rudics_cts4_111_113( ...
            a_decoderId, ...
            cyProfPhaseList, ...
            dataCTD, dataOXY, dataOCR, ...
            dataECO2, dataECO3, dataFLNTU, ...
         ...
         [tabTrajIndex, tabTrajData] = collect_trajectory_data_ir_rudics_111_113(a_decoderId, ...
         ...
         process_technical_data_ir_rudics_111_113( ...
            a_decoderId, cyProfPhaseList, ...
            sensorTechCTD, sensorTechOPTODE, sensorTechOCR, ...
            sensorTechECO2, sensorTechECO3, ...
            sensorTechFLNTU, sensorTechCROVER, sensorTechSUNA, deepCycleFlag, ...
            tabTech, a_refDay, ...
            floatProgParam);
