...
switch (a_decoderId)
   ...
   case {219, 220} % Arvor-C 5.3 & 5.301
      ...
      if (~isempty(dataCTD))
         ...
         [dataCTD(:, 26:49)] = sensor_2_value_for_temperature_204_to_214_217_219_220_222_223(dataCTD(:, 26:49));
         if (a_decoderId == 219)
            [dataCTD(:, 50:73)] = sensor_2_value_for_salinity_219(dataCTD(:, 50:73));
         else
            [dataCTD(:, 50:73)] = sensor_2_value_for_salinity_210_to_214_217_220_222_223(dataCTD(:, 50:73));
         end
      end
