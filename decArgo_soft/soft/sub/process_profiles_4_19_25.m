...
%
% SYNTAX :
%  [o_tabProfiles] = process_profiles_4_19_25(...
...
% ------------------------------------------------------------------------------
function [o_tabProfiles] = process_profiles_4_19_25(...
   a_floatSurfData, a_cycleNum, ...
   a_descProfDate, a_descProfPres, a_descProfTemp, a_descProfSal, ...
   a_descProfRawDoxy, a_descProfDoxy, ...
   a_ascProfDate, a_ascProfPres, a_ascProfTemp, a_ascProfSal, ...
...
for idProf = 1:3
   ...
   if (~isempty(tabDate))
      ...
      tabRawDoxy(find(tabRawDoxy == g_decArgo_molarDoxyCountsDef)) = paramRawDoxy.fillValue;
