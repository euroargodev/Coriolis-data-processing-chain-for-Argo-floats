...
% measurements (TPHASE_DOXY) using the Aanderaa standard calibration.
%
% SYNTAX :
%  [o_PPOX_DOXY] = compute_PPOX_DOXY_28( ...
%    a_TPHASE_DOXY, ...
%    a_TPHASE_DOXY_fillValue, ...
%    a_PRES, a_TEMP, ...
...
% ------------------------------------------------------------------------------
function [o_PPOX_DOXY] = compute_PPOX_DOXY_28( ...
   a_TPHASE_DOXY, ...
   a_TPHASE_DOXY_fillValue, ...
   a_PRES, a_TEMP, ...
   a_PRES_fillValue, a_TEMP_fillValue, ...
