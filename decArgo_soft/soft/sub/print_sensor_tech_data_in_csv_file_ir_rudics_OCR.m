...
for id = 1:length(idPack)
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; OCR tech; A0Lambda380; %f\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechOCRCoefLambda380A0(idP, 3));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; OCR tech; A1Lambda380; %g\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechOCRCoefLambda380A1(idP, 3));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; OCR tech; LmLambda380; %g\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechOCRCoefLambda380Lm(idP, 3));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; OCR tech; A0Lambda412; %f\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechOCRCoefLambda412A0(idP, 3));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; OCR tech; A1Lambda412; %g\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechOCRCoefLambda412A1(idP, 3));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; OCR tech; LmLambda412; %g\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechOCRCoefLambda412Lm(idP, 3));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; OCR tech; A0Lambda490; %f\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechOCRCoefLambda490A0(idP, 3));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; OCR tech; A1Lambda490; %g\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechOCRCoefLambda490A1(idP, 3));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; OCR tech; LmLambda490; %g\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechOCRCoefLambda490Lm(idP, 3));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; OCR tech; A0PAR; %f\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechOCRCoefParA0(idP, 3));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; OCR tech; A1PAR; %g\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechOCRCoefParA1(idP, 3));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; OCR tech; LmPAR; %g\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechOCRCoefParLm(idP, 3));
end
