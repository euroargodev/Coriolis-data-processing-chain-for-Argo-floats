...
%
% SYNTAX :
%  [o_NITRATE] = compute_profile_NITRATE_from_MOLAR_NITRATE_105_to_109_121_122(a_MOLAR_NITRATE, ...
...
% ------------------------------------------------------------------------------
function [o_NITRATE] = compute_profile_NITRATE_from_MOLAR_NITRATE_105_to_109_121_122(a_MOLAR_NITRATE, ...
   a_MOLAR_NITRATE_fill_value, a_NITRATE_fill_value, ...
   a_MOLAR_NITRATE_pres, a_ctdData, ...
   a_PRES_fill_value, a_TEMP_fill_value, a_PSAL_fill_value)
