...
%
% SYNTAX :
%  [o_tabTrajNMeas, o_tabTrajNCycle] = process_trajectory_data_4_19_25( ...
%    a_cycleNum, ...
...
% ------------------------------------------------------------------------------
function [o_tabTrajNMeas, o_tabTrajNCycle] = process_trajectory_data_4_19_25( ...
   a_cycleNum, ...
   a_addLaunchData, a_floatSurfData, ...
   a_floatClockDrift, ...
   a_descentStartDate, a_firstStabDate, a_firstStabPres, a_descentEndDate, ...
...
if (~isempty(a_parkPres))
   ...
   paramRawDoxy = get_netcdf_param_attributes('MOLAR_DOXY');
   ...
   a_parkRawDoxy(find(a_parkRawDoxy == g_decArgo_molarDoxyCountsDef)) = paramRawDoxy.fillValue;
