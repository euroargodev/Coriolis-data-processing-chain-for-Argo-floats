...
%
% SYNTAX :
%  store_tech2_data_for_nc_201_203_215(a_tabTech, a_deepCycle, a_decoderId)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function store_tech2_data_for_nc_201_203_215(a_tabTech, a_deepCycle, a_decoderId)
...
if (a_deepCycle == 1)
   ...
   if (tabTech2(27) > 0)
      ...
      g_decArgo_outputNcParamValue{end+1} = sensor_2_value_for_pressure_201_203_215_216_218(tabTech2(29));
   ...
   if (a_decoderId == 203)
      ...
      g_decArgo_outputNcParamValue{end+1} = tabTech2(41)*20;
