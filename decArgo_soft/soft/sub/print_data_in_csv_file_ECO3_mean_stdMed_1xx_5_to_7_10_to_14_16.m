...
% ------------------------------------------------------------------------------
function print_data_in_csv_file_ECO3_mean_stdMed_1xx_5_to_7_10_to_14_16( ...
   a_decoderId, a_cycleNum, a_profNum, a_phaseNum, ...
   a_dataECO3Mean, a_dataECO3StdMed)
...
if (isempty(idDataStdMed))
   ...
   dataMean(:, 8) = compute_CDOM_105_to_107_110_112_121_to_133_1121_to_28_1322_1323(dataMean(:, 6), g_decArgo_cdomDef, paramCDOM.fillValue);
   ...
   if (isempty(idDataMean))
      ...
      paramCDOM = get_netcdf_param_attributes('CDOM');
      data(:, 14) = compute_CDOM_105_to_107_110_112_121_to_133_1121_to_28_1322_1323(data(:, 6), g_decArgo_cdomDef, paramCDOM.fillValue);
