   ...
   case {114}
      ...
      switch (a_paramName)
         case {'PRES', 'PRES_ADJUSTED'}
            ...
            listMc2 = [ ...
               g_MC_Grounded];
            listMcStr1 = sprintf('%d ', listMc1);
            listMcStr2 = sprintf('%d ', listMc2);
            o_comment = sprintf('%s resolution is 0.1 dbar, except for measurement codes [%s] for which %s resolution is 1 dbar and for measurement codes [%s] for which %s resolution is 10 dbar', ...
               a_paramName, listMcStr2(1:end-1), a_paramName, listMcStr1(1:end-1), a_paramName);
   ...
   case {126, 127}
      ...
      switch (a_paramName)
         case {'PRES', 'PRES_ADJUSTED'}
            ...
            listMcStr = sprintf('%d ', listMc);
            o_comment = sprintf('%s resolution is 0.01 dbar for CTD sensor and 0.1 dbar for BGC sensors, except for measurement codes [%s] for which %s resolution is 1 dbar', ...
               a_paramName, listMcStr(1:end-1), a_paramName);
      ...
      switch (a_paramName)
         ...
         case {'JULD', 'JULD_ADJUSTED'}
            ...
            listMc = [ ...
               g_MC_TST_Float];
            listMcStr = sprintf('%d ', listMc);
            o_comment = sprintf('%s resolution is 1 second, except for measurement code [%s] for which %s resolution is 1 minute', ...
               a_paramName, listMcStr(1:end-1), a_paramName);
   ...
   case {1101, 1102, 1103, 1104, 1105, 1106, 1107, 1108, 1109, 1110, 1111, 1112, 1113, 1314}
      ...
      switch (a_paramName)
         case {'PRES', 'PRES_ADJUSTED'}
            ...
            if (ismember(a_decoderId, [1102, 1103, 1104, 1106, 1107, 1108, 1109, 1113, 1314])) % Apex Iridium Rudics & Sbd without surface measurement
               listMc1 = [ ...
                  g_MC_AST
                  g_MC_AscProfDeepestBin
                  g_MC_AET];
      ...
      switch (a_paramName)
         ...
         case {'JULD', 'JULD_ADJUSTED'}
            ...
            listMc = [ ...
               ...
               g_MC_LMT];
            listMcStr = sprintf('%d ', listMc);
            o_comment = sprintf('%s resolution is 6 minutes, except for measurement codes [%s] for which %s resolution is 1 second', ...
               a_paramName, listMcStr(1:end-1), a_paramName);
