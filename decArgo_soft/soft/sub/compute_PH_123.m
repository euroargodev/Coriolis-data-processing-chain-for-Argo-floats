...
%
% SYNTAX :
%  [o_PH_IN_SITU_FREE, o_PH_IN_SITU_TOTAL] = compute_PH_123( ...
%    a_VRS_PH, ...
%    a_VRS_PH_fillValue, ...
...
% ------------------------------------------------------------------------------
function [o_PH_IN_SITU_FREE, o_PH_IN_SITU_TOTAL] = compute_PH_123( ...
   a_VRS_PH, ...
   a_VRS_PH_fillValue, ...
   a_PRES, a_TEMP, a_PSAL, ...
   a_PRES_fillValue, a_TEMP_fillValue, a_PSAL_fillValue, ...
...
if (~isempty(idNoDef))
   ...
   transPhPCoefs = [transPhF1; transPhF2; transPhF3; transPhF4];
