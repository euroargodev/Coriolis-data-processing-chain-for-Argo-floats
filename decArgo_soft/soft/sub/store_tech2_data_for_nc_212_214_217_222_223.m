...
%
% SYNTAX :
%  store_tech2_data_for_nc_212_214_217_222_223(a_tabTech2, a_deepCycle, a_iceDetected)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function store_tech2_data_for_nc_212_214_217_222_223(a_tabTech2, a_deepCycle, a_iceDetected)
...
if (a_deepCycle == 1)
   ...
   if (tabTech2(32+ID_OFFSET) > 0)
      ...
      g_decArgo_outputNcParamValue{end+1} = sensor_2_value_for_pressure_202_210_to_214_217_222_to_224(tabTech2(34+ID_OFFSET));
