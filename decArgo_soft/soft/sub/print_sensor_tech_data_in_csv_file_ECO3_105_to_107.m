...
% ------------------------------------------------------------------------------
function print_sensor_tech_data_in_csv_file_ECO3_105_to_107( ...
   a_cycleNum, a_profNum, a_dataIndexList, ...
   a_sensorTechECO3)
...
for id = 1:length(idPack)
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; ECO3 tech; ScaleFactChloroA; %g\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechECO3CoefScaleFactChloroA(idP, 3));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; ECO3 tech; DarkCountChloroA; %g\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechECO3CoefDarkCountChloroA(idP, 3));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; ECO3 tech; ScaleFactBackscatter700; %g\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechECO3CoefScaleFactBackscat(idP, 3));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; ECO3 tech; DarkCountBackscatter700; %g\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechECO3CoefDarkCountBackscat(idP, 3));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; ECO3 tech; ScaleFactCDOM; %g\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechECO3CoefScaleFactCdom(idP, 3));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; ECO3 tech; DarkCountCDOM; %g\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechECO3CoefDarkCountCdom(idP, 3));
end
