...
%
% SYNTAX :
%  [o_tabTrajNMeas, o_tabTrajNCycle] = process_trajectory_data_32( ...
%    a_cycleNum, ...
...
%    a_cycleProfiles, ...
%    a_parkDate, a_parkTransDate, a_parkPres, a_parkTemp, a_parkSal, a_parkRawDoxy, a_parkDoxy, ...
...
%   a_parkRawDoxy            : parking raw oxygen measurements
...
% % ------------------------------------------------------------------------------
function [o_tabTrajNMeas, o_tabTrajNCycle] = process_trajectory_data_32( ...
   a_cycleNum, ...
   a_addLaunchData, a_floatSurfData, ...
   a_floatClockDrift, ...
   a_cycleStartDate, a_descentStartDate, ...
