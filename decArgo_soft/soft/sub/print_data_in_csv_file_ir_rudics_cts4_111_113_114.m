...
%
% SYNTAX :
%  print_data_in_csv_file_ir_rudics_cts4_111_113_114( ...
%    a_decoderId, ...
...
% ------------------------------------------------------------------------------
function print_data_in_csv_file_ir_rudics_cts4_111_113_114( ...
   a_decoderId, ...
   a_cyProfPhaseList, a_cyProfPhaseIndexList, ...
   a_dataCTD, a_dataOXY, ...
   a_dataECO2, a_dataECO3, ...
   ...
   if (~isempty(idPack))
      ...
      for idDataType = 1:length(dataTypeList)
         ...
         switch (dataType)
            ...
            case 8
               % ECO2 (raw)
               print_data_in_csv_file_ECO2_raw_111_113_114( ...
                  a_decoderId, cycleNum, profNum, phaseNum, ...
                  a_dataECO2Raw);
