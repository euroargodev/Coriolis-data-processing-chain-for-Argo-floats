...
%
% SYNTAX :
%  print_sensor_tech_data_in_csv_file_ir_rudics_cts4_105_to_110( ...
%    a_decoderId, ...
...
% ------------------------------------------------------------------------------
function print_sensor_tech_data_in_csv_file_ir_rudics_cts4_105_to_110( ...
   a_decoderId, ...
   a_cyProfPhaseList, a_cyProfPhaseIndexList, ...
   a_sensorTechCTD, a_sensorTechOPTODE, ...
   a_sensorTechOCR, a_sensorTechECO3, ...
         ...
         for idDataType = 1:length(dataTypeList)
            ...
            switch (dataType)
               ...
               case 1
                  % OPTODE
                  if (~isempty(dataIndexList))
                     print_sensor_tech_data_in_csv_file_105_to_110_sbd2_OPTODE( ...
                        cycleNum, profNum, dataIndexList, ...
                        a_sensorTechOPTODE);
                  end
