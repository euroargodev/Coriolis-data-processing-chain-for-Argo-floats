   ...
   if (~isempty(profCtdPtshStruct))
      ...
      if (~isempty(idShallow) || ~isempty(idDeep))
         ...
         profCtdCpStruct.data = [ ...
            ...
            profCtdCpStruct.data ...
            ones(size(profCtdCpStruct.data, 1), 1)*paramVrsPh.fillValue ...
            ones(size(profCtdCpStruct.data, 1), 1)*paramPhInSituFree.fillValue ...
            ones(size(profCtdCpStruct.data, 1), 1)*paramPhInSituTotal.fillValue];
         if (~isempty(profCtdCpStruct.dataAdj))
            profCtdCpStruct.dataAdj = [ ...
               ones(size(profCtdCpStruct.dataAdj, 1), 1)*paramMtime.fillValue ...
               profCtdCpStruct.dataAdj ...
               ones(size(profCtdCpStruct.dataAdj, 1), 1)*paramVrsPh.fillValue ...
               ones(size(profCtdCpStruct.dataAdj, 1), 1)*paramPhInSituFree.fillValue ...
               ones(size(profCtdCpStruct.dataAdj, 1), 1)*paramPhInSituTotal.fillValue];
         end
