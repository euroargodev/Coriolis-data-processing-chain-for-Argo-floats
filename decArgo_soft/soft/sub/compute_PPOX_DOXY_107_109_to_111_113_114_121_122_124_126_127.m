...
%
% SYNTAX :
%  [o_PPOX_DOXY] = compute_PPOX_DOXY_107_109_to_111_113_114_121_122_124_126_127( ...
...
% ------------------------------------------------------------------------------
function [o_PPOX_DOXY] = compute_PPOX_DOXY_107_109_to_111_113_114_121_122_124_126_127( ...
   a_C1PHASE_DOXY, a_C2PHASE_DOXY, a_TEMP_DOXY, ...
   a_C1PHASE_DOXY_fillValue, a_C2PHASE_DOXY_fillValue, a_TEMP_DOXY_fillValue, ...
   a_PRES, ...
   a_PRES_fillValue, ...
...
elseif ((isfield(g_decArgo_calibInfo, 'OPTODE')) && (isfield(g_decArgo_calibInfo.OPTODE, 'TabDoxyCoef')))
   ...
   fprintf('ERROR: Float #%d Cycle #%d Profile #%d: inconsistent DOXY calibration coefficients - PPOX_DOXY not computed\n', ...
      g_decArgo_floatNum, ...
      a_profOptode.cycleNumber, ...
      a_profOptode.profileNumber);
   return
