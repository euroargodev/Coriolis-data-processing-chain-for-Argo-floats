...
%
% SYNTAX :
%  [o_ncConfig] = create_output_float_config_ir_rudics_cts4(a_decArgoConfParamNames, a_ncConfParamNames)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_ncConfig] = create_output_float_config_ir_rudics_cts4(a_decArgoConfParamNames, a_ncConfParamNames)
