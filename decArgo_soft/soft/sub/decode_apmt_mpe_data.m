...
%
% SYNTAX :
%  [o_mpeData] = decode_apmt_mpe_data(a_data, a_lastByteNum, a_inputFilePathName)
%
% INPUT PARAMETERS :
%   a_data              : input MPE data to decode
...
% ------------------------------------------------------------------------------
function [o_mpeData] = decode_apmt_mpe_data(a_data, a_lastByteNum, a_inputFilePathName)
