...
for id = 1:length(idPack)
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; ECO3 tech; ScaleFactBackscatter532; %g\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      a_sensorTechECO3CoefScaleFactCdom(idP, 3));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; ECO3 tech; DarkCountBackscatter532; %g\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
