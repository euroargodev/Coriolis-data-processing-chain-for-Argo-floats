...
%    parse_apx_ir_rudics_LR_profile_data(a_profLowResMeasDataStr, a_decoderId)
%
% INPUT PARAMETERS :
...
switch (a_decoderId)
   ...
   case {1101} % 030410
      ...
      [o_parkData, o_profLrData, o_expectedProfLrNbSamples] = ...
         parse_apx_ir_rudics_LR_profile_data_1(a_profLowResMeasDataStr);
      
   case {1102, 1106, 1108} % 120210 & 060612 & 062813_2
      
      [o_parkData, o_profLrData, o_expectedProfLrNbSamples] = ...
         parse_apx_ir_rudics_LR_profile_data_2_6_8(a_profLowResMeasDataStr);
      
   case {1103, 1109} % 012811 & 062813_3
      
      [o_parkData, o_profLrData, o_expectedProfLrNbSamples] = ...
         parse_apx_ir_rudics_LR_profile_data_3_9(a_profLowResMeasDataStr);
      
   case {1104} % 020212
      
      [o_parkData, o_profLrData, o_expectedProfLrNbSamples] = ...
         parse_apx_ir_rudics_LR_profile_data_4(a_profLowResMeasDataStr);
      
   case {1105} % 030512
      
      [o_parkData, o_profLrData, o_expectedProfLrNbSamples] = ...
         parse_apx_ir_rudics_LR_profile_data_5(a_profLowResMeasDataStr);
      
   case {1107} % 062813_1
      
      [o_parkData, o_profLrData, o_expectedProfLrNbSamples] = ...
         parse_apx_ir_rudics_LR_profile_data_7(a_profLowResMeasDataStr);
      
   case {1110, 1112} % 092813 & 102815
      
      [o_parkData, o_profLrData, o_expectedProfLrNbSamples] = ...
         parse_apx_ir_rudics_LR_profile_data_10_12(a_profLowResMeasDataStr);
      
   case {1111} % 073014
      
      [o_parkData, o_profLrData, o_expectedProfLrNbSamples] = ...
         parse_apx_ir_rudics_LR_profile_data_11(a_profLowResMeasDataStr);
      
   case {1113} % 110216
      
      [o_parkData, o_profLrData, o_expectedProfLrNbSamples] = ...
         parse_apx_ir_rudics_LR_profile_data_13(a_profLowResMeasDataStr);      
   ...
   otherwise
      fprintf('DEC_WARNING: Float #%d Cycle #%d: Nothing done yet in parse_apx_ir_rudics_LR_profile_data for decoderId #%d\n', ...
         g_decArgo_floatNum, ...
         g_decArgo_cycleNum, ...
         a_decoderId);
      return;
