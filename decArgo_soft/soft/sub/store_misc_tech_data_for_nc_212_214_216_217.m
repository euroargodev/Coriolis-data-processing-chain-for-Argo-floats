...
% ------------------------------------------------------------------------------
function store_misc_tech_data_for_nc_212_214_216_217(a_decodedDataTab, a_decoderId)
...
if (a_decoderId ~= 216) % ICE mode activation information is not available for Arvor Deep
   iceActivatedFlag = 0;
