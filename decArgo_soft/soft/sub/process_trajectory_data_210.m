...
%
% SYNTAX :
%  [o_tabTrajNMeas, o_tabTrajNCycle] = process_trajectory_data_210( ...
...
% ------------------------------------------------------------------------------
function [o_tabTrajNMeas, o_tabTrajNCycle] = process_trajectory_data_210( ...
   a_cycleNum, a_deepCycle, a_irSessionNum, ...
   a_gpsData, a_iridiumMailData, ...
   a_cycleStartDate, ...
   a_descentToParkStartDate, a_firstStabDate, a_firstStabPres, a_descentToParkEndDate, ...
...
if (a_deepCycle == 1)
   ...
   if (~isempty(tabTech2))
      ...
      pres = sensor_2_value_for_pressure_202_210(tabTech2(15+ID_OFFSET));
      temp = sensor_2_value_for_temperature_204_to_210(tabTech2(16+ID_OFFSET));
      psal = sensor_2_value_for_salinity_210(tabTech2(17+ID_OFFSET));
