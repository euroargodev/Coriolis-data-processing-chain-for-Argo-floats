   ...
   if (~isempty(tabTech2) && (a_iceDetected == 0))
      ...
      if (any([pres temp psal] ~= 0))
         ...
         if (any(tabTech2(14:16) ~= 0) && any(tabTech2(14:16) ~= 65535))
            ...
            c1PhaseDoxy = sensor_2_value_C1C2Phase_doxy_201T203_206T209_213T218_221(tabTech2(14));
            c2PhaseDoxy = sensor_2_value_C1C2Phase_doxy_201T203_206T209_213T218_221(tabTech2(15));
            tempDoxy = sensor_2_value_for_temp_doxy_201T203_206T209_213T218_221(tabTech2(16));
            doxy = compute_DOXY_201_203_206_209_213_to_218_221(c1PhaseDoxy, c2PhaseDoxy, tempDoxy, pres, temp, psal);
