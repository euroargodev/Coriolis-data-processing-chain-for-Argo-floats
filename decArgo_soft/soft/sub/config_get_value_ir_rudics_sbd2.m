...
%
% SYNTAX :
%  [o_confParamvalue] = config_get_value_ir_rudics_sbd2(a_cycleNum, a_profNum, a_confParamName)
%
% INPUT PARAMETERS :
...
%
% OUTPUT PARAMETERS :
%   o_confParamvalue : value of a configuration parameter
%
% EXAMPLES :
%
% SEE ALSO : 
...
% ------------------------------------------------------------------------------
% RELEASES :
%   09/11/2013 - RNU - creation
% ------------------------------------------------------------------------------
function [o_confParamvalue] = config_get_value_ir_rudics_sbd2(a_cycleNum, a_profNum, a_confParamName)
