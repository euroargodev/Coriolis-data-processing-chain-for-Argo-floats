...
if (~isempty(ctdLinkData))   
   ...
   if (a_lambda == 700)
      o_BBP = compute_BBP700_105_to_110_121( ...
...
if (~FITLM_MATLAB_FUNCTION_NOT_AVAILABLE)
   if (a_decoderId ~= 110)
      ...
      for idP = 1:size(paramToDeriveList, 1)
         ...
         if (~isempty(idF1) && ~isempty(idF2))
            ...
            nitrate = compute_drift_NITRATE_from_spectrum_105_to_109_121( ...
   ...
   for idD = 1:length(paramToDeriveList)
      ...
      if (~isempty(idF))
         ...
         nitrate = compute_drift_NITRATE_from_MOLAR_NITRATE_105_to_109_121( ...
...
if (~isempty(ctdLinkData))   
   ...
   switch (a_decoderId)
      ...
      case {107, 109, 110, 121}
         ...
         o_DOXY = compute_DOXY_107_109_110_121( ...
            a_C1PHASE_DOXY, ...
            a_C2PHASE_DOXY, ...
            a_TEMP_DOXY, ...
            a_C1PHASE_DOXY_fillValue, ...
