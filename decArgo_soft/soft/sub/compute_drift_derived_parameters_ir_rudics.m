...
if (~isempty(ctdLinkData))   
   ...
   if (a_lambda == 700)
      o_BBP = compute_BBP700_105_to_112_121_122_124( ...
...
if (~FITLM_MATLAB_FUNCTION_NOT_AVAILABLE)
   if (~ismember(a_decoderId, [110, 113]))
      ...
      for idP = 1:size(paramToDeriveList, 1)
         ...
         if (~isempty(idF1) && ~isempty(idF2))
            ...
            nitrate = compute_drift_NITRATE_105_to_109_111_112_121_122_124( ...
   ...
   for idD = 1:length(paramToDeriveList)
      ...
      if (~isempty(idF))
         ...
         nitrate = compute_drift_NITRATE_from_MOLAR_105_to_109_111_112_121_122_124( ...
