...
% the OPTODE SENSOR.
% The method used is the Aanderaa standard calibration or the Aanderaa
% standard calibration.
%
% SYNTAX :
%  [o_doxyValues] = compute_DOXY_202_207_208( ...
...
% ------------------------------------------------------------------------------
function [o_doxyValues] = compute_DOXY_202_207_208( ...
   a_c1PhaseDoxyValues, a_c2PhaseDoxyValues, a_tempDoxyValues, ...
   a_presValues, a_psalValues)
...
elseif ((isfield(g_decArgo_calibInfo, 'OPTODE')) && (isfield(g_decArgo_calibInfo.OPTODE, 'TabDoxyCoef')))
   ...
   % as tempValues come from the TEMP_DOXY, we don't use TempCoefI (see next
   % line)
