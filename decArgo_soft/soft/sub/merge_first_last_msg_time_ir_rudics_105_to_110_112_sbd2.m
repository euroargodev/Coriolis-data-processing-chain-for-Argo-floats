...
%
% SYNTAX :
%  [o_tabTrajNMeas, o_tabTrajNCycle] = merge_first_last_msg_time_ir_rudics_105_to_110_112_sbd2( ...
...
% ------------------------------------------------------------------------------
function [o_tabTrajNMeas, o_tabTrajNCycle] = merge_first_last_msg_time_ir_rudics_105_to_110_112_sbd2( ...
   a_tabTrajNMeas, a_tabTrajNCycle)
...
if (~isempty(a_tabTrajNCycle))
   ...
   %       (([a_tabTrajNCycle.cycleNumber] == 0) & ([a_tabTrajNCycle.profileNumber] == 0) & ([a_tabTrajNCycle.surfOnly] == 0)));
   idDel = find( ...
      ([a_tabTrajNCycle.cyclePhase] == g_decArgo_phasePreMission) | ...
      (([a_tabTrajNCycle.cyclePhase] == g_decArgo_phaseSatTrans) & ([a_tabTrajNCycle.surfOnly] == 1)) | ...
      (([a_tabTrajNCycle.cyclePhase] == g_decArgo_phaseSurfWait) & ([a_tabTrajNCycle.surfOnly] ~= 2)) | ...
