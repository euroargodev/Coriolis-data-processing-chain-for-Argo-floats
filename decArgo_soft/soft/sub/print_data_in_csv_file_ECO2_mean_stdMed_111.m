...
if (isempty(idDataStdMed))
   ...
   dataMean(:, 6) = compute_CHLA_105_to_111_121_122(dataMean(:, 4), g_decArgo_chloroADef, paramCHLA.fillValue);
   ...
   if (isempty(idDataMean))
      ...
      paramCHLA = get_netcdf_param_attributes('CHLA');
      data(:, 10) = compute_CHLA_105_to_111_121_122(data(:, 4), g_decArgo_chloroADef, paramCHLA.fillValue);
