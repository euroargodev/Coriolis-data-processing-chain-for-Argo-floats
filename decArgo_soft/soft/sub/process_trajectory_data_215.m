...
%
% SYNTAX :
%  [o_tabTrajNMeas, o_tabTrajNCycle, o_tabTechNMeas] = process_trajectory_data_215( ...
...
% ------------------------------------------------------------------------------
function [o_tabTrajNMeas, o_tabTrajNCycle, o_tabTechNMeas] = process_trajectory_data_215( ...
   a_cycleNum, a_deepCycle, ...
   a_gpsData, a_iridiumMailData, ...
   a_cycleStartDate, ...
   a_descentToParkStartDate, a_firstStabDate, a_firstStabPres, a_descentToParkEndDate, ...
...
if (a_deepCycle == 1)
   ...
   if (~isempty(a_tabTech))
      ...
      pres = sensor_2_value_for_pressure_201_203_215_216_218(tabTech2(10));
      temp = sensor_2_value_for_temperature_201_to_203_215_216_218(tabTech2(11));
      ...
      if (any([pres temp psal] ~= 0))
         ...
         if (any(tabTech2(13:15) ~= 0) && any(tabTech2(13:15) ~= 65535))
            ...
            c1PhaseDoxy = sensor_2_value_C1C2Phase_doxy_201_to_203_206_to_209_213_to_218(tabTech2(13));
            c2PhaseDoxy = sensor_2_value_C1C2Phase_doxy_201_to_203_206_to_209_213_to_218(tabTech2(14));
            tempDoxy = sensor_2_value_for_temp_doxy_201_to_203_206_to_209_213_to_218(tabTech2(15));
