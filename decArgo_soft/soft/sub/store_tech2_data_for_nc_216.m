...
%
% SYNTAX :
%  store_tech2_data_for_nc_216(a_tabTech, a_deepCycle, a_iceDetected)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function store_tech2_data_for_nc_216(a_tabTech, a_deepCycle, a_iceDetected)
...
if (a_deepCycle == 1)
   ...
   if (tabTech2(28) > 0)
      ...
      g_decArgo_outputNcParamValue{end+1} = sensor_2_value_for_pressure_201_203_215_216_218(tabTech2(30));
   ...
   g_decArgo_outputNcParamValue{end+1} = tabTech2(42)*20;
   
   % ice detection algorithm is supposed to be always enabled
