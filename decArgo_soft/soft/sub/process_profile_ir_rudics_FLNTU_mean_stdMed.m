...
%
% SYNTAX :
%  [o_tabProfiles, o_tabDrift] = process_profile_ir_rudics_FLNTU_mean_stdMed( ...
...
% ------------------------------------------------------------------------------
function [o_tabProfiles, o_tabDrift] = process_profile_ir_rudics_FLNTU_mean_stdMed( ...
   a_dataFLNTUMean, a_dataFLNTUStdMed, ...
   a_descentToParkStartDate, a_ascentEndDate, a_gpsData, a_sensorTechFLNTU)
...
cycleNumList = sort(unique(a_dataFLNTUMeanDate(:, 1)));
profileNumList = sort(unique(a_dataFLNTUMeanDate(:, 2)));
phaseNumList = sort(unique(a_dataFLNTUMeanDate(:, 3)));
