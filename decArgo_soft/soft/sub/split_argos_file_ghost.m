...
% the algorithm for 'last message ghost' detection may fail (for floats with
% erratic transmissions (such as 6901855)). We then assume that a ghost message
% has at most 2 float messages for a given satellite pass.
