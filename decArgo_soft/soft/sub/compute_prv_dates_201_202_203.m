...
%    compute_prv_dates_201_202_203(a_tabTech)
%
% INPUT PARAMETERS :
...
elseif (length(idF2) == 1)
   ...
   if ((a_tabTech(id, 27) > 0) && (cycleStartDateDay ~= g_decArgo_dateDef))
      o_firstEmergencyAscentDate = a_tabTech(id, 31) + cycleStartDateDay;
      o_firstEmergencyAscentDate = o_firstEmergencyAscentDate + a_tabTech(id, 28)/1440;
