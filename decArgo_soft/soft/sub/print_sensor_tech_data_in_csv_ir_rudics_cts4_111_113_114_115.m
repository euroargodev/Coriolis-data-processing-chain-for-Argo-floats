...
%
% SYNTAX :
%  print_sensor_tech_data_in_csv_ir_rudics_cts4_111_113_114_115( ...
%    a_decoderId, ...
...
% ------------------------------------------------------------------------------
function print_sensor_tech_data_in_csv_ir_rudics_cts4_111_113_114_115( ...
   a_decoderId, ...
   a_cyProfPhaseList, a_cyProfPhaseIndexList, ...
   a_sensorTechCTD, a_sensorTechOPTODE, ...
   a_sensorTechECO2, a_sensorTechECO3, ...
      ...
      for idDataType = 1:length(dataTypeList)
         ...
         switch (dataType)
            ...
            case 1
               % OPTODE
               if (~isempty(dataIndexList))
                  print_sensor_tech_data_in_csv_file_111_113_114_115_OPTODE( ...
                     cycleNum, profNum, dataIndexList, ...
                     a_sensorTechOPTODE);
               end
            ...
            case 2
               % OCR
               if (~isempty(dataIndexList))
                  print_sensor_tech_data_in_csv_ir_rudics_111_113_114_115_OCR( ...
                     cycleNum, profNum, dataIndexList, ...
                     a_sensorTechOCR);
               end
            ...
            case 3
               ...
               if (~isempty(dataIndexList))
                  ...
                  if (ismember('ECO2', g_decArgo_sensorMountedOnFloat))
                     print_sensor_tech_data_in_csv_file_ECO2_111_113_114_115( ...
                        cycleNum, profNum, dataIndexList, ...
                        a_sensorTechECO2);
                     ...
                     switch (a_decoderId)
                        ...
                        case {115}
                           print_sensor_tech_data_in_csv_file_ECO3_108_109_115( ...
                              ...
                              a_sensorTechECO3);
                        otherwise
                           fprintf('WARNING: Float #%d: Nothing implemented yet in print_sensor_tech_data_in_csv_ir_rudics_cts4_111_113_114_115 for decoderId #%d\n', ...
                              g_decArgo_floatNum, ...
                              a_decoderId);
                     end
                  end
