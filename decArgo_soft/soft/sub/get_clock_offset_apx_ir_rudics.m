...
%
% SYNTAX :
%  [o_clockOffset] = get_clock_offset_apx_ir_rudics(...
...
% ------------------------------------------------------------------------------
function [o_clockOffset] = get_clock_offset_apx_ir_rudics(...
   a_floatNum, a_floatRudicsId, a_decoderId)
...
[floatCycleList, restricted] = get_float_cycle_list_iridium_rudics_apx(a_floatNum, a_floatRudicsId);
if (restricted)
