...
% ------------------------------------------------------------------------------
function [o_tabProfiles] = merge_profile_meas_ir_rudics_cts5_usea_ocr_133(a_tabProfiles)
...
paramIr4 = get_netcdf_param_attributes('RAW_DOWNWELLING_IRRADIANCE555');
...
paramIr4StDev = get_netcdf_param_attributes('RAW_DOWNWELLING_IRRADIANCE555_STD');
...
paramIr4Med = get_netcdf_param_attributes('RAW_DOWNWELLING_IRRADIANCE555_MED');
      ...
      switch (a_tabProfiles(idProf).treatType)
         case {g_decArgo_treatRaw, g_decArgo_treatAverage, g_decArgo_treatDecimatedRaw}
            ...
            finalData = [finalData; ...
               ...
               ones(size(data, 1), 1)*paramIr4StDev.fillValue, ...
               ...
               ones(size(data, 1), 1)*paramIr4Med.fillValue, ...
               ];
