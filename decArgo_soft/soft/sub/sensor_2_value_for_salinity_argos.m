...
%
% SYNTAX :
%  [o_salValues] = sensor_2_value_for_salinity_argos(a_salCounts)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_salValues] = sensor_2_value_for_salinity_argos(a_salCounts)
...
o_salValues(idNoDef) = o_salValues(idNoDef)/1000 + 10;
