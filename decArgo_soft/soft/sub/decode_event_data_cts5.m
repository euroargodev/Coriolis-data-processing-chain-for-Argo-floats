...
for id = 1:length(idF) % multiple such events in case of multi parking mode
   if (id == 1)
      g_decArgo_eventDataTime{end+1} = get_cts5_time_data_init_struct(...
         'DESCENT TO PARK START TIME', 'JULD', g_decArgo_eventData{idFCyPtn(idF(id)), 6}, []);
      g_decArgo_eventDataTraj{end+1} = get_cts5_traj_data_init_struct(...
         g_MC_DST, 'JULD', ...
         'Descent to parking depth start date', g_decArgo_eventData{idFCyPtn(idF(id)), 6}, ...
         a_cyNum, a_ptnNum);
      descStartDate = g_decArgo_eventData{idFCyPtn(idF(id)), 6};
   else
      g_decArgo_eventDataTraj{end+1} = get_cts5_traj_data_init_struct(...
         g_MC_PET-10, 'JULD', ...
         'Descent to next parking depth start date', g_decArgo_eventData{idFCyPtn(idF(id)), 6}, ...
         a_cyNum, a_ptnNum);
   end
end
...
for id = 1:length(idF) % multiple such events in case of multi parking mode
   if (id == 1)
      g_decArgo_eventDataTime{end+1} = get_cts5_time_data_init_struct(...
         'PARK START TIME', 'JULD', g_decArgo_eventData{idFCyPtn(idF(id)), 6}, []);
      g_decArgo_eventDataTraj{end+1} = get_cts5_traj_data_init_struct(...
         g_MC_PST, 'JULD', ...
         'Descent to parking depth end date', g_decArgo_eventData{idFCyPtn(idF(id)), 6}, ...
         a_cyNum, a_ptnNum);
      parkStartDate = g_decArgo_eventData{idFCyPtn(idF(id)), 6};
   else
      g_decArgo_eventDataTraj{end+1} = get_cts5_traj_data_init_struct(...
         g_MC_PET-10, 'JULD', ...
         'Descent to next parking depth end date', g_decArgo_eventData{idFCyPtn(idF(id)), 6}, ...
         a_cyNum, a_ptnNum);
   end
end

% stabilize park start time
stabParkStartDate = [];
...
% pressure checks
idF = find(([g_decArgo_eventData{idFCyPtn, 4}] == 282) | ...
   ([g_decArgo_eventData{idFCyPtn, 4}] == 55));
if (~isempty(idF))
   for id = 1:length(idF)
      if (g_decArgo_eventData{idFCyPtn(idF(id)), 4} == 282)
         g_decArgo_eventDataTime{end+1} = get_cts5_time_data_init_struct(...
            'Pressure check', 'JULD', g_decArgo_eventData{idFCyPtn(idF(id)), 6}, ...
            g_decArgo_eventData{idFCyPtn(idF(id)), 5}{1});
      else
         g_decArgo_eventDataTime{end+1} = get_cts5_time_data_init_struct(...
            'Pressure check and speed', 'JULD', g_decArgo_eventData{idFCyPtn(idF(id)), 6}, ...
            g_decArgo_eventData{idFCyPtn(idF(id)), 5}{1});
      end
   end
   ...
   if (~isempty(descStartDate) && ~isempty(refParkStart))
      ...
      for id = 1:length(idF2)
         g_decArgo_eventDataTraj{end+1} = get_cts5_traj_data_init_struct(...
            g_MC_DescProf, 'JULD', ...
            'Pressure check time during descent to park', ...
            g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 6}, ...
            a_cyNum, a_ptnNum);
         g_decArgo_eventDataTraj{end}.group = g_decArgo_trajItemGroupNum;
         g_decArgo_eventDataTraj{end+1} = get_cts5_traj_data_init_struct(...
            g_MC_DescProf, 'PRES', ...
            'Pressure check pressure during descent to park', ...
            g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 5}{1}, ...
            a_cyNum, a_ptnNum);
         g_decArgo_eventDataTraj{end}.group = g_decArgo_trajItemGroupNum;
         g_decArgo_trajItemGroupNum = g_decArgo_trajItemGroupNum + 1;

         if (g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 4} == 55)
            g_decArgo_eventDataParamTech{end+1} = get_cts5_traj_data_init_struct(...
               g_MC_DescProf, 'JULD', ...
               'Pressure check (vertical speed) time during descent to park', ...
               g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 6}, ...
               a_cyNum, a_ptnNum);
            g_decArgo_eventDataParamTech{end}.group = g_decArgo_techItemGroupNum;
            g_decArgo_eventDataParamTech{end+1} = get_cts5_traj_data_init_struct(...
               g_MC_DescProf, 'VERTICAL_SPEED', ...
               'Pressure check (vertical speed) vertical speed during descent to park', ...
               g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 5}{2}, ...
               a_cyNum, a_ptnNum);
            g_decArgo_eventDataParamTech{end}.group = g_decArgo_techItemGroupNum;
            g_decArgo_techItemGroupNum = g_decArgo_techItemGroupNum + 1;
   ...
   if (~isempty(refParkStart) && ~isempty(parkEndDate))
      ...
      for id = 1:length(idF2)
         g_decArgo_eventDataTraj{end+1} = get_cts5_traj_data_init_struct(...
            g_MC_DriftAtPark, 'JULD', ...
            'Pressure check time during drift at park', ...
            g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 6}, ...
            a_cyNum, a_ptnNum);
         g_decArgo_eventDataTraj{end}.group = g_decArgo_trajItemGroupNum;
         g_decArgo_eventDataTraj{end+1} = get_cts5_traj_data_init_struct(...
            g_MC_DriftAtPark, 'PRES', ...
            'Pressure check pressure during drift at park', ...
            g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 5}{1}, ...
            a_cyNum, a_ptnNum);
         g_decArgo_eventDataTraj{end}.group = g_decArgo_trajItemGroupNum;
         g_decArgo_trajItemGroupNum = g_decArgo_trajItemGroupNum + 1;
         ...
         if (g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 4} == 55)
            g_decArgo_eventDataParamTech{end+1} = get_cts5_traj_data_init_struct(...
               g_MC_DriftAtPark, 'JULD', ...
               'Pressure check (vertical speed) time during drift at park', ...
               g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 6}, ...
               a_cyNum, a_ptnNum);
            g_decArgo_eventDataParamTech{end}.group = g_decArgo_techItemGroupNum;
            g_decArgo_eventDataParamTech{end+1} = get_cts5_traj_data_init_struct(...
               g_MC_DriftAtPark, 'VERTICAL_SPEED', ...
               'Pressure check (vertical speed) vertical speed during drift at park', ...
               g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 5}{2}, ...
               a_cyNum, a_ptnNum);
            g_decArgo_eventDataParamTech{end}.group = g_decArgo_techItemGroupNum;
            g_decArgo_techItemGroupNum = g_decArgo_techItemGroupNum + 1;
   ...
   if (~isempty(parkEndDate) && ~isempty(deepParkStartDate))
      ...
      for id = 1:length(idF2)
         g_decArgo_eventDataTraj{end+1} = get_cts5_traj_data_init_struct(...
            g_MC_Desc2Prof, 'JULD', ...
            'Pressure check time during descent to prof', ...
            g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 6}, ...
            a_cyNum, a_ptnNum);
         g_decArgo_eventDataTraj{end}.group = g_decArgo_trajItemGroupNum;
         g_decArgo_eventDataTraj{end+1} = get_cts5_traj_data_init_struct(...
            g_MC_Desc2Prof, 'PRES', ...
            'Pressure check pressure during descent to prof', ...
            g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 5}{1}, ...
            a_cyNum, a_ptnNum);
         g_decArgo_eventDataTraj{end}.group = g_decArgo_trajItemGroupNum;
         g_decArgo_trajItemGroupNum = g_decArgo_trajItemGroupNum + 1;
         ...
         if (g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 4} == 55)
            g_decArgo_eventDataParamTech{end+1} = get_cts5_traj_data_init_struct(...
               g_MC_Desc2Prof, 'JULD', ...
               'Pressure check (vertical speed) time during descent to prof', ...
               g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 6}, ...
               a_cyNum, a_ptnNum);
            g_decArgo_eventDataParamTech{end}.group = g_decArgo_techItemGroupNum;
            g_decArgo_eventDataParamTech{end+1} = get_cts5_traj_data_init_struct(...
               g_MC_Desc2Prof, 'VERTICAL_SPEED', ...
               'Pressure check (vertical speed) vertical speed during descent to prof', ...
               g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 5}{2}, ...
               a_cyNum, a_ptnNum);
            g_decArgo_eventDataParamTech{end}.group = g_decArgo_techItemGroupNum;
            g_decArgo_techItemGroupNum = g_decArgo_techItemGroupNum + 1;
   ...
   if (~isempty(deepParkStartDate) && ~isempty(ascentStartDate))
      ...
      for id = 1:length(idF2)
         g_decArgo_eventDataTraj{end+1} = get_cts5_traj_data_init_struct(...
            g_MC_DriftAtProf, 'JULD', ...
            'Pressure check time during drift at prof', ...
            g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 6}, ...
            a_cyNum, a_ptnNum);
         g_decArgo_eventDataTraj{end}.group = g_decArgo_trajItemGroupNum;
         g_decArgo_eventDataTraj{end+1} = get_cts5_traj_data_init_struct(...
            g_MC_DriftAtProf, 'PRES', ...
            'Pressure check pressure during drift at prof', ...
            g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 5}{1}, ...
            a_cyNum, a_ptnNum);
         g_decArgo_eventDataTraj{end}.group = g_decArgo_trajItemGroupNum;
         g_decArgo_trajItemGroupNum = g_decArgo_trajItemGroupNum + 1;
         ...
         if (g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 4} == 55)
            g_decArgo_eventDataParamTech{end+1} = get_cts5_traj_data_init_struct(...
               g_MC_DriftAtProf, 'JULD', ...
               'Pressure check (vertical speed) time during drift at prof', ...
               g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 6}, ...
               a_cyNum, a_ptnNum);
            g_decArgo_eventDataParamTech{end}.group = g_decArgo_techItemGroupNum;
            g_decArgo_eventDataParamTech{end+1} = get_cts5_traj_data_init_struct(...
               g_MC_DriftAtProf, 'VERTICAL_SPEED', ...
               'Pressure check (vertical speed) vertical speed during drift at prof', ...
               g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 5}{2}, ...
               a_cyNum, a_ptnNum);
            g_decArgo_eventDataParamTech{end}.group = g_decArgo_techItemGroupNum;
            g_decArgo_techItemGroupNum = g_decArgo_techItemGroupNum + 1;
   ...
   if (~isempty(ascentStartDate))
      ...
      for id = 1:length(idF2)
         g_decArgo_eventDataTraj{end+1} = get_cts5_traj_data_init_struct(...
            g_MC_AscProf, 'JULD', ...
            'Pressure check time during ascent to surface', ...
            g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 6}, ...
            a_cyNum, a_ptnNum);
         g_decArgo_eventDataTraj{end}.group = g_decArgo_trajItemGroupNum;
         g_decArgo_eventDataTraj{end+1} = get_cts5_traj_data_init_struct(...
            g_MC_AscProf, 'PRES', ...
            'Pressure check pressure during ascent to surface', ...
            g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 5}{1}, ...
            a_cyNum, a_ptnNum);
         g_decArgo_eventDataTraj{end}.group = g_decArgo_trajItemGroupNum;
         g_decArgo_trajItemGroupNum = g_decArgo_trajItemGroupNum + 1;
         ...
         if (g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 4} == 55)
            g_decArgo_eventDataParamTech{end+1} = get_cts5_traj_data_init_struct(...
               g_MC_AscProf, 'JULD', ...
               'Pressure check (vertical speed) time during ascent to surface', ...
               g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 6}, ...
               a_cyNum, a_ptnNum);
            g_decArgo_eventDataParamTech{end}.group = g_decArgo_techItemGroupNum;
            g_decArgo_eventDataParamTech{end+1} = get_cts5_traj_data_init_struct(...
               g_MC_AscProf, 'VERTICAL_SPEED', ...
               'Pressure check (vertical speed) vertical speed during ascent to surface', ...
               g_decArgo_eventData{idFCyPtn(idF(idF2(id))), 5}{2}, ...
               a_cyNum, a_ptnNum);
            g_decArgo_eventDataParamTech{end}.group = g_decArgo_techItemGroupNum;
            g_decArgo_techItemGroupNum = g_decArgo_techItemGroupNum + 1;
