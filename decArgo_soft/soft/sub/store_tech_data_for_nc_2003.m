...
%
% SYNTAX :
%  store_tech_data_for_nc_2003(a_tabTech, a_deepCycle)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function store_tech_data_for_nc_2003(a_tabTech, a_deepCycle)
...
if (g_decArgo_finalEolMode == 0)
   ...
   if (a_deepCycle == 1)
      ...
      g_decArgo_outputNcParamValue{end+1} = tabTech(34+ID_OFFSET);
      ...
      g_decArgo_outputNcParamValue{end+1} = tabTech(39+ID_OFFSET);
      ...
      g_decArgo_outputNcParamValue{end+1} = tabTech(48+ID_OFFSET);
   ...
   for idTech = 1:size(a_tabTech, 1)
      ...
      g_decArgo_outputNcParamIndex = [g_decArgo_outputNcParamIndex;
         g_decArgo_cycleNum 136+offset];
      g_decArgo_outputNcParamValue{end+1} = a_tabTech(idTech, 48+ID_OFFSET);
   end
end
