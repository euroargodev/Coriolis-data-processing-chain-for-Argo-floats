...
%
% SYNTAX :
%  store_tech2_data_for_nc_201_203(a_tabTech, a_deepCycle, a_decoderId)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function store_tech2_data_for_nc_201_203(a_tabTech, a_deepCycle, a_decoderId)
...
if (a_deepCycle == 1)
   ...
   g_decArgo_outputNcParamValue{end+1} = sensor_2_value_for_pressure_201_203(tabTech2(10));
