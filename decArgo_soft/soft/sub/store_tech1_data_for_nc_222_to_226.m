...
%
% SYNTAX :
%  store_tech1_data_for_nc_222_to_226(a_tabTech1, a_deepCycle)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function store_tech1_data_for_nc_222_to_226(a_tabTech1, a_deepCycle)
...
if (a_deepCycle == 1)
   ...
   if (tabTech1(61+ID_OFFSET) == 1) % GPS valid fix
      g_decArgo_outputNcParamIndex = [g_decArgo_outputNcParamIndex;
         g_decArgo_cycleNum 136];
      g_decArgo_outputNcParamValue{end+1} = format_time_mmss_dec_argo(tabTech1(73+ID_OFFSET)/3600);
   end
