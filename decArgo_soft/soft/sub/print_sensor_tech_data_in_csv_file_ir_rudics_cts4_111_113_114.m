...
%
% SYNTAX :
%  print_sensor_tech_data_in_csv_file_ir_rudics_cts4_111_113_114( ...
...
% ------------------------------------------------------------------------------
function print_sensor_tech_data_in_csv_file_ir_rudics_cts4_111_113_114( ...
   a_cyProfPhaseList, a_cyProfPhaseIndexList, ...
   a_sensorTechCTD, a_sensorTechOPTODE, ...
   a_sensorTechECO2, a_sensorTechECO3, ...
      ...
      for idDataType = 1:length(dataTypeList)
         ...
         switch (dataType)
            ...
            case 1
               % OPTODE
               if (~isempty(dataIndexList))
                  print_sensor_tech_data_in_csv_file_111_113_114_OPTODE( ...
                     cycleNum, profNum, dataIndexList, ...
                     a_sensorTechOPTODE);
               end
            ...
            case 2
               % OCR
               if (~isempty(dataIndexList))
                  print_sensor_tech_data_in_csv_file_ir_rudics_111_113_114_OCR( ...
                     cycleNum, profNum, dataIndexList, ...
                     a_sensorTechOCR);
               end
            ...
            case 3
               ...
               if (~isempty(dataIndexList))
                  ...
                  if (ismember('ECO2', g_decArgo_sensorMountedOnFloat))
                     print_sensor_tech_data_in_csv_file_ECO2_111_113_114( ...
                        cycleNum, profNum, dataIndexList, ...
                        a_sensorTechECO2);
