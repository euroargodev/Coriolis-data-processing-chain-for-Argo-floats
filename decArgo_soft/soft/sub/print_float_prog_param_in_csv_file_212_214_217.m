...
%
% SYNTAX :
%  print_float_prog_param_in_csv_file_212_214_217(a_floatParam1, a_floatParam2)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function print_float_prog_param_in_csv_file_212_214_217(a_floatParam1, a_floatParam2)
...
elseif (size(a_floatParam1, 1) == 1)
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog1_%d; TC24: Internal pressure calibration coeficient #1; %.3f\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_floatParam1(id, 2+ID_OFFSET), a_floatParam1(id, 66+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog1_%d; TC25: Internal pressure calibration coeficient #2; %f\n', ...
