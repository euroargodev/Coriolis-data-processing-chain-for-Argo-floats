% ------------------------------------------------------------------------------
% Decode one cycle of APEX Iridium Rudics data.
%
% SYNTAX :
...
%    o_timeDataLog, ...
%    o_presOffsetData] = ...
%    decode_apx_ir_rudics(a_msgFileList, a_logFileList, a_presOffsetData, a_decoderId)
%
% INPUT PARAMETERS :
...
if (~isempty(a_msgFileList))
   [o_miscInfoMsg, o_configInfoMsg, o_techInfo, o_techData, ...
      ...
      o_gpsDataMsg, o_gpsInfoMsg, ...
      o_presOffsetData] = ...
      decode_msg_apx_ir_rudics(a_msgFileList, o_presOffsetData, a_decoderId);
end
...
if (~isempty(a_logFileList))
   [o_miscInfoLog, o_configInfoLog, ...
      ...
      sbe63ParseIssueDataLog, ...
      o_presOffsetData] = ...
      decode_log_apx_ir_rudics(a_logFileList, o_presOffsetData, a_decoderId);
end
