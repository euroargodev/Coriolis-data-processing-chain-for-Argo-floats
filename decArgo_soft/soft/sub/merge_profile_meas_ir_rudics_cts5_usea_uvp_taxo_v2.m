...
%
% SYNTAX :
%  [o_tabProfiles] = merge_profile_meas_ir_rudics_cts5_usea_uvp_taxo_v2(a_tabProfiles)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_tabProfiles] = merge_profile_meas_ir_rudics_cts5_usea_uvp_taxo_v2(a_tabProfiles)
...
for idDir = 1:length(uDir)
   ...
   newProfile.paramNumberWithSubLevels = [4:7];
   newProfile.paramNumberOfSubLevels = [40 40 40 40];
