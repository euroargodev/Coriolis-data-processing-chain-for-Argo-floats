...
% ------------------------------------------------------------------------------
function print_sensor_tech_data_in_csv_file_ECO3_105_to_107_110_to_112( ...
   a_cycleNum, a_profNum, a_dataIndexList, ...
   a_sensorTechECO3)
...
for id = 1:length(idPack)
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; ECO3 tech; ScaleFactCDOM; %s\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
      num_2_str(a_sensorTechECO3CoefScaleFactCdom(idP, 3)));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; %d; %s; ECO3 tech; DarkCountCDOM; %s\n', ...
      g_decArgo_floatNum, a_cycleNum, a_profNum, get_phase_name(-1), ...
