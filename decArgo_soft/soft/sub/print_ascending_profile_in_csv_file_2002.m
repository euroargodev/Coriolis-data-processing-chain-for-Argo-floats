...
if (~isempty(a_ascProfPres))
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; AscProf; Description; Float time; UTC time; PRES (dbar); TEMP (°C); PSAL (PSU); TEMP_DOXY (°C); PHASE_DELAY_DOXY (usec); DOXY (micromol/kg)\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum);
