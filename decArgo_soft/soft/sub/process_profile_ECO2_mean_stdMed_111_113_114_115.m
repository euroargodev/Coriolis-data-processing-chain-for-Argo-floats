...
%
% SYNTAX :
%  [o_tabProfiles, o_tabDrift] = process_profile_ECO2_mean_stdMed_111_113_114_115( ...
...
% ------------------------------------------------------------------------------
function [o_tabProfiles, o_tabDrift] = process_profile_ECO2_mean_stdMed_111_113_114_115( ...
   a_dataECO2Mean, a_dataECO2StdMed, ...
   a_descentToParkStartDate, a_ascentEndDate, a_gpsData, a_sensorTechECO2, a_decoderId)
...
cycleProfPhaseList = unique(a_dataECO2MeanDate(:, 1:3), 'rows');
