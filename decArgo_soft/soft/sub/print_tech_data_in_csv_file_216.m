...
%
% SYNTAX :
%  print_tech_data_in_csv_file_216(a_tabTech1, a_tabTech2, a_deepCycle)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function print_tech_data_in_csv_file_216(a_tabTech1, a_tabTech2, a_deepCycle)
...
elseif (length(idF1) == 1)
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #1; Pressure offset; %d; cbar\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, twos_complement_dec_argo(a_tabTech1(id, 44+ID_OFFSET), 8));
...
elseif (length(idF2) == 1)
   ...
   if (a_deepCycle == 1)
      ...
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas PRES; %d; => %.1f; dbar\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 10+ID_OFFSET), sensor_2_value_for_pressure_201_203_215_216(a_tabTech2(id, 10+ID_OFFSET)));
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas TEMP; %d; => %.3f; °C\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 11+ID_OFFSET), sensor_2_value_for_temperature_201_to_203_215_216(a_tabTech2(id, 11+ID_OFFSET)));
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas PSAL; %d; => %.3f; PSU\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 12+ID_OFFSET), sensor_2_value_for_salinity_201_to_203_215_216(a_tabTech2(id, 12+ID_OFFSET)));
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas C1PHASE_DOXY; %d; => %.3f; degree\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 13+ID_OFFSET), sensor_2_value_C1C2Phase_doxy_201_to_203_206_to_209_213_to_217(a_tabTech2(id, 13+ID_OFFSET)));
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas C2PHASE_DOXY; %d; => %.3f; degree\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 14+ID_OFFSET), sensor_2_value_C1C2Phase_doxy_201_to_203_206_to_209_213_to_217(a_tabTech2(id, 14+ID_OFFSET)));
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas TEMP_DOXY; %d; => %.3f; °C\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 15+ID_OFFSET), sensor_2_value_for_temp_doxy_201_to_203_206_to_209_213_to_217(a_tabTech2(id, 15+ID_OFFSET)));
   ...
   if (a_deepCycle == 1)
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; Insulation voltage (20 mV resolution); %d; => %d mV\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 41+ID_OFFSET), a_tabTech2(id, 41+ID_OFFSET)*20);
   end
