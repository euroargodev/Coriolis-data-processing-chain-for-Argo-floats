...
elseif (length(idF2) == 1)
   ...
   if (a_deepCycle == 1)
      ...
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas C1PHASE_DOXY; %d; => %.3f; degree\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 13+ID_OFFSET), sensor_2_value_C1C2Phase_doxy_201_to_203_206_to_209_213_to_216(a_tabTech2(id, 13+ID_OFFSET)));
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas C2PHASE_DOXY; %d; => %.3f; degree\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 14+ID_OFFSET), sensor_2_value_C1C2Phase_doxy_201_to_203_206_to_209_213_to_216(a_tabTech2(id, 14+ID_OFFSET)));
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech #2; "Subsurface" meas TEMP_DOXY; %d; => %.3f; °C\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech2(id, 15+ID_OFFSET), sensor_2_value_for_temp_doxy_201_to_203_206_to_209_213_to_216(a_tabTech2(id, 15+ID_OFFSET)));
