...
switch (a_decoderId)
   ...
   case {216} % Arvor-Deep-Ice Iridium 5.65 (IFREMER version)
      ...
      % convert counts to physical values
      if (~isempty(dataCTD))
         [dataCTD(:, 33:47)] = sensor_2_value_for_pressure_201_203_215_216_218(dataCTD(:, 33:47));
         [dataCTD(:, 48:62)] = sensor_2_value_for_temperature_201_to_203_215_216_218(dataCTD(:, 48:62));
         [dataCTD(:, 63:77)] = sensor_2_value_for_salinity_201_to_203_215_216_218(dataCTD(:, 63:77));
      end
      if (~isempty(dataCTDO))
         [dataCTDO(:, 17:23)] = sensor_2_value_for_pressure_201_203_215_216_218(dataCTDO(:, 17:23));
         [dataCTDO(:, 24:30)] = sensor_2_value_for_temperature_201_to_203_215_216_218(dataCTDO(:, 24:30));
         [dataCTDO(:, 31:37)] = sensor_2_value_for_salinity_201_to_203_215_216_218(dataCTDO(:, 31:37));
         [dataCTDO(:, 38:51)] = sensor_2_value_C1C2Phase_doxy_201_to_203_206_to_209_213_to_218(dataCTDO(:, 38:51));
         [dataCTDO(:, 52:58)] = sensor_2_value_for_temp_doxy_201_to_203_206_to_209_213_to_218(dataCTDO(:, 52:58));
      end
      ...
      [parkDate, parkTransDate, ...
         parkPres, parkTemp, parkSal, ...
         parkC1PhaseDoxy, parkC2PhaseDoxy, parkTempDoxy] = ...
         create_prv_drift_201_to_203_215_216_218(dataCTD, dataCTDO, 2);
      ...
      [descProfDate, descProfPres, descProfTemp, descProfSal, ...
         ...
         inAirDate, inAirTransDate, inAirPres, inAirTemp, inAirSal, ...
         inAirC1PhaseDoxy, inAirC2PhaseDoxy, inAirTempDoxy] = ...
         create_prv_profile_215_216_218(dataCTD, dataCTDO, 2);
