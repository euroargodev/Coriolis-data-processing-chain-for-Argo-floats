...
%
% SYNTAX :
%  store_tech1_data_for_nc_221(a_tabTech, a_deepCycle)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function store_tech1_data_for_nc_221(a_tabTech, a_deepCycle)
...
if (a_deepCycle == 1)
   ...
   if (tabTech1(59) == 1) % GPS valid fix
      g_decArgo_outputNcParamIndex = [g_decArgo_outputNcParamIndex;
         g_decArgo_cycleNum 138];
      g_decArgo_outputNcParamValue{end+1} = format_time_mmss_dec_argo(tabTech1(74)/3600);
   end
