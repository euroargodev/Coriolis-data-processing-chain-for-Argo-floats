...
%
% SYNTAX :
%  [o_ramsesData] = decode_apmt_ramses_data(a_data, a_lastByteNum, a_inputFilePathName)
%
% INPUT PARAMETERS :
%   a_data              : input RAMSES data to decode
...
% ------------------------------------------------------------------------------
function [o_ramsesData] = decode_apmt_ramses_data(a_data, a_lastByteNum, a_inputFilePathName)
