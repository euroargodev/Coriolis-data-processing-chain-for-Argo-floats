...
while (again ~= 0)
   ...
   switch (paramName)
      ...
      case 'JULD_LEVEL' % for nc_create_v2_merged_profile
      ...
      case 'VALVE_ACTION_FLAG' % for TRAJ_AUX
      ...
      case 'PUMP_ACTION_FLAG' % for TRAJ_AUX
      ...
      case 'VALVE_ACTION_DURATION' % for TRAJ_AUX
      ...
      case 'PUMP_ACTION_DURATION' % for TRAJ_AUX
