...
while (again ~= 0)
   ...
   switch (paramName)
      ...
      case 'NB_SAMPLE_CTD'  % for PROF_AUX
      ...
      case 'NB_SAMPLE_TRANSISTOR_PH'  % for PROF_AUX
      ...
      case 'NB_SIZE_SPECTRA_PARTICLES'
         o_attributeStruct = struct('name', 'NB_SIZE_SPECTRA_PARTICLES', ...
            'longName', 'Number of particles per size class', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'number of particles per litre', ...
            'validMin', '', ...
            'validMax', '', ...
            'axis', '', ...
            'cFormat', '%d', ...
      ...
      case 'GREY_SIZE_SPECTRA_PARTICLES'
         o_attributeStruct = struct('name', 'GREY_SIZE_SPECTRA_PARTICLES', ...
            'longName', 'Mean grey level per size class', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'count', ...
            'validMin', '', ...
