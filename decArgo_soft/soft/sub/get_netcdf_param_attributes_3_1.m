...
while (again ~= 0)
   ...
   switch (paramName)
      ...
      case 'IMAGE_NUMBER_PARTICLES_LPM'
         o_attributeStruct = struct('name', 'IMAGE_NUMBER_PARTICLES_LPM', ...
      ...
      case 'NUMBER_IMAGES_PARTICLES_TAXO'
         o_attributeStruct = struct('name', 'NUMBER_IMAGES_PARTICLES_TAXO', ...
            'longName', 'Number of images analysed and averaged in the record', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'count', ...
            'validMin', '', ...
      ...
      case 'BLACK_NUMBER_IMAGES_PARTICLES'
         o_attributeStruct = struct('name', 'BLACK_NUMBER_IMAGES_PARTICLES', ...
            'longName', 'Number of images analysed and averaged', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'count', ...
      ...
      case 'NUMBER_CATEGORIES_TAXO'
         o_attributeStruct = struct('name', 'NUMBER_CATEGORIES_TAXO', ...
      ...
      case 'NUMBER_OBJECTS_CATEGORY'
         o_attributeStruct = struct('name', 'NUMBER_OBJECTS_CATEGORY', ...
            'longName', 'Number of objects of the taxonomy category found in the record', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'count', ...
            'validMin', '', ...
      ...
      case 'OBJECT_MEAN_SIZE_CATEGORY'
         o_attributeStruct = struct('name', 'OBJECT_MEAN_SIZE_CATEGORY', ...
            'longName', 'Mean size of an object of the taxonomy category', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', '', ...
            'validMin', '', ...
      ...
      case 'OBJECT_MEAN_GREY_LEVEL_CATEGORY'
         o_attributeStruct = struct('name', 'OBJECT_MEAN_GREY_LEVEL_CATEGORY', ...
            'longName', 'Mean grey level of an object of the taxonomy category', ...
            'standardName', '', ...
            'fillValue', single(99999), ...
            'units', 'count', ...
            'validMin', '', ...
