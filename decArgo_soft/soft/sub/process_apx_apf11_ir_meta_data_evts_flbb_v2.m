...
%
% SYNTAX :
%  [o_metaData] = process_apx_apf11_ir_meta_data_evts_flbb_v2(a_events, a_metaData)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_metaData] = process_apx_apf11_ir_meta_data_evts_flbb_v2(a_events, a_metaData)
...
PATTERN_USED = [ ...
   {'Serial Number:'} {'FLBB_SERIAL_NUMBER'} ...
   ];
