...
%
% SYNTAX :
%  print_tech_data_in_csv_file_205_to_209(a_tabTech)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function print_tech_data_in_csv_file_205_to_209(a_tabTech, a_decoderId)
...
elseif (size(a_tabTech, 1) == 1)
   ...
   if ~((length(unique(a_tabTech(id, 4:43))) == 1) && (unique(a_tabTech(id, 4:43)) == 0))
      ...
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech; "Subsurface" meas TEMP; %d; => %.3f; degC\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech(id, 42), sensor_2_value_for_temp_204_to_214_217_219_220_222_to_224(a_tabTech(id, 42)));
   ...
   if (a_decoderId == 209)
      ...
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech; SBE 63 state indicator (0:Ok, 1:Ko (dialog problem)); %d\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech(id, 76));
      fprintf(g_decArgo_outputCsvFileId, '%d; %d; Tech; Aanderaa 4330 state indicator (0:Ok, 1:Ko (dialog problem)); %d\n', ...
         g_decArgo_floatNum, g_decArgo_cycleNum, a_tabTech(id, 77));
   end
end
