...
%
% SYNTAX :
%  print_float_prog_param_in_csv_file_213(a_floatParam)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function print_float_prog_param_in_csv_file_213(a_floatParam)
...
elseif (size(a_floatParam, 1) == 1)
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog_%d; TC21: Delay before reset-offset command; %d; minutes\n', ...
   ...
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog_%d; TC23: Iridium timeout; %d; minutes\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_floatParam(id, 2+ID_OFFSET), a_floatParam(id, 65+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog_%d; TC24: Internal pressure calibration coeficient #1; %.3f\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_floatParam(id, 2+ID_OFFSET), a_floatParam(id, 66+ID_OFFSET));
   fprintf(g_decArgo_outputCsvFileId, '%d; %d; Prog_%d; TC25: Internal pressure calibration coeficient #2; %f\n', ...
      g_decArgo_floatNum, g_decArgo_cycleNum, a_floatParam(id, 2+ID_OFFSET), a_floatParam(id, 67+ID_OFFSET));
end
