...
%
% SYNTAX :
%  [o_miscInfo, o_missionCfg, o_sampleCfg, ...
%    o_gpsData, o_grounding, o_buoyancy, o_cycleTimeData, o_presOffsetData] = ...
%    decode_system_log_apx_apf11_ir(a_systemLogFileList, a_cycleTimeData, a_presOffsetData)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_miscInfo, o_missionCfg, o_sampleCfg, ...
   o_gpsData, o_grounding, o_buoyancy, o_cycleTimeData, o_presOffsetData] = ...
   decode_system_log_apx_apf11_ir(a_systemLogFileList, a_cycleTimeData, a_presOffsetData)
