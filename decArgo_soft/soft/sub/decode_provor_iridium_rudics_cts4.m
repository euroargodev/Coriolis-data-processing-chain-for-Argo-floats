...
if (isempty(g_decArgo_outputCsvFileId))
   ...
   if (g_decArgo_generateNcMeta ~= 0)
      ...
      [decArgoConfParamNames, ncConfParamNames] = create_config_param_names_ir_rudics_cts4;
   end
end
...
init_float_config_ir_rudics_cts4(a_launchDate, a_decoderId);
   ...
   if (~isempty(idToProcess))
      ...
      switch (a_decoderId)
         ...
         case {105, 106, 107, 108, 109} % Remocean A
            ...
            % profiles
            set_float_config_ir_rudics_cts4(cyProfPhaseList, a_floatSoftVersion);
