...
%
% SYNTAX :
%  [o_NITRATE] = compute_drift_NITRATE_from_MOLAR_1xx_5_to_9_11_12_14_21_to_25(a_MOLAR_NITRATE, ...
...
% ------------------------------------------------------------------------------
function [o_NITRATE] = compute_drift_NITRATE_from_MOLAR_1xx_5_to_9_11_12_14_21_to_25(a_MOLAR_NITRATE, ...
   a_MOLAR_NITRATE_fill_value, a_NITRATE_fill_value, ...
   a_MOLAR_NITRATE_dates, a_ctdDates, a_ctdData, ...
   a_PRES_fill_value, a_TEMP_fill_value, a_PSAL_fill_value, a_profSuna)
