...
%
% SYNTAX :
%  [o_tabProfiles] = process_profiles_210_211( ...
...
%    a_descentToParkStartDate, a_ascentEndDate, a_transStartDate, a_tabTech2, a_decoderId)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function [o_tabProfiles] = process_profiles_210_211( ...
   a_descProfDate, a_descProfPres, a_descProfTemp, a_descProfSal, ...
   a_ascProfDate, a_ascProfPres, a_ascProfTemp, a_ascProfSal, ...
   a_gpsData, a_iridiumMailData, ...
   a_descentToParkStartDate, a_ascentEndDate, a_transStartDate, a_tabTech2, a_decoderId)
