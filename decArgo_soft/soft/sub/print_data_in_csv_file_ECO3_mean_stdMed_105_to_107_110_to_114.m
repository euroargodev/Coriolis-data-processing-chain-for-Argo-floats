...
%
% SYNTAX :
%  print_data_in_csv_file_ECO3_mean_stdMed_105_to_107_110_to_114( ...
...
% ------------------------------------------------------------------------------
function print_data_in_csv_file_ECO3_mean_stdMed_105_to_107_110_to_114( ...
   a_decoderId, a_cycleNum, a_profNum, a_phaseNum, ...
   a_dataECO3Mean, a_dataECO3StdMed)
...
if (isempty(idDataStdMed))
   ...
   dataMean(:, 8) = compute_CDOM_105_to_107_110_112_121_to_127_1121_to_27_1322_1323(dataMean(:, 6), g_decArgo_cdomDef, paramCDOM.fillValue);
   ...
   if (isempty(idDataMean))
      ...
      paramCDOM = get_netcdf_param_attributes('CDOM');
      data(:, 14) = compute_CDOM_105_to_107_110_112_121_to_127_1121_to_27_1322_1323(data(:, 6), g_decArgo_cdomDef, paramCDOM.fillValue);
