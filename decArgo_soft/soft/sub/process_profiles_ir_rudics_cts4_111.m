...
%
% SYNTAX :
%  [o_tabProfiles, o_tabDrift] = process_profiles_ir_rudics_cts4_111( ...
%    a_decoderId, ...
%    a_cyProfPhaseList, ...
...
% ------------------------------------------------------------------------------
function [o_tabProfiles, o_tabDrift] = process_profiles_ir_rudics_cts4_111( ...
   a_decoderId, ...
   a_cyProfPhaseList, ...
   a_dataCTD, a_dataOXY, a_dataOCR, ...
   a_dataECO2, a_dataECO3, a_dataFLNTU, ...
...
for idDataType = 1:length(dataTypeList)
   ...
   switch (dataType)
      ...
      case 6
         ...
         [prof, drift] = process_profile_ECO2_mean_stdMed_111( ...
      ...
      case 8
         % ECO2 (raw)
         [prof, drift] = process_profile_ECO2_raw_111( ...
            a_dataECO2Raw, ...
            a_descentToParkStartDate, a_ascentEndDate, ...
            a_gpsData, a_sensorTechECO2, a_decoderId);
      ...
      case 9
         ...
         [prof, drift] = process_profile_ECO3_mean_stdMed_105_to_107_110_111( ...
      ...
      case 11
         % ECO3 (raw)
         [prof, drift] = process_profile_ECO3_raw_105_to_107_110_111( ...
            a_dataECO3Raw, ...
            a_descentToParkStartDate, a_ascentEndDate, ...
            a_gpsData, a_sensorTechECO3, a_decoderId);
      ...
      case 24
         % SUNA (APF)
         [prof, drift] = process_profile_ir_rudics_SUNA_APF_105_to_109_111_121_122( ...
            a_dataSUNAAPF, ...
            a_descentToParkStartDate, a_ascentEndDate, ...
