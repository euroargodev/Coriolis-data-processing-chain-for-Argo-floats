...
%
% SYNTAX :
%  generate_json_float_meta_apx_apf11_iridium()
%
% INPUT PARAMETERS :
%
% OUTPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function generate_json_float_meta_apx_apf11_iridium()
...
% log file creation
logFileName = [DIR_LOG_FILE '/generate_json_float_meta_apx_apf11_iridium_' currentTime '.log'];
diary(logFileName);
