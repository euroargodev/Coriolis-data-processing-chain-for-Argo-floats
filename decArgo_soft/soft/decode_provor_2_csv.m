% ------------------------------------------------------------------------------
% Decode PROVOR data to a CSV file.
%
% SYNTAX :
%   decode_provor_2_csv or decode_provor_2_csv(6900189, 7900118)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function decode_provor_2_csv(varargin)
...
logFileName = [g_decArgo_dirOutputLogFile '/decode_provor_2_csv' name '_' datestr(now, 'yyyymmddTHHMMSS') '.log'];
diary(logFileName);

% output CSV file creation
outputFileName = [g_decArgo_dirOutputCsvFile '/provor_decoded_data' name '_' datestr(now, 'yyyymmddTHHMMSS') '.csv'];
