% source: http://www.mathworks.com/matlabcentral/fileexchange/27816-2s-complement-to-decimal-converter?download=true

function [decimal] = twos_complement_dec_argo(x,bits)
