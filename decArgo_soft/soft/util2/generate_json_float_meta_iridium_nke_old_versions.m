...
%
% SYNTAX :
%  generate_json_float_meta_iridium_nke_old_versions()
%
% INPUT PARAMETERS :
%
% OUTPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
% RELEASES :
%   10/16/2015 - RNU - creation
% ------------------------------------------------------------------------------
function generate_json_float_meta_iridium_nke_old_versions()
...
outputDirName = ['C:\Users\jprannou\_RNU\Argo\ActionsCoriolis\ConvertNkeOldVersionsTo3.1\generate_json_float_meta_iridium_nke_old_versions_' datestr(now, 'yyyymmddTHHMMSS')];
...
logFile = [DIR_LOG_FILE '/' 'generate_json_float_meta_iridium_nke_old_versions_' name '_' datestr(now, 'yyyymmddTHHMMSS') '.log'];
diary(logFile);
tic;
