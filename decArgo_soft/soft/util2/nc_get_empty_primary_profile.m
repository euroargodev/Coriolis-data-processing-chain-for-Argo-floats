% ------------------------------------------------------------------------------
% Retrieve profile files where primary profile (N_PROF = 1) is empty.
%
% SYNTAX :
%   nc_get_empty_primary_profile
%
% INPUT PARAMETERS :
%
% OUTPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function nc_get_empty_primary_profile
...
logFile = [DIR_LOG_CSV_FILE '/' 'nc_get_empty_primary_profile_' datestr(now, 'yyyymmddTHHMMSS') '.log'];
diary(logFile);
tic;
