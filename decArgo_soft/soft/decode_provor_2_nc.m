% ------------------------------------------------------------------------------
% Decode PROVOR data to NetCDF files.
%
% SYNTAX :
%   decode_provor_2_nc or decode_provor_2_nc(6900189, 7900118)
%
% INPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function decode_provor_2_nc(varargin)
...
logFileName = [g_decArgo_dirOutputLogFile '/decode_provor_2_nc' name '_' datestr(now, 'yyyymmddTHHMMSS') '.log'];
diary(logFileName);
